...
lib.ssMetadata = [
		{name:"728x90_flyoverxmas_atlas_", frames: [[0,83,167,80],[0,0,181,81],[169,83,70,55],[183,0,50,51]]}
];
...
(lib.bb_logo = function() {
	this.spriteSheet = ss["728x90_flyoverxmas_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(496,-155,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(496,-155,150.3,72), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("AAQA7IAAgvQAAgKgEgDQgDgFgHgBQgDAAgDACQgDABgDADIgEAFIgBAJIAAAuIgYAAIAAh0IAYAAIAAApQALgLAMAAQANAAAKAKQAEAEACAHQADAGAAAHIAAA0g");
	this.shape.setTransform(247.5,1.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgMAwQgIgJAAgNIAAgmIgKAAIAAgRIAKAAIAAgaIAXAAIAAAaIAUAAIAAARIgUAAIAAAkQAAAGACACQADADADAAIAGgCIAFgEIAJARQgLAJgMABQgLgBgJgHg");
	this.shape_1.setTransform(239.2,1.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgfA3IAqhYIgbAAIAAAOIgXAAIAAgjIBPAAIAAASIgsBbg");
	this.shape_2.setTransform(231.1,1.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgfA4QgGgCgGgFIALgSQADAEADABQADABADAAQADAAADgDQACgDAAgEQgLgegWg3IAaAAIATA0IAVg0IAZAAIgnBiQgEAKgGAEQgHAFgJAAQgHAAgFgDg");
	this.shape_3.setTransform(217.6,4.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgYArIAAhTIAYAAIAAAKQAEgEAGgFQAHgDAHAAIABAWIgFAAQgFAAgEACQgEACgDAEQgEAHAAALIAAAlg");
	this.shape_4.setTransform(210.1,2.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgSAqQgFgCgFgEQgJgIAAgNQAAgGACgFQADgEAEgDQAFgDAGgCQAHgCAIABIARAAIAAgBQAAgHgEgDQgDgEgIAAQgFAAgHACQgGADgFAEIgLgQQARgLAUgBQAIAAAGACQAHACAFAEQAJAIAAARIAAA1IgWAAIAAgKQgJAKgMABQgHgBgGgBgAgNAPQAAAEADADQADADAHAAQAFAAAFgFQAFgEAAgGIAAgEIgPAAQgNAAAAAJg");
	this.shape_5.setTransform(201.7,2.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgdAiQgKgIAAgSIAAgyIAYAAIAAAtQAAAUAPAAQAGAAAFgFQAFgGAAgJIAAgtIAYAAIAABUIgYAAIAAgLQgEAGgGADQgGADgGAAQgOAAgJgJg");
	this.shape_6.setTransform(192.1,2.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAQArIAAgvQAAgJgEgGQgDgEgHAAQgDAAgDABQgDABgDACIgEAHIgBAJIAAAuIgYAAIAAhTIAYAAIAAAJQALgLAMAAQAOAAAJAKQAEAEACAHQADAFAAAIIAAAzg");
	this.shape_7.setTransform(182.2,2.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgSAqQgFgCgFgEQgJgIAAgNQAAgGACgFQADgEAEgDQAFgDAGgCQAHgCAIABIARAAIAAgBQAAgHgEgDQgDgEgIAAQgFAAgHACQgGADgFAEIgLgQQARgLAUgBQAIAAAGACQAHACAFAEQAJAIAAARIAAA1IgWAAIAAgKQgJAKgMABQgHgBgGgBgAgNAPQAAAEADADQADADAHAAQAFAAAFgFQAFgEAAgGIAAgEIgPAAQgNAAAAAJg");
	this.shape_8.setTransform(172.3,2.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("A
7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgrAmIAPgSQASAPAOAAQAHAAAEgDQADgDAAgFQAAgEgEgDQgEgDgLgDQgTgFgJgGQgEgEgDgGQgCgFAAgIQAAgQALgIQAMgJAPAAQAMAAALAEQALAEAIAHIgNASQgOgLgPAAQgFAAgEADQgEADAAAEQAAAFAFADQAEADAPAEQAPAEAJAGQAEAEADAGQACAFAAAIQAAAPgLAJQgGAEgHADQgHACgKAAQgZAAgVgTg");
	this.shape_19.setTransform(73.9,1.3);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AAQA7IAAgvQAAgKgEgDQgDgFgHgBQgDAAgDACQgDABgDADIgEAFIgBAJIAAAuIgYAAIAAh0IAYAAIAAApQALgLAMAAQANAAAKAKQAEAEACAHQADAGAAAHIAAA0g");
	this.shape_20.setTransform(59.9,1.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgMAwQgIgJAAgNIAAgmIgKAAIAAgRIAKAAIAAgaIAXAAIAAAaIAUAAIAAARIgUAAIAAAkQAAAGACACQADADADAAIAGgCIAFgEIAJARQgLAJgMABQgLgBgJgHg");
	this.shape_21.setTransform(51.5,1.5);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgLA8IAAhUIAXAAIAABUgAgJgjQgEgEAAgGQAAgGAEgDQAEgEAFgBQAGABAEAEQAEADAAAGQAAAGgEAEQgEAEgGAAQgFAAgEgEg");
	this.shape_22.setTransform(45.6,1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AAPAqIgPgtIgPAtIgYAAIgdhTIAZAAIAQAyIAQgyIAWAAIARAyIARgyIAYAAIgdBTg");
	this.shape_23.setTransform(36.2,2.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AgfA4QgGgCgGgFIALgSQADAEADABQADABADAAQADAAADgDQACgDAAgEQgLgegWg3IAaAAIATA0IAVg0IAZAAIgnBiQgEAKgGAEQgHAFgJAAQgHAAgFgDg");
	this.shape_24.setTransform(20.4,4.4);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AgLA7IAAh0IAXAAIAAB0g");
	this.shape_25.setTransform(13.5,1.1);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AglA3IAAhtIBLAAIAAAVIgyAAIAAAYIAvAAIAAAVIgvAAIAAArg");
	this.shape_26.setTransform(6.7,1.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(-0.5,-10.4,255.3,23.4), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgZCnIAAkaIglAAIAAgyIB9AAIAAAyIglAAIAAEag");
	this.shape.setTransform(249,24.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAPCnIAAiKIgcAAIAACKIg0AAIAAlMIA0AAIAACQIAcAAIAAiQIAzAAIAAFMg");
	this.shape_1.setTransform(234.6,24.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgeCnQgLgFgHgIQgIgJgEgMQgEgMAAgPIAAjTQAAgOAFgMQAFgLAJgKQAIgJAMgEQAMgGANAAQANAAAMAGQALAEAJAJQAIAKAFALQAEAMAAAOIAAA9IgwAAIAAg/QAAgNgNAAQgNAAAAANIAADZQAAAPANAAQAOAAAAgPIAAhDIgNAAIAAgpIA/AAIAAClIgeAAIgGgSQgFALgKAGQgKAFgKAAQgNAAgLgEg");
	this.shape_2.setTransform(219.4,24.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgZCnIAAlMIAzAAIAAFMg");
	this.shape_3.setTransform(208,24.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgZCnIAAkaIglAAIAAgyIB9AAIAAAyIglAAIAAEag");
	this.shape_4.setTransform(197.6,24.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAZCnIgkiXIgMgsIAADDIgsAAIAAlMIAxAAIAgCVIAKAtIAAjCIAsAAIAAFMg");
	this.shape_5.setTransform(177.6,24.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("A
4);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAPCnIAAiKIgcAAIAACKIg0AAIAAlMIA0AAIAACQIAcAAIAAiQIAzAAIAAFMg");
	this.shape_16.setTransform(14.2,24.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(4.3,-1,253.4,54), null);
...
(lib.SNOW = function(mode,startPosition,loop) {
	...
	// Layer 6
	this.instance = new lib.snowflake1("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(365.6,-175.6,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_1 = new lib.snowflake1("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(238.3,-122.1,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_2 = new lib.snowflake2("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(235.4,-29.9,1,1,0,0,180,25,25.5);

	this.instance_3 = new lib.snowflake2("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(332.6,-92.3,1,1,0,0,0,25,25.5);

	this.instance_4 = new lib.snowflake2("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(390.5,-24.5,1,1,0,0,0,25,25.5);

	this.instance_5 = new lib.snowflake2("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(59.3,-239.1,1,1,0,0,0,25,25.5);

	this.instance_6 = new lib.snowflake2("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(56.6,-169.5,1,1,0,0,180,25,25.5);

	this.instance_7 = new lib.snowflake2("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(165.5,-224.4,1,1,0,0,0,25,25.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},97).wait(187));

	// Layer 5
	this.instance_8 = new lib.snowflake1("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(413,-211.6,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_9 = new lib.snowflake1("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(285.7,-158.1,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_10 = new lib.snowflake2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(282.8,-65.9,1,1,0,0,180,25,25.5);

	this.instance_11 = new lib.snowflake2("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(380,-128.3,1,1,0,0,0,25,25.5);

	this.instance_12 = new lib.snowflake2("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(437.9,-60.5,1,1,0,0,0,25,25.5);

	this.instance_13 = new lib.snowflake1("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(79.8,-222,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_14 = new lib.snowflake1("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(174,-213.5,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_15 = new lib.snowflake1("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(-14.7,-275.5,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_16 = new lib.snowflake1("synched",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(119.5,-159.8,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_17 = new lib.snowflake1("synched",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(-47.4,-168.5,0.49,0.49,0,0,180,24.9,21.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]},48).wait(236));

	// Layer 4
	this.instance_18 = new lib.snowflake2("synched",0);
	this.instance_18.parent = this;
	this.instance_18.setTransform(-50.4,-76.3,1,1,0,0,180,25,25.5);

	this.instance_19 = new lib.snowflake2("synched",0);
	this.instance_19.parent = this;
	this.instance_19.setTransform(46.9,-138.7,1,1,0,0,0,25,25.5);

	this.instance_20 = new lib.snowflake2("synched",0);
	this.instance_20.parent = this;
	this.instance_20.setTransform(104.7,-70.9,1,1,0,0,0,25,25.5);

	this.instance_21 = new lib.snowflake2("synched",0);
	this.instance_21.parent = this;
	this.instance_21.setTransform(-14.8,-179.2,1,1,0,0,0,25,25.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18}]},54).wait(230));

	// Layer 3
	this.instance_22 = new lib.snowflake2("synched",0);
	this.instance_22.parent = this;
	this.instance_22.setTransform(434.2,-118.6,1,1,0,0,180,25,25.5);

	this.instance_23 = new lib.snowflake2("synched",0);
	this.instance_23.parent = this;
	this.instance_23.setTransform(631.3,-58.6,1,1,0,0,0,25,25.5);

	this.instance_24 = new lib.snowflake2("synched",0);
	this.instance_24.parent = this;
	this.instance_24.setTransform(568.3,-162.6,1,1,0,0,0,25,25.5);

	this.instance_25 = new lib.snowflake1copy("synched",19);
	this.instance_25.parent = this;
	this.instance_25.setTransform(595.9,-204.5,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_26 = new lib.snowflake1copy("synched",19);
	this.instance_26.parent = this;
	this.instance_26.setTransform(477.2,-189.5,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_27 = new lib.snowflake1("synched",79);
	this.instance_27.parent = this;
	this.instance_27.setTransform(494.1,-327.3,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_28 = new lib.snowflake1("synched",19);
	this.instance_28.parent = this;
	this.instance_28.setTransform(617.7,-284.6,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_29 = new lib.snowflake2("synched",0);
	this.instance_29.parent = this;
	this.instance_29.setTransform(165.3,-133.5,1,1,0,0,180,25,25.5);

	this.instance_30 = new lib.snowflake2("synched",0);
	this.instance_30.parent = this;
	this.instance_30.setTransform(362.4,-73.5,1,1,0,0,0,25,25.5);

	this.instance_31 = new lib.snowflake2("synched",0);
	this.instance_31.parent = this;
	this.instance_31.setTransform(299.4,-177.5,1,1,0,0,0,25,25.5);

	this.instance_32 = new lib.snowflake1copy("synched",19);
	this.instance_32.parent = this;
	this.instance_32.setTransform(326.9,-219.3,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_33 = new lib.snowflake1copy("synched",19);
	this.instance_33.parent = this;
	this.instance_33.setTransform(208.3,-204.3,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_34 = new lib.snowflake1("synched",79);
	this.instance_34.parent = this;
	this.instance_34.setTransform(225.2,-342.2,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_35 = new lib.snowflake1("synched",19);
	this.instance_35.parent = this;
	this.instance_35.setTransform(348.8,-299.5,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_36 = new lib.snowflake2("synched",0);
	this.instance_36.parent = this;
	this.instance_36.setTransform(-70.5,66.6,1,1,0,0,180,25,25.5);

	this.instance_37 = new lib.snowflake2("synched",0);
	this.instance_37.parent = this;
	this.instance_37.setTransform(126.6,126.6,1,1,0,0,0,25,25.5);

	this.instance_38 = new lib.snowflake2("synched",0);
	this.instance_38.parent = this;
	this.instance_38.setTransform(63.6,22.6,1,1,0,0,0,25,25.5);

	this.instance_39 = new lib.snowflake2("synched",0);
	this.instance_39.parent = this;
	this.instance_39.setTransform(-60,-76.5,1,1,0,0,0,25,25.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22}]}).wait(284));

	// Layer 2
	this.instance_40 = new lib.snowflake1copy("synched",19);
	this.instance_40.parent = this;
	this.instance_40.setTransform(29.8,-230.4,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_41 = new lib.snowflake1copy("synched",19);
	this.instance_41.parent = this;
	this.instance_41.setTransform(176.2,-136.8,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_42 = new lib.snowflake1copy("synched",19);
	this.instance_42.parent = this;
	this.instance_42.setTransform(91.2,-19.3,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_43 = new lib.snowflake1copy("synched",19);
	this.instance_43.parent = this;
	this.instance_43.setTransform(-27.5,-4.3,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_44 = new lib.snowflake1copy("synched",19);
	this.instance_44.parent = this;
	this.instance_44.setTransform(145.2,-215.2,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_45 = new lib.snowflake1copy("synched",19);
	this.instance_45.parent = this;
	this.instance_45.setTransform(-34.4,-154.5,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_46 = new lib.snowflake1("synched",44);
	this.instance_46.parent = this;
	this.instance_46.setTransform(51.3,-222,0.49,0.49,0,0,180,24.9,21.4);

	this.instance_47 = new lib.snowflake1("synched",79);
	this.instance_47.parent = this;
	this.instance_47.setTransform(-10.6,-142.1,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_48 = new lib.snowflake1("synched",19);
	this.instance_48.parent = this;
	this.instance_48.setTransform(113,-99.4,0.49,0.49,0,0,180,24.9,21.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40}]}).wait(284));

	// Layer 1
	this.instance_49 = new lib.snowflake1("synched",0);
	this.instance_49.parent = this;
	this.instance_49.setTransform(-101.9,-163.4,0.49,0.49,0,0,0,24.9,21.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_49).wait(284));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-110.2,-271.3,758,337.3);
...
// stage content:
(lib._728x90_flyoverxmas = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// Layer 6
	this.instance = new lib.Symbol4("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(322.5,84.5,1,1,0,0,0,90.5,40.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({regX:46.3,regY:46,x:282.1,y:88.7,alpha:0.042},0).wait(1).to({x:287.1,y:86.9,alpha:0.095},0).wait(1).to({x:293.7,y:84.6,alpha:0.168},0).wait(1).to({x:303.1,y:81.4,alpha:0.27},0).wait(1).to({x:315.8,y:76.9,alpha:0.407},0).wait(1).to({x:328.4,y:72.5,alpha:0.545},0).wait(1).to({x:337.8,y:69.3,alpha:0.647},0).wait(1).to({x:344.5,y:66.9,alpha:0.719},0).wait(1).to({x:349.4,y:65.2,alpha:0.773},0).wait(1).to({x:353.2,y:63.9,alpha:0.815},0).wait(1).to({x:356.3,y:62.8,alpha:0.848},0).wait(1).to({x:358.8,y:61.9,alpha:0.875},0).wait(1).to({x:360.9,y:61.2,alpha:0.898},0).wait(1).to({x:362.6,y:60.6,alpha:0.917},0).wait(1).to({x:364.1,y:60.1,alpha:0.933},0).wait(1).to({x:365.3,y:59.7,alpha:0.946},0).wait(1).to({x:366.3,y:59.3,alpha:0.957},0).wait(1).to({x:367.2,y:59,alpha:0.967},0).wait(1).to({x:367.9,y:58.8,alpha:0.975},0).wait(1).to({x:368.5,y:58.5,alpha:0.981},0).wait(1).to({x:369,y:58.4,alpha:0.987},0).wait(1).to({x:369.4,y:58.2,alpha:0.991},0).wait(1).to({x:369.7,y:58.1,alpha:0.995},0).wait(1).to({x:370,y:58,alpha:0.997},0).wait(1).to({x:370.1,alpha:0.999},0).wait(1).to({x:370.2,alpha:1},0).wait(1).to({regX:90.5,regY:40.5,x:414.5,y:52.5},0).to({x:443.5,y:45.6},196).wait(1));

	// Layer 5
	this.instance_1 = new lib.reindeer("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(319.5,83.5,1,1,0,0,0,90.5,40.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({_off:false},0).wait(1).to({regX:131.9,regY:39.6,x:364.7,y:81.2,alpha:0.042,startPosition:1},0).wait(1).to({x:369.7,y:79.4,alpha:0.095,startPosition:2},0).wait(1).to({x:376.3,y:77.1,alpha:0.168,startPosition:3},0).wait(1).to({x:385.7,y:73.7,alpha:0.27,startPosition:4},0).wait(1).to({x:398.4,y:69.1,alpha:0.407,startPosition:5},0).wait(1).to({x:411,y:64.6,alpha:0.545,startPosition:6},0).wait(1).to({x:420.4,y:61.2,alpha:0.647,startPosition:7},0).wait(1).to({x:427.1,y:58.8,alpha:0.719,startPosition:8},0).wait(1).to({x:432,y:57,alpha:0.773,startPosition:9},0).wait(1).to({x:435.8,y:55.7,alpha:0.815,startPosition:10},0).wait(1).to({x:438.9,y:54.6,alpha:0.848,startPosition:11},0).wait(1).to({x:441.4,y:53.7,alpha:0.875,startPosition:12},0).wait(1).to({x:443.5,y:52.9,alpha:0.898,startPosition:13},0).wait(1).to({x:445.2,y:52.3,alpha:0.917,startPosition:14},0).wait(1).to({x:446.7,y:51.8,alpha:0.933,startPosition:15},0).wait(1).to({x:447.9,y:51.3,alpha:0.946,startPosition:16},0).wait(1).to({x:448.9,y:51,alpha:0.957,startPosition:17},0).wait(1).to({x:449.8,y:50.6,alpha:0.967,startPosition:18},0).wait(1).to({x:450.5,y:50.4,alpha:0.975,startPosition:19},0).wait(1).to({x:451.1,y:50.2,alpha:0.981,startPosition:20},0).wait(1).to({x:451.6,y:50,alpha:0.987,startPosition:21},0).wait(1).to({x:452,y:49.8,alpha:0.991,startPosition:22},0).wait(1).to({x:452.3,y:49.7,alpha:0.995,startPosition:23},0).wait(1).to({x:452.6,y:49.6,alpha:0.997,startPosition:24},0).wait(1).to({x:452.7,alpha:0.999,startPosition:25},0).wait(1).to({x:452.8,alpha:1,startPosition:26},0).wait(1).to({regX:90.5,regY:40.5,x:411.5,y:50.5,startPosition:9},0).to({x:440.5,y:44.6,startPosition:7},196).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:131.5,regY:26.1,scaleX:2.85,scaleY:2.85,x:160.4,y:52.6,alpha:0.067},0).wait(1).to({scaleX:2.65,scaleY:2.65,x:159.9,y:51,alpha:0.168},0).wait(1).to({scaleX:2.32,scaleY:2.32,x:158.9,y:48.3,alpha:0.335},0).wait(1).to({scaleX:1.9,scaleY:1.9,x:157.6,y:44.8,alpha:0.545},0).wait(1).to({scaleX:1.62,scaleY:1.62,x:156.8,y:42.4,alpha:0.686},0).wait(1).to({scaleX:1.45,scaleY:1.45,x:156.3,y:41,alpha:0.773},0).wait(1).to({scaleX:1.33,scaleY:1.33,x:156,y:40.1,alpha:0.832},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:155.7,y:39.4,alpha:0.875},0).wait(1).to({scaleX:1.18,scaleY:1.18,x:155.6,y:38.9,alpha:0.908},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:155.4,y:38.5,alpha:0.933},0).wait(1).to({scaleX:1.1,scaleY:1.1,x:155.2,y:38.1,alpha:0.952},0).wait(1).to({scaleX:1.07,scaleY:1.07,x:155.1,y:37.9,alpha:0.967},0).wait(1).to({scaleX:1.04,scaleY:1.04,y:37.7,alpha:0.978},0).wait(1).to({scaleX:1.03,scaleY:1.03,x:155,y:37.6,alpha:0.987},0).wait(1).to({scaleX:1.01,scaleY:1.01,y:37.4,alpha:0.993},0).wait(1).to({scaleX:1.01,scaleY:1.01,alpha:0.997},0).wait(1).to({scaleX:1,scaleY:1,alpha:0.999},0).wait(1).to({regX:128.7,regY:28,scaleX:1,scaleY:1,x:152.1,y:39.3,alpha:1},0).wait(221));
...
p.nominalBounds = new cjs.Rectangle(144.9,-81.3,1039.2,337.3);
// library properties:
lib.properties = {
	width: 728,
	height: 90,
	...
	webfonts: {},
	manifest: [
		{src:"images/728x90_flyoverxmas_atlas_.png", id:"728x90_flyoverxmas_atlas_"}
	],
	preloads: []
};
