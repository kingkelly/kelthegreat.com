...
lib.ssMetadata = [
		{name:"160x600_flyoverxmas_atlas_", frames: [[0,326,167,80],[0,408,70,55],[72,408,50,51],[0,0,160,324]]}
];
...
(lib.bb_logo = function() {
	this.spriteSheet = ss["160x600_flyoverxmas_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(503,-155,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(503,-155,150.3,72), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("AAdBrIAAhVQAAgRgGgJQgHgIgNgBQgFABgGACQgGACgFAFQgEADgDAIQgCAHgBAIIAABUIgrAAIAAjVIArAAIAABMQAVgTAWgBQAZABARAQQAIAKAEALQAFAMgBAMIAABfg");
	this.shape.setTransform(171.8,664);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgWBXQgQgOAAgaIAAhHIgSAAIAAgeIASAAIAAgvIArAAIAAAvIAlAAIAAAeIglAAIAABFQAAAJAEAFQAFAFAGAAQAGAAAGgCQAFgDAEgGIAQAeQgUATgXAAQgVAAgPgPg");
	this.shape_1.setTransform(156.6,664.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ag5BlIBNiiIgyAAIAAAaIgqAAIAAhBICRAAIAAAiIhRCng");
	this.shape_2.setTransform(141.8,664.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ag7BoQgLgFgJgKIATgfQAGAFAFADQAGACAFAAQAHABADgHQAFgFAAgHQgUg4gohlIAuAAIAlBgIAmhgIAuAAIhIC2QgGAQgNAIQgNAJgRAAQgLAAgLgEg");
	this.shape_3.setTransform(117.1,670);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgsBPIAAiaIArAAIAAAUQAIgJAMgHQAMgHAOAAIAAApIgIAAQgKAAgIADQgHAEgEAGQgJAOAAAWIAABDg");
	this.shape_4.setTransform(103.4,666.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgiBMQgKgEgIgGQgRgPAAgXQAAgMAFgKQAEgHAIgGQAJgGAMgDQALgDAQAAIAfAAIAAgBQAAgMgHgHQgGgFgOgBQgKAAgMAFQgMAFgKAGIgTgcQAfgWAmAAQAOAAAMAEQAMADAIAHQASAOAAAeIAABiIgpAAIAAgSQgQAVgYAAQgMAAgLgEgAgaAbQABAJAGAEQAGAFAMgBQAKAAAJgGQAIgIAAgLIAAgIIgaAAQgaAAAAAQg");
	this.shape_5.setTransform(87.9,666.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ag2A/QgSgQAAggIAAhdIAsAAIAABUQAAAjAaAAQAMAAAKgJQAJgJAAgSIAAhTIAsAAIAACaIgsAAIAAgUQgIALgKAGQgLAGgLAAQgaAAgRgQg");
	this.shape_6.setTransform(70.4,667);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAdBPIAAhXQAAgSgGgJQgHgJgNAAQgGAAgFADQgGACgFAFQgFAEgCAHQgCAHgBAJIAABWIgrAAIAAiaIArAAIAAARQAVgUAXAAQAYAAARARQAIAJAEAMQAFALAAAOIAABeg");
	this.shape_7.setTransform(52.2,666.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AghBMQgLgEgIgGQgRgPAAgXQAAgMAFgKQADgHAJgGQAJgGAMgDQAMgDAOAAIAgAAIAAgBQAAgMgHgHQgGgFgNgBQgKAAgNAFQgMAFgJAGIgTgcQAegWAmAAQAOAAAMAEQALADAJAHQASAOAAAeIAABiIgpAAIAAgSQgQAVgYAAQgMAAgKgEgAgZAbQAAAJAGAEQAGAFAMgBQAKAAAJgGQAJgIAAgLIAAgIIgbAAQgZAAAAAQg");
	this.shape_8.setTransform(34.1,666.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgiBfQgQgHgOgOIAYghQAJALAJAEQAKAFAKAAQAIAAAHgIQADgDACgGQACgFAAgHIAAheIg7AAIAAgnIBoAAIAACDQAAAkgTASQgJAJgMAEQgMAFgNAAQgSgBgQgGg");
	this.shape_9.setTransform(17.1,664.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgUBrIAAjVIAqAAIAADVg");
	this.shape_10.setTransform(169.8,634);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgUBtIAAiaIAqAAIAACagAgRhBQgIgHABgLQgBgKAIgIQAHgHAKAAQALAAAHAHQAHAIAAAKQAAALgHAHQgHAHgLAAQgKAAgHgHg");
	this.shape_11.setTransform(161.5,633.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgWBXQgQgPAAgZIAAhGIgSAAIAAggIASAAIAAguIArAAIAAAuIAlAAIAAAgIglAAIAABEQAAAJAEAFQAFAFAGAAQAGAAAGgDQAFgDAEgFIAQAfQgUASgXAAQgVAAgPgPg");
	this.shape_12.setTransform(151.3,634.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAdBPIAAhXQAAgSgGgJQgHgJgNAAQgGAAgFADQgGACgEAFQgFAEgDAHQgDAHABAJIAABWIgsAAIAAiaIAsAAIAAARQATgUAYAAQAYAAARARQAIAJAEAMQAEALAAAOIAABeg");
	this.shape_13.setTransform(135.5,636.8);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("Ag2A/QgSgQAAggIAAhdIAsAAIAABUQAAAjAaAAQAMAAAKgJQAJgJAAgSIAAhTIAsAAIAACaIgsAAIAAgUQgIALgKAGQgLAGgLAAQgaAAgRgQg");
	this.shape_14.setTransform(116.9,637.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AghBMQgLgEgIgHQgRgNAAgYQAAgMAEgKQAFgHAJgGQAIgGAMgDQAMgDAPAAIAfAAIAAgBQAAgMgGgHQgHgFgNAAQgLgBgMAFQgMAEgJAHIgUgcQAfgWAmAAQAPAAALADQALAEAJAHQASAOAAAeIAABiIgoAAIAAgSQgRAVgYAAQgMAAgKgEgAgZAbQgBAIAHAFQAGAFALAAQALgBAJgGQAJgIgBgLIAAgIIgaAAQgZAAAAAQg");
	this.shape_15.setTransform(91.4,637);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AgWBXQgQgPAAgZIAAhGIgSAAIAAggIASAAIAAguIArAAIAAAuIAlAAIAAAgIglAAIAABEQAAAJAEAFQAFAFAGAAQAGAAAGgDQAFgDAEgFIAQAfQgUASgXAAQgVAAgPgPg");
	this.shape_16.setTransform(77.2,634.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AAdBPIAAhXQAAgSgGgJQgHgJgNAAQgFAAgGADQgGACgFAFQgEAEgDAHQgCAHgBAJIAABWIgrAAIAAiaIArAAIAAARQAVgUAXAAQAYAAARARQAIAJAEAMQAFALgBAOIAABeg");
	this.shape_17.setTransform(61.5,636.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AgiBMQgKgEgIgHQgRgNAAgYQAAgMAFgKQAEgHAIgGQAJgGAMgDQALgDAPAAIAgAAIAAgBQAAgMgHgHQgGgFgOAAQgKgBgMAFQgMAEgKAHIgTgcQAfgWAmAAQAOAAAMADQAMAEAIAHQASAOAAAeIAABiIgpAAIAAgSQgQAVgYAAQgMAAgLgEgAgaAbQABAIAGAFQAGAFAMAAQAKgBAJgGQAIgIAAgLIAAgIIgaAAQgaAAAAAQg");
	this.shape_18.setTransform(43.3,637);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AhPBFIAbghQAhAcAaAAQAMAAAIgFQAHgFAAgKQAAgJgIgFQgHgFgWgGQgjgIgQgMQgIgHgEgLQgEgKAAgOQAAgdAUgQQAVgPAeAAQAUAAAUAHQAUAHAPAMIgWAhQgbgUgbAAQgLAAgGAGQgHAFAAAJQAAAIAIAGQAIAFAcAHQAcAHAQANQAIAHAEAKQAEALAAANQAAAbgUARQgKAJgOAEQgNAEgRAAQgvAAgmgjg");
	this.shape_19.setTransform(25.7,634.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AAdBrIAAhVQAAgRgHgJQgGgJgNAAQgFABgGACQgGACgEAFQgGAEgCAGQgDAIAAAIIAABUIgqAAIAAjVIAqAAIAABMQAVgTAWAAQAZAAARARQAIAJAEALQAEAMABANIAABeg");
	this.shape_20.setTransform(144.2,604);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgWBXQgQgOAAgaIAAhHIgSAAIAAgeIASAAIAAgvIArAAIAAAvIAlAAIAAAeIglAAIAABFQAAAJAEAFQAFAFAGAAQAGAAAGgCQAFgDAEgGIAQAeQgUATgXAAQgVAAgPgPg");
	this.shape_21.setTransform(129,604.8);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgUBtIAAiaIAqAAIAACagAgRhBQgIgHAAgLQAAgKAIgIQAHgHAKAAQALAAAHAHQAHAIAAAKQAAALgHAHQgHAIgLAAQgKAAgHgIg");
	this.shape_22.setTransform(118.1,603.8);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AAdBOIgdhUIgcBUIgtAAIg0iaIAtAAIAeBcIAehcIApAAIAeBcIAehcIAtAAIg0Cag");
	this.shape_23.setTransform(100.9,607);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("Ag7BoQgKgFgKgKIATgfQAFAFAGADQAFADAHAAQAFAAAFgHQAEgFAAgHQgUg4gohlIAvAAIAkBgIAlhgIAvAAIhIC2QgHAQgMAIQgOAJgPAAQgMAAgLgEg");
	this.shape_24.setTransform(71.9,610);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AgVBrIAAjVIAqAAIAADVg");
	this.shape_25.setTransform(59.2,604);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AhEBlIAAjJICJAAIAAAoIhcAAIAAArIBXAAIAAAnIhXAAIAABPg");
	this.shape_26.setTransform(46.8,604.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(7.7,584.8,175.3,99.3), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AghDcIAAl0IgyAAIAAhDICnAAIAABDIgyAAIAAF0g");
	this.shape.setTransform(159.2,588.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AATDcIAAi2IglAAIAAC2IhEAAIAAm3IBEAAIAAC/IAlAAIAAi/IBEAAIAAG3g");
	this.shape_1.setTransform(140.3,588.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgoDcQgNgGgKgLQgLgMgFgPQgGgRAAgTIAAkXQAAgSAHgPQAGgQAMgMQAMgMAPgGQAQgHARAAQASAAAQAHQAOAGAMAMQAKAMAGAQQAGAPAAASIAABRIg/AAIAAhTQAAgTgSAAQgSAAAAATIAAEfQAAATASAAQATAAAAgTIAAhaIgSAAIAAg1IBTAAIAADZIgnAAIgHgXQgHAOgNAIQgNAHgOAAQgRAAgPgGg");
	this.shape_2.setTransform(120.1,588.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AghDcIAAm3IBDAAIAAG3g");
	this.shape_3.setTransform(105.2,588.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AghDcIAAl0IgyAAIAAhDICnAAIAABDIgyAAIAAF0g");
	this.shape_4.setTransform(91.5,588.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAhDcIgwjHIgPg7IAAECIg7AAIAAm3IBBAAIAqDFIAOA9IAAkCIA5AAIAAG3g");
	this.shape_5.setTransform(65.2,588.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AghDcQgPgGgMgMQgMgMgGgQQgHgRAAgTIAAkTQAAgTAHgRQAGgQAMgMQAMgMAPgGQAQgGARAAQASAAAQAGQAPAGAMAMQAMAMAGAQQAHARAAATIAAETQAAATgHARQgGAQgMAMQgMAMgPAGQgQAGgSAAQgRAAgQgGgAgQiNIAAEbQAAASAQAAQAQAAAAgSIAAkbQAAgTgQAAQgQAAAAATg");
	this.shape_6.setTransform(44.6,588.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhUDcIAAm3IBZAAQAQAAAOAFQAPAFAKAKQAMALAGAQQAHARAAAWIAAEOQAAAWgHARQgGAPgMAKQgKAKgPAEQgOAFgQAAgAgQCdIAQAAQARAAAAgXIAAkLQAAgWgRAAIgQAAg");
	this.shape_7.setTransform(185.3,533.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhEDcIAAm3IBEAAIAAF3IBFAAIAABAg");
	this.shape_8.setTransform(167.9,533.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AghDcQgPgGgMgMQgMgMgGgQQgHgRAAgTIAAkTQAAgTAHgRQAGgQAMgMQAMgMAPgGQAQgGARAAQASAAAQAGQAPAGAMAMQAMAMAGAQQAHARAAATIAAETQAAATgHARQgGAQgMAMQgMAMgPAGQgQAGgSAAQgRAAgQgGgAgQiNIAAEbQAAASAQAAQAQAAAAgSIAAkbQAAgTgQAAQgQAAAAATg");
	this.shape_9.setTransform(149.3,533.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AATDcIAAi2IglAAIAAC2IhEAAIAAm3IBEAAIAAC/IAlAAIAAi/IBEAAIAAG3g");
	this.shape_10.setTransform(129,533.3);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgZAxQALAAAGgJQAHgJAAgTIgYAAIAAhNIAzAAIAABHQAAAZgOARQgOASgXAAg");
	this.shape_11.setTransform(107.5,554.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AghDcQgPgGgMgMQgMgMgGgQQgHgRAAgTIAAkTQAAgTAHgRQAGgQAMgMQAMgMAPgGQAQgGARAAQASAAAQAGQAPAGAMAMQAMAMAGAQQAHARAAATIAAETQAAATgHARQgGAQgMAMQgMAMgPAGQgQAGgSAAQgRAAgQgGgAgQiNIAAEbQAAASAQAAQAQAAAAgSIAAkbQAAgTgQAAQgQAAAAATg");
	this.shape_12.setTransform(93.6,533.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AATDcIAAi2IglAAIAAC2IhEAAIAAm3IBEAAIAAC/IAlAAIAAi/IBEAAIAAG3g");
	this.shape_13.setTransform(73.3,533.3);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgZAxQALAAAGgJQAHgJAAgTIgYAAIAAhNIAzAAIAABHQAAAZgOARQgOASgXAAg");
	this.shape_14.setTransform(51.8,554.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AghDcQgPgGgMgMQgMgMgGgQQgHgRAAgTIAAkTQAAgTAHgRQAGgQAMgMQAMgMAPgGQAQgGARAAQASAAAQAGQAPAGAMAMQAMAMAGAQQAHARAAATIAAETQAAATgHARQgGAQgMAMQgMAMgPAGQgQAGgSAAQgRAAgQgGgAgQiNIAAEbQAAASAQAAQAQAAAAgSIAAkbQAAgTgQAAQgQAAAAATg");
	this.shape_15.setTransform(37.9,533.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AATDcIAAi2IglAAIAAC2IhEAAIAAm3IBEAAIAAC/IAlAAIAAi/IBEAAIAAG3g");
	this.shape_16.setTransform(17.6,533.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(5.2,500.5,192.1,125), null);
...
(lib.SNOW = function(mode,startPosition,loop) {
	...
	this.instance_33.setTransform(-8.4,-384.7,0.49,0.49,0,0,0,24.9,21.4);

	this.instance_34 = new lib.snowflake1("synched",19);
	this.instance_34.parent = this;
	this.instance_34.setTransform(81.5,-322.7,0.49,0.49,0,0,180,24.9,21.4);
...
p.nominalBounds = new cjs.Rectangle(-110.2,-275.1,324.9,341.2);


// stage content:
(lib._160x600_flyoverxmas = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// Layer 4
	this.instance = new lib.Symbol3();
	this.instance.parent = this;
	this.instance.setTransform(-363.9,697.4,0.9,0.9,0,0,0,83.5,40.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(28).to({_off:false},0).to({alpha:1},27,cjs.Ease.get(0.1)).wait(184));

	// Layer 3
	this.instance_1 = new lib.Symbol2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(99.5,46.2,0.665,0.665,0,0,0,125.7,13.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(18).to({_off:false},0).to({alpha:1},16,cjs.Ease.get(0.98)).wait(205));

	// Layer 2
	this.instance_2 = new lib.Symbol1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(113,-632.2,1.995,1.995,0,0,0,128.8,28.1);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:101.4,regY:560.8,scaleX:1.91,scaleY:1.91,x:59.9,y:426.8,alpha:0.067},0).wait(1).to({scaleX:1.77,scaleY:1.77,x:62.1,y:421.2,alpha:0.168},0).wait(1).to({scaleX:1.55,scaleY:1.55,x:65.8,y:411.9,alpha:0.335},0).wait(1).to({scaleX:1.27,scaleY:1.27,x:70.4,y:400.2,alpha:0.545},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:73.5,y:392.4,alpha:0.686},0).wait(1).to({scaleX:0.97,scaleY:0.97,x:75.4,y:387.6,alpha:0.773},0).wait(1).to({scaleX:0.89,scaleY:0.89,x:76.8,y:384.3,alpha:0.832},0).wait(1).to({scaleX:0.83,scaleY:0.83,x:77.7,y:381.9,alpha:0.875},0).wait(1).to({scaleX:0.79,scaleY:0.79,x:78.4,y:380.1,alpha:0.908},0).wait(1).to({scaleX:0.76,scaleY:0.76,x:78.9,y:378.7,alpha:0.933},0).wait(1).to({scaleX:0.73,scaleY:0.73,x:79.3,y:377.6,alpha:0.952},0).wait(1).to({scaleX:0.71,scaleY:0.71,x:79.7,y:376.8,alpha:0.967},0).wait(1).to({scaleX:0.69,scaleY:0.69,x:79.9,y:376.2,alpha:0.978},0).wait(1).to({scaleX:0.68,scaleY:0.68,x:80.1,y:375.7,alpha:0.987},0).wait(1).to({scaleX:0.67,scaleY:0.67,x:80.3,y:375.3,alpha:0.993},0).wait(1).to({scaleX:0.67,scaleY:0.67,y:375.1,alpha:0.997},0).wait(1).to({scaleX:0.67,scaleY:0.67,x:80.4,y:375,alpha:0.999},0).wait(1).to({regX:128.7,regY:28.1,scaleX:0.67,scaleY:0.67,x:98.6,y:20.7,alpha:1},0).wait(221));

	// snow
	this.instance_3 = new lib.SNOW("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(80.8,559.2,1,1,0,0,0,25,21.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(239));

	// Layer 8
	this.instance_4 = new lib.ss_photosanta();
	this.instance_4.parent = this;
	...
	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#D82532","#AC232E","#B1222D"],[0,0.62,1],-1.4,-156.6,1.4,158.9).s().p("AukZRMAAAgyhIdJAAMAAAAyhg");
	this.shape.setTransform(82.9,444.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(239));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-53.7,298,404.1,607.8);
// library properties:
lib.properties = {
	width: 160,
	height: 600,
	...
	webfonts: {},
	manifest: [
		{src:"images/160x600_flyoverxmas_atlas_.png", id:"160x600_flyoverxmas_atlas_"}
	],
	preloads: []
};
