...
lib.ssMetadata = [
		{name:"300x250_st_hiber_atlas_", frames: [[0,0,150,173],[0,175,135,163]]}
];
...
(lib.salmlemon_bb = function() {
	this.spriteSheet = ss["300x250_st_hiber_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.salmsalt_bb = function() {
	this.spriteSheet = ss["300x250_st_hiber_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.salmsalt_bb();
	this.instance.parent = this;
	this.instance.setTransform(-29.6,35.3,1,1,-6.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-29.6,20.5,152.1,176.8), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.salmlemon_bb();
	this.instance.parent = this;
	this.instance.setTransform(102.4,6,0.999,0.999,22);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(37.6,6,203.7,216.4), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_48.setTransform(260.1,69.4);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAQAAANAGQANAFALAKQAJAKAGAOQAFANAAAQIAABhQAAAQgFANQgGAOgJAKQgLAKgNAGQgNAFgQAAgAgYBKIAYAAQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_49.setTransform(247.6,59);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#063928").s().p("AhJB7IAAj1ICSAAIAAAxIhhAAIAAAyIBJAAIAAAvIhJAAIAAAyIBhAAIAAAxg");
	this.shape_50.setTransform(229.2,59);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICTAAIAAAxIgyAAIAADEg");
	this.shape_51.setTransform(212.1,59);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#063928").s().p("AAYB7IgJgxIgdAAIgKAxIgxAAIAxj1IAwAAIAxD1gAAFAYIgFgYIgEAYIAJAAg");
	this.shape_52.setTransform(196.9,59);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQANAFAKAKQAKAKAGAOQAFANABAQQAAAXgNASQgLAQgTAJIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_53.setTransform(178.6,59);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQAOAFAJAKQAKAKAFAOQAGANABAQQAAAXgNASQgLAQgTAJIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_54.setTransform(160.2,59);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBIAAIAAAvIhIAAIAAAyIBiAAIAAAxg");
	this.shape_55.setTransform(141.9,59);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAPAAAOAGQANAFALAKQAJAKAFAOQAHANAAAQIAABhQAAAQgHANQgFAOgJAKQgLAKgNAGQgOAFgPAAgAgYBKIAYAAQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_56.setTransform(123.5,59);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgwAAIAAj1IAwAAIAwB6IAAh6IAxAAIAAD1g");
	this.shape_57.setTransform(105.2,59);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgGgNABgQIAAirIAwAAIAACrQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAirIAxAAIAACrQABAQgHANQgFAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFg");
	this.shape_58.setTransform(86.8,59);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#063928").s().p("AgYB7IAAh7Igwh6IAwAAIAYA+IAYg+IAxAAIgxB6IAAB7g");
	this.shape_59.setTransform(61.6,59);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQANAFAKAKQAKAKAGAOQAFANABAQQAAAXgNASQgLAQgTAJIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_60.setTransform(44.5,59);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAyIBiAAIAAAxg");
	this.shape_61.setTransform(26.1,59);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#063928").s().p("AgYB7Igxj1IAxAAIAYB6IAYh6IAyAAIgyD1g");
	this.shape_62.setTransform(7.8,59);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#063928").s().p("");
	this.shape_63.setTransform(228.8,24);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_64.setTransform(215.3,24);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgwAAIAAj1IAwAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_65.setTransform(195.1,24);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgGgNABgQIAAhhQgBgPAGgOQAFgOAKgKQALgJANgGQANgGAPAAQAPAAAOAGQANAGAKAJQAKAKAFAOQAHAOAAAPIAABhQAAAQgHANQgFAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_66.setTransform(176.7,24);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_67.setTransform(163.2,24);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_68.setTransform(149.8,24);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#063928").s().p("AAYB7IgKgxIgcAAIgKAxIgxAAIAxj1IAwAAIAyD1gAAEAYIgEgYIgEAYIAIAAg");
	this.shape_69.setTransform(133.7,24);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgxAAIAAj1IAxAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_70.setTransform(115.3,24);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAPAAAOAGQANAGALAJQAJAKAFAOQAHAOAAAPQgBAXgLASQgMARgTAIIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_71.setTransform(97,24);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAAAyIBhAAIAAAxg");
	this.shape_72.setTransform(78.6,24);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAQAAANAGQAOAGAKAJQAJAKAFAOQAHAOgBAPQAAAPgEAMQgFAMgJAJQAJAKAFAMQAEANAAAOQABAQgHANQgFAOgJAKQgKAKgOAGQgNAFgQAAgAgYBKIAYAAQAKAAAHgHQAHgIAAgKQAAgKgHgIQgHgGgKgBIgYAAgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_73.setTransform(60.3,24);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_74.setTransform(46.8,24);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgwAAIAAj1IAwAAIAABjIAwAAIAAhjIAxAAIAAD1g");
	this.shape_75.setTransform(33.4,24);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-2.9,7.6,884.6,74.5), null);
...
// stage content:
(lib._300x250_st_hiber = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(1).to({regX:139.4,regY:114.2,rotation:27.6,x:-32.2,y:448.3},0).wait(1).to({rotation:24.5,x:-24.7,y:431.8},0).wait(1).to({rotation:20.6,x:-15.2,y:410.5},0).wait(1).to({rotation:15.6,x:-3.6,y:383.2},0).wait(1).to({rotation:9.6,x:9.8,y:350.6},0).wait(1).to({rotation:3.4,x:23,y:317.5},0).wait(1).to({rotation:-1.8,x:33.7,y:289.3},0).wait(1).to({rotation:-5.9,x:41.9,y:267.2},0).wait(1).to({rotation:-9.2,x:48,y:250.2},0).wait(1).to({rotation:-11.7,x:52.8,y:236.8},0).wait(1).to({rotation:-13.7,x:56.6,y:226.1},0).wait(1).to({rotation:-15.3,x:59.5,y:217.4},0).wait(1).to({rotation:-16.7,x:62,y:210.4},0).wait(1).to({rotation:-17.8,x:64,y:204.7},0).wait(1).to({rotation:-18.7,x:65.6,y:199.9},0).wait(1).to({rotation:-19.4,x:66.9,y:196.1},0).wait(1).to({rotation:-20.1,x:68,y:192.9},0).wait(1).to({rotation:-20.5,x:68.8,y:190.4},0).wait(1).to({rotation:-20.9,x:69.5,y:188.3},0).wait(1).to({rotation:-21.2,x:70.1,y:186.8},0).wait(1).to({rotation:-21.4,x:70.4,y:185.7},0).wait(1).to({rotation:-21.6,x:70.6,y:184.9},0).wait(1).to({rotation:-21.7,x:70.9,y:184.4},0).wait(1).to({regX:89.4,regY:133.6,x:31.7,y:220.7},0).wait(138));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({regX:46.4,regY:108.9,rotation:-42.6,x:401.1,y:460.9},0).wait(1).to({rotation:-39.5,x:390.2,y:442},0).wait(1).to({rotation:-35.6,x:376.6,y:417.8},0).wait(1).to({rotation:-30.5,x:359.4,y:387.2},0).wait(1).to({rotation:-24.5,x:339.4,y:350.9},0).wait(1).to({rotation:-18.3,x:319.5,y:314.5},0).wait(1).to({rotation:-13,x:302.8,y:283.8},0).wait(1).to({rotation:-8.9,x:289.9,y:260.1},0).wait(1).to({rotation:-5.7,x:280,y:241.8},0).wait(1).to({rotation:-3.1,x:272.3,y:227.6},0).wait(1).to({rotation:-1.1,x:266.1,y:216.3},0).wait(1).to({rotation:0.6,x:261.2,y:207.1},0).wait(1).to({rotation:1.9,x:257.1,y:199.8},0).wait(1).to({rotation:3,x:253.8,y:193.7},0).wait(1).to({rotation:3.9,x:251,y:188.7},0).wait(1).to({rotation:4.7,x:248.8,y:184.7},0).wait(1).to({rotation:5.3,x:247,y:181.4},0).wait(1).to({rotation:5.8,x:245.5,y:178.7},0).wait(1).to({rotation:6.2,x:244.4,y:176.6},0).wait(1).to({rotation:6.5,x:243.5,y:175},0).wait(1).to({rotation:6.7,x:242.8,y:173.8},0).wait(1).to({rotation:6.9,x:242.3,y:173},0).wait(1).to({x:242.1,y:172.6},0).wait(1).to({regX:67.6,regY:174.6,rotation:7,x:255.1,y:240.1},0).wait(138));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(67).to({regX:438.9,regY:38.8,x:456.7,y:58.5},0).wait(1).to({x:455},0).wait(1).to({x:451.8},0).wait(1).to({x:446.7},0).wait(1).to({x:439.1},0).wait(1).to({x:428.3},0).wait(1).to({x:412.7},0).wait(1).to({x:389.9,y:58.4},0).wait(1).to({x:355.3},0).wait(1).to({x:305.5},0).wait(1).to({x:253.1,y:58.3},0).wait(1).to({x:215.4},0).wait(1).to({x:190.6,y:58.2},0).wait(1).to({x:173.8},0).wait(1).to({x:162.3},0).wait(1).to({x:154.4},0).wait(1).to({x:149.1},0).wait(1).to({x:145.7},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(56));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_st_hiber_atlas_.png", id:"300x250_st_hiber_atlas_"}
	],
	preloads: []
};
