...
lib.ssMetadata = [
		{name:"300x250_st_enjoy_atlas_", frames: [[0,0,171,189],[0,191,114,140],[116,191,84,114]]}
];
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.ribbon_bb2();
	this.instance.parent = this;
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({regX:158.2,regY:155.6,rotation:27.6,x:-47.1,y:375.5},0).wait(1).to({rotation:24.5,x:-36.4,y:366.4},0).wait(1).to({rotation:20.6,x:-22.9,y:354.4},0).wait(1).to({rotation:15.6,x:-6,y:338.7},0).wait(1).to({rotation:9.6,x:13.7,y:319.6},0).wait(1).to({rotation:3.4,x:32.9,y:299.6},0).wait(1).to({rotation:-1.8,x:48.8,y:282.4},0).wait(1).to({rotation:-5.9,x:60.9,y:268.7},0).wait(1).to({rotation:-9.2,x:70.1,y:257.9},0).wait(1).to({rotation:-11.7,x:77.1,y:249.4},0).wait(1).to({rotation:-13.7,x:82.6,y:242.7},0).wait(1).to({rotation:-15.3,x:87.1,y:237.2},0).wait(1).to({rotation:-16.7,x:90.7,y:232.7},0).wait(1).to({rotation:-17.8,x:93.6,y:229},0).wait(1).to({rotation:-18.7,x:95.9,y:226},0).wait(1).to({rotation:-19.4,x:97.8,y:223.4},0).wait(1).to({rotation:-20.1,x:99.4,y:221.4},0).wait(1).to({rotation:-20.5,x:100.7,y:219.7},0).wait(1).to({rotation:-20.9,x:101.7,y:218.5},0).wait(1).to({rotation:-21.2,x:102.4,y:217.4},0).wait(1).to({rotation:-21.4,x:103,y:216.7},0).wait(1).to({rotation:-21.6,x:103.4,y:216.2},0).wait(1).to({rotation:-21.7,x:103.6,y:215.9},0).wait(1).to({regX:89.4,regY:133.6,x:31.7,y:220.7},0).wait(63).to({regX:89.2,regY:133.7,rotation:33.2,x:-30.5,y:146.9},19).wait(200));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(67).to({regX:582.9,regY:49.7,x:600.7,y:69.4},0).wait(1).to({x:599},0).wait(1).to({x:595.8},0).wait(1).to({x:590.7},0).wait(1).to({x:583.1},0).wait(1).to({x:572.3},0).wait(1).to({x:556.7},0).wait(1).to({x:533.9,y:69.3},0).wait(1).to({x:499.3},0).wait(1).to({x:449.5},0).wait(1).to({x:397.1,y:69.2},0).wait(1).to({x:359.4},0).wait(1).to({x:334.6,y:69.1},0).wait(1).to({x:317.8},0).wait(1).to({x:306.3},0).wait(1).to({x:298.4},0).wait(1).to({x:293.1},0).wait(1).to({x:289.7},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(55).to({regX:582.9,regY:49.7,x:287,y:69.1},0).wait(1).to({x:284},0).wait(1).to({x:278.5},0).wait(1).to({x:269.6},0).wait(1).to({x:256.4},0).wait(1).to({x:237.4},0).wait(1).to({x:211},0).wait(1).to({x:176.3},0).wait(1).to({x:135.8},0).wait(1).to({x:96.8},0).wait(1).to({x:64.7},0).wait(1).to({x:40.3},0).wait(1).to({x:22.2},0).wait(1).to({x:9},0).wait(1).to({x:-0.5},0).wait(1).to({x:-7},0).wait(1).to({x:-11.1},0).wait(1).to({x:-13.4},0).wait(1).to({regX:131.7,regY:89,x:-465.3,y:108.4},0).wait(53).to({regX:582.9,regY:49.7,x:-14.9,y:69.1},0).wait(1).to({x:-17.7},0).wait(1).to({x:-22.8},0).wait(1).to({x:-30.8},0).wait(1).to({x:-42.7},0).wait(1).to({x:-59.5},0).wait(1).to({x:-82.8},0).wait(1).to({x:-113.8},0).wait(1).to({x:-151.7},0).wait(1).to({x:-191.5},0).wait(1).to({x:-226.8},0).wait(1).to({x:-254.9},0).wait(1).to({x:-276.3},0).wait(1).to({x:-292.3},0).wait(1).to({x:-304.1},0).wait(1).to({x:-312.6},0).wait(1).to({x:-318.5},0).wait(1).to({x:-322.4},0).wait(1).to({x:-324.5},0).wait(1).to({regX:131.7,regY:89,x:-776.3,y:108.4},0).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(103).to({_off:false},0).to({alpha:1},10).wait(194));
