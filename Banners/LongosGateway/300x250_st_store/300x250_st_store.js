...
lib.ssMetadata = [
		{name:"300x250_st_store_atlas_", frames: [[0,129,102,103],[0,0,111,127]]}
];
...
(lib.peach_bb = function() {
	this.spriteSheet = ss["300x250_st_store_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.peaches_bb = function() {
	this.spriteSheet = ss["300x250_st_store_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.peach_bb();
	this.instance.parent = this;
	this.instance.setTransform(10.9,89.1,1,1,-6.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(10.9,77.9,112.7,113.5), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.peaches_bb();
	this.instance.parent = this;
	this.instance.setTransform(95.3,32.4,0.999,0.999,22);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(47.7,32.4,150.4,159.2), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_48.setTransform(212.4,139.4);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#063928").s().p("");
	this.shape_49.setTransform(199.9,129);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#063928").s().p("");
	this.shape_50.setTransform(181.5,129);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#063928").s().p("AhJB7IAAj1ICSAAIAAAxIhhAAIAAAyIBJAAIAAAvIhJAAIAAAxIBhAAIAAAyg");
	this.shape_51.setTransform(163.2,129);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgxAAIAAj1IAxAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_52.setTransform(144.8,129);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAxIBiAAIAAAyg");
	this.shape_53.setTransform(126.5,129);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQAOAFAJAKQAKALAFANQAHANAAAQQgBAYgMARQgLAQgTAJIArBpgAgYgXIAYAAQAKgBAHgGQAHgIAAgKQAAgKgHgHQgHgIgKAAIgYAAg");
	this.shape_54.setTransform(108.1,129);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#063928").s().p("AgdB1QgNgFgJgKQgLgKgFgNQgGgOABgQIAAhhQgBgQAGgNQAFgNALgLQAJgKANgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKALAFANQAHANAAAQIAABhQAAAQgHAOQgFANgKAKQgKAKgNAFQgOAGgPAAQgPAAgOgGgAgRhBQgHAHAAAKIAABhQAAAKAHAIQAHAGAKAAQAKAAAHgGQAHgIAAgKIAAhhQAAgKgHgHQgHgIgKAAQgKAAgHAIg");
	this.shape_55.setTransform(89.8,129);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_56.setTransform(72.6,129);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#063928").s().p("");
	this.shape_57.setTransform(55.5,129);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAAAyIBhAAIAAAxg");
	this.shape_58.setTransform(245.6,94);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgwAAIAAj1IAwAAIAABjIAwAAIAAhjIAxAAIAAD1g");
	this.shape_59.setTransform(227.2,94);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_60.setTransform(208.9,94);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#063928").s().p("Ag8B7IAAj1IAwAAIAADEIBJAAIAAAxg");
	this.shape_61.setTransform(184.9,94);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#063928").s().p("Ag8B7IAAj1IAwAAIAADEIBJAAIAAAxg");
	this.shape_62.setTransform(169,94);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#063928").s().p("AAYB7IgKgxIgcAAIgKAxIgwAAIAwj1IAwAAIAyD1gAAEAYIgEgYIgEAYIAIAAg");
	this.shape_63.setTransform(151.9,94);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICSAAIAAAxIgyAAIAADEg");
	this.shape_64.setTransform(126.7,94);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#063928").s().p("AgcB1QgNgFgLgKQgKgKgFgOQgGgNABgQIAAirIAwAAIAACrQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAirIAyAAIAACrQAAAQgHANQgFAOgKAKQgKAKgNAFQgOAGgPAAQgPAAgNgGg");
	this.shape_65.setTransform(108.3,94);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#063928").s().p("AgcB1QgNgFgLgKQgKgKgFgOQgGgNABgQIAAhhQgBgQAGgNQAFgNAKgLQALgKANgFQANgGAPAAQAQAAANAGQANAFAKAKQAKALAFANQAHANgBAQIAABhQABAQgHANQgFAOgKAKQgKAKgNAFQgNAGgQAAQgPAAgNgGgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgHgKAAQgKAAgHAHg");
	this.shape_66.setTransform(90,94);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgwAAIAAj1IAwAAIAABjIAwAAIAAhjIAxAAIAAD1g");
	this.shape_67.setTransform(71.6,94);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICSAAIAAAxIgxAAIAADEg");
	this.shape_68.setTransform(53.3,94);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_69.setTransform(39.8,94);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#063928").s().p("AAZB7IgZh7IgYB7IgxAAIgwj1IAwAAIAZB6IAYh6IAxAAIAYB6IAZh6IAwAAIgwD1g");
	this.shape_70.setTransform(21.4,94);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#063928").s().p("AgKAmIAHgmIgPAAIAAglIAlAAIAAATIgWA4g");
	this.shape_71.setTransform(212.4,71.3);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#063928").s().p("");
	this.shape_72.setTransform(199.8,59);
	...
	this.shape_73.setTransform(182.7,59);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAyIBiAAIAAAxg");
	this.shape_74.setTransform(165.5,59);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgxAAIAAj1IAxAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_75.setTransform(147.2,59);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgxAAIAAj1IAxAAIAABjIAwAAIAAhjIAyAAIAAD1g");
	this.shape_76.setTransform(128.8,59);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#063928").s().p("");
	this.shape_77.setTransform(110.5,59);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAAAyIBhAAIAAAxg");
	this.shape_78.setTransform(92.1,59);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAQAAANAGQAOAFAKAKQAJAKAFAOQAHANgBAQQABAXgMASQgMAQgTAJIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_79.setTransform(73.8,59);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAABjg");
	this.shape_80.setTransform(55.4,59);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#063928").s().p("");
	this.shape_81.setTransform(178,24);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#063928").s().p("AgSAmIAAhLIAlAAIgPBLg");
	this.shape_82.setTransform(166.5,13.6);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgFgNAAgQIAAhhQAAgPAFgOQAFgOAKgKQALgJANgGQANgGAPAAQAQAAANAGQANAGAKAJQAKAKAGAOQAFAOAAAPIAABhQAAAQgFANQgGAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_83.setTransform(154,24);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#063928").s().p("");
	this.shape_84.setTransform(135.6,24);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgxAAIAAj1IAxAAIAwB6IAAh6IAxAAIAAD1g");
	this.shape_85.setTransform(117.3,24);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("#063928").s().p("AgdB2QgNgGgJgKQgKgKgGgOQgFgNgBgQIAAhhQABgPAFgOQAGgOAKgKQAJgJANgGQAOgGAPAAQAPAAAOAGQANAGAKAJQAKAKAGAOQAFAOABAPIAABhQgBAQgFANQgGAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_86.setTransform(98.9,24);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("#063928").s().p("Ag8B7IAAj1IAxAAIAADEIBIAAIAAAxg");
	this.shape_87.setTransform(83,24);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(5.9,7.6,875.7,144.5), null);
...
// stage content:
(lib._300x250_st_store = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(1).to({regX:122.9,regY:112,rotation:27.6,x:-45.7,y:438.7},0).wait(1).to({rotation:24.5,x:-38.8,y:422.9},0).wait(1).to({rotation:20.6,x:-29.9,y:402.6},0).wait(1).to({rotation:15.6,x:-18.9,y:376.7},0).wait(1).to({rotation:9.6,x:-6,y:345.7},0).wait(1).to({rotation:3.4,x:6.6,y:314.3},0).wait(1).to({rotation:-1.8,x:17.2,y:287.6},0).wait(1).to({rotation:-5.9,x:25.3,y:266.8},0).wait(1).to({rotation:-9.2,x:31.4,y:250.6},0).wait(1).to({rotation:-11.7,x:36.2,y:238},0).wait(1).to({rotation:-13.7,x:40,y:227.9},0).wait(1).to({rotation:-15.3,x:43.1,y:219.7},0).wait(1).to({rotation:-16.7,x:45.5,y:213.1},0).wait(1).to({rotation:-17.8,x:47.6,y:207.6},0).wait(1).to({rotation:-18.7,x:49.2,y:203.2},0).wait(1).to({rotation:-19.4,x:50.7,y:199.5},0).wait(1).to({rotation:-20.1,x:51.7,y:196.5},0).wait(1).to({rotation:-20.5,x:52.6,y:194.1},0).wait(1).to({rotation:-20.9,x:53.3,y:192.2},0).wait(1).to({rotation:-21.2,x:53.9,y:190.7},0).wait(1).to({rotation:-21.4,x:54.3,y:189.6},0).wait(1).to({rotation:-21.6,x:54.5,y:189},0).wait(1).to({rotation:-21.7,x:54.7,y:188.5},0).wait(1).to({regX:89.4,regY:133.6,x:31.7,y:220.7},0).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({regX:67.2,regY:134.7,rotation:-42.6,x:433.9,y:465.9},0).wait(1).to({rotation:-39.5,x:422.7,y:448.7},0).wait(1).to({rotation:-35.6,x:408.5,y:426.7},0).wait(1).to({rotation:-30.5,x:390.4,y:398.9},0).wait(1).to({rotation:-24.5,x:369,y:365.7},0).wait(1).to({rotation:-18.3,x:347.3,y:332.4},0).wait(1).to({rotation:-13,x:328.9,y:304.3},0).wait(1).to({rotation:-8.9,x:314.5,y:282.4},0).wait(1).to({rotation:-5.7,x:303.2,y:265.5},0).wait(1).to({rotation:-3.1,x:294.5,y:252.2},0).wait(1).to({rotation:-1.1,x:287.4,y:241.7},0).wait(1).to({rotation:0.6,x:281.7,y:233.1},0).wait(1).to({rotation:1.9,x:277,y:226.2},0).wait(1).to({rotation:3,x:273.2,y:220.5},0).wait(1).to({rotation:3.9,x:270,y:215.9},0).wait(1).to({rotation:4.7,x:267.4,y:212.1},0).wait(1).to({rotation:5.3,x:265.3,y:208.9},0).wait(1).to({rotation:5.8,x:263.6,y:206.5},0).wait(1).to({rotation:6.2,x:262.3,y:204.5},0).wait(1).to({rotation:6.5,x:261.2,y:203},0).wait(1).to({rotation:6.7,x:260.5,y:201.9},0).wait(1).to({rotation:6.9,x:259.9,y:201.1},0).wait(1).to({x:259.7,y:200.7},0).wait(1).to({regX:67.6,regY:174.6,rotation:7,x:255.1,y:240.1},0).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(79).to({regX:443.3,regY:73.8,x:461.1,y:93.5},0).wait(1).to({x:459.4},0).wait(1).to({x:456.2},0).wait(1).to({x:451.1},0).wait(1).to({x:443.5},0).wait(1).to({x:432.7},0).wait(1).to({x:417.1},0).wait(1).to({x:394.3,y:93.4},0).wait(1).to({x:359.7},0).wait(1).to({x:309.9},0).wait(1).to({x:257.5,y:93.3},0).wait(1).to({x:219.8},0).wait(1).to({x:195,y:93.2},0).wait(1).to({x:178.2},0).wait(1).to({x:166.7},0).wait(1).to({x:158.8},0).wait(1).to({x:153.5},0).wait(1).to({x:150.1},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(67));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_st_store_atlas_.png", id:"300x250_st_store_atlas_"}
	],
	preloads: []
};
