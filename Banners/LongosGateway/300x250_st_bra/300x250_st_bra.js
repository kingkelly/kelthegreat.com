...
lib.ssMetadata = [
		{name:"300x250_st_bra_atlas_", frames: [[0,0,96,152],[98,0,97,120]]}
];
...
(lib.bb_butter = function() {
	this.spriteSheet = ss["300x250_st_bra_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.bb_eggs = function() {
	this.spriteSheet = ss["300x250_st_bra_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.bb_eggs();
	this.instance.parent = this;
	this.instance.setTransform(5,70.5,1,1,-6.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(5,59.9,109.6,129.9), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.bb_butter();
	this.instance.parent = this;
	this.instance.setTransform(102.1,12.5,0.999,0.999,22);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(45.1,12.5,145.9,176.7), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_48.setTransform(218.3,69.4);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#063928").s().p("AAxB7IAAh7IgZB7IgwAAIgZh7IAAB7IgwAAIAAj1IBJAAIAYB6IAYh6IBKAAIAAD1g");
	this.shape_49.setTransform(203.3,59);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#063928").s().p("AhIB7IAAj1ICSAAIAAAxIhiAAIAAAyIBIAAIAAAvIhIAAIAAAyIBiAAIAAAxg");
	this.shape_50.setTransform(182.5,59);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#063928").s().p("Ag8B7IAAj1IAxAAIAADEIBIAAIAAAxg");
	this.shape_51.setTransform(165.3,59);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#063928").s().p("AhJB7IAAj1IBJAAQAQAAANAGQANAFAKAKQAKAKAGAOQAFANAAAQQAAAPgEAMQgFAMgJAJQAJAKAFANQAEAMAAAOQAAAQgFANQgGAOgKAKQgKAKgNAGQgNAFgQAAgAgYBKIAYAAQAKgBAHgGQAHgIAAgKQAAgKgHgIQgHgHgKAAIgYAAgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_52.setTransform(148.2,59);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#063928").s().p("AgcB2QgOgGgKgKQgJgKgGgOQgFgNgBgQIAAhhQABgQAFgNQAGgOAJgKQAKgKAOgFQANgGAPAAQAPAAAOAGQANAFAKAKQAKAKAGAOQAFANAAAQIAABhQAAAQgFANQgGAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_53.setTransform(129.9,59);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQANAFAKAKQAKAKAGAOQAFANABAQQAAAXgNASQgLAQgTAJIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_54.setTransform(111.5,59);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#063928").s().p("AhJB7IAAj1IBJAAQAPAAAOAGQAOAFAJAKQAKAKAGAOQAFANABAQQgBAQgFANQgGANgKAKQgJAKgOAFQgOAGgPgBIgYAAIAABjgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_55.setTransform(93.2,59);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#063928").s().p("AgdB2QgNgGgJgKQgKgKgGgOQgGgNAAgQIAAhhQAAgQAGgNQAGgOAKgKQAJgKANgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKAKAFAOQAGANABAQIAABhQgBAQgGANQgFAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_56.setTransform(68,59);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgxAAIAAj1IAxAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_57.setTransform(49.6,59);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#063928").s().p("AgKAmIAHgmIgPAAIAAglIAlAAIAAATIgWA4g");
	this.shape_58.setTransform(259.1,36.3);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#063928").s().p("");
	this.shape_59.setTransform(246.6,24);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAABjg");
	this.shape_60.setTransform(228.2,24);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBJAAIAAAvIhJAAIAAAyIBhAAIAAAxg");
	this.shape_61.setTransform(209.9,24);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_62.setTransform(196.4,24);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAQAAANAGQANAGAKAJQAKAKAGAOQAFAOAAAPQAAAXgMASQgLARgTAIIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_63.setTransform(183,24);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#063928").s().p("AhJB7IAAj1IBJAAQAPAAAOAGQANAGAKAJQAKAKAGAOQAFAOABAPQgBAPgFAMQgEAMgIAJQAIAKAEAMQAFANABAOQgBAQgFANQgGAOgKAKQgKAKgNAGQgOAFgPAAgAgYBKIAYAAQAKAAAHgHQAHgIAAgKQAAgKgHgIQgHgGgKgBIgYAAgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_64.setTransform(164.6,24);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#063928").s().p("AgdB2QgNgGgJgKQgKgKgGgOQgFgNgBgQIAAhhQABgPAFgOQAGgOAKgKQAJgJANgGQAOgGAPAAQAPAAAOAGQANAGAKAJQAKAKAGAOQAFAOABAPIAABhQgBAQgFANQgGAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_65.setTransform(139.4,24);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgxAAIAAj1IAxAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_66.setTransform(121.1,24);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#063928").s().p("AgKAmIAHgmIgPAAIAAglIAlAAIAAATIgWA4g");
	this.shape_67.setTransform(101.5,36.3);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#063928").s().p("AAYB7IgKgxIgcAAIgKAxIgwAAIAwj1IAwAAIAxD1gAAEAYIgEgYIgEAYIAIAAg");
	this.shape_68.setTransform(89,24);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAQAAANAGQAOAGAKAJQAJAKAFAOQAHAOgBAPQABAXgMASQgMARgTAIIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_69.setTransform(70.6,24);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAQAAANAGQANAGALAJQAJAKAGAOQAFAOAAAPQAAAPgEAMQgFAMgJAJQAJAKAFAMQAEANAAAOQAAAQgFANQgGAOgJAKQgLAKgNAGQgNAFgQAAgAgYBKIAYAAQAKAAAHgHQAHgIAAgKQAAgKgHgIQgHgGgKgBIgYAAgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_70.setTransform(52.3,24);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgFgNAAgQIAAhhQAAgPAFgOQAFgOAKgKQALgJANgGQANgGAPAAQAQAAANAGQANAGAKAJQAKAKAGAOQAFAOAAAPIAABhQAAAQgFANQgGAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_71.setTransform(27.1,24);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgwAAIAAj1IAwAAIAwB6IAAh6IAxAAIAAD1g");
	this.shape_72.setTransform(8.7,24);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-2,7.6,883.6,74.5), null);
...
// stage content:
(lib._300x250_st_bra = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(1).to({regX:118,regY:100.9,rotation:27.6,x:-44.9,y:426.7},0).wait(1).to({rotation:24.5,x:-38.6,y:410.8},0).wait(1).to({rotation:20.6,x:-30.6,y:390.5},0).wait(1).to({rotation:15.6,x:-20.6,y:364.7},0).wait(1).to({rotation:9.6,x:-9.1,y:333.9},0).wait(1).to({rotation:3.4,x:2.4,y:302.9},0).wait(1).to({rotation:-1.8,x:11.9,y:276.7},0).wait(1).to({rotation:-5.9,x:19.2,y:256.2},0).wait(1).to({rotation:-9.2,x:24.8,y:240.4},0).wait(1).to({rotation:-11.7,x:29.2,y:228.1},0).wait(1).to({rotation:-13.7,x:32.6,y:218.2},0).wait(1).to({rotation:-15.3,x:35.4,y:210.3},0).wait(1).to({rotation:-16.7,x:37.7,y:203.8},0).wait(1).to({rotation:-17.8,x:39.6,y:198.5},0).wait(1).to({rotation:-18.7,x:41,y:194.2},0).wait(1).to({rotation:-19.4,x:42.3,y:190.6},0).wait(1).to({rotation:-20.1,x:43.3,y:187.8},0).wait(1).to({rotation:-20.5,x:44.1,y:185.4},0).wait(1).to({rotation:-20.9,x:44.8,y:183.6},0).wait(1).to({rotation:-21.2,x:45.3,y:182.2},0).wait(1).to({rotation:-21.4,x:45.7,y:181.1},0).wait(1).to({rotation:-21.6,x:45.9,y:180.4},0).wait(1).to({rotation:-21.7,x:46,y:180},0).wait(1).to({regX:89.4,regY:133.6,x:31.7,y:220.7},0).wait(138));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({regX:59.7,regY:124.8,rotation:-42.6,x:421.7,y:463.6},0).wait(1).to({rotation:-39.5,x:410.6,y:445.8},0).wait(1).to({rotation:-35.6,x:396.6,y:423},0).wait(1).to({rotation:-30.5,x:378.9,y:394.1},0).wait(1).to({rotation:-24.5,x:358.1,y:359.8},0).wait(1).to({rotation:-18.3,x:337.1,y:325.4},0).wait(1).to({rotation:-13,x:319.4,y:296.3},0).wait(1).to({rotation:-8.9,x:305.5,y:273.7},0).wait(1).to({rotation:-5.7,x:294.8,y:256.3},0).wait(1).to({rotation:-3.1,x:286.4,y:242.7},0).wait(1).to({rotation:-1.1,x:279.7,y:232},0).wait(1).to({rotation:0.6,x:274.3,y:223.2},0).wait(1).to({rotation:1.9,x:269.8,y:216.1},0).wait(1).to({rotation:3,x:266.2,y:210.2},0).wait(1).to({rotation:3.9,x:263.2,y:205.5},0).wait(1).to({rotation:4.7,x:260.8,y:201.6},0).wait(1).to({rotation:5.3,x:258.8,y:198.4},0).wait(1).to({rotation:5.8,x:257.2,y:195.9},0).wait(1).to({rotation:6.2,x:255.9,y:193.8},0).wait(1).to({rotation:6.5,x:254.9,y:192.3},0).wait(1).to({rotation:6.7,x:254.2,y:191.1},0).wait(1).to({rotation:6.9,x:253.6,y:190.4},0).wait(1).to({x:253.4,y:190},0).wait(1).to({regX:67.6,regY:174.6,rotation:7,x:255.1,y:240.1},0).wait(138));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(67).to({regX:439.4,regY:38.8,x:457.2,y:58.5},0).wait(1).to({x:455.5},0).wait(1).to({x:452.3},0).wait(1).to({x:447.2},0).wait(1).to({x:439.6},0).wait(1).to({x:428.8},0).wait(1).to({x:413.2},0).wait(1).to({x:390.4,y:58.4},0).wait(1).to({x:355.8},0).wait(1).to({x:306},0).wait(1).to({x:253.6,y:58.3},0).wait(1).to({x:215.9},0).wait(1).to({x:191.1,y:58.2},0).wait(1).to({x:174.3},0).wait(1).to({x:162.8},0).wait(1).to({x:154.9},0).wait(1).to({x:149.6},0).wait(1).to({x:146.2},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(56));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_st_bra_atlas_.png", id:"300x250_st_bra_atlas_"}
	],
	preloads: []
};
