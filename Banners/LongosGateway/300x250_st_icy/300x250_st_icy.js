...
lib.ssMetadata = [
		{name:"300x250_st_icy_atlas_", frames: [[0,0,163,159],[0,161,133,165]]}
];
...
(lib.pep_bb = function() {
	this.spriteSheet = ss["300x250_st_icy_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.zuc_bb();
	this.instance.parent = this;
	this.instance.setTransform(-17,50.2,1,1,-6.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-17,35.6,150.3,178.6), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.pep_bb();
	this.instance.parent = this;
	this.instance.setTransform(125.7,29.8,0.999,0.999,22);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(66.1,29.8,210.5,208.3), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_48.setTransform(216.1,104.4);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#063928").s().p("AhJB7IAAj1IBJAAQAPAAAOAGQANAFAKAKQAKALAGANQAFANABAQIAABhQgBAQgFANQgGAOgKAKQgKAKgNAFQgOAGgPAAgAgYBKIAYAAQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgHgKAAIgYAAg");
	this.shape_49.setTransform(203.8,94);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#063928").s().p("AgdB1QgNgFgJgKQgLgKgFgOQgGgNABgQIAAhhQgBgQAGgNQAFgNALgLQAJgKANgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKALAFANQAHANAAAQIAABhQAAAQgHANQgFAOgKAKQgKAKgNAFQgOAGgPAAQgPAAgOgGgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgHgKAAQgKAAgHAHg");
	this.shape_50.setTransform(185.6,94);
	...
	this.shape_51.setTransform(167.5,94);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAABjg");
	this.shape_52.setTransform(149.3,94);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgwAAIAAj1IAwAAIAABjIAwAAIAAhjIAxAAIAAD1g");
	this.shape_53.setTransform(124.5,94);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#063928").s().p("");
	this.shape_54.setTransform(106.4,94);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAyIBiAAIAAAxg");
	this.shape_55.setTransform(88.2,94);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAPAAAOAGQAOAFAKAKQAJALAFANQAHANAAAQQAAAYgMARQgMAQgTAJIArBpgAgYgXIAYAAQAKgBAHgGQAHgIAAgKQAAgKgHgIQgHgHgKAAIgYAAg");
	this.shape_56.setTransform(70.1,94);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#063928").s().p("AhJB7IAAj1ICSAAIAAAxIhhAAIAAAyIBJAAIAAAvIhJAAIAABjg");
	this.shape_57.setTransform(51.9,94);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQANAFAKAKQAKAKAGAOQAFANAAAQQAAAXgMASQgLAQgTAJIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_58.setTransform(221.7,59);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#063928").s().p("AgdB2QgMgGgKgKQgLgKgFgOQgGgNAAgQIAAhhQAAgQAGgNQAFgOALgKQAKgKAMgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKAKAFAOQAHANAAAQIAABhQAAAQgHANQgFAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_59.setTransform(203.5,59);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAABjg");
	this.shape_60.setTransform(186.4,59);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#063928").s().p("");
	this.shape_61.setTransform(161.6,59);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAPAAAOAGQAOAFAKAKQAJAKAFAOQAHANgBAQIAABhQABAQgHANQgFAOgJAKQgKAKgOAGQgOAFgPAAgAgYBKIAYAAQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_62.setTransform(143.4,59);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#063928").s().p("AAYB7IgJgxIgdAAIgKAxIgwAAIAwj1IAwAAIAxD1gAAFAYIgFgYIgEAYIAJAAg");
	this.shape_63.setTransform(125.3,59);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#063928").s().p("AgdB2QgMgGgKgKQgLgKgFgOQgGgNAAgQIAAhhQAAgQAGgNQAFgOALgKQAKgKAMgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKAKAFAOQAHANAAAQIAABhQAAAQgHANQgFAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_64.setTransform(108.1,59);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAQAAANAGQAOAFAKAKQAJAKAFAOQAHANgBAQQABAXgMASQgMAQgTAJIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_65.setTransform(90,59);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#063928").s().p("AgYB7IAAh7Igxh6IAxAAIAYA+IAYg+IAyAAIgyB6IAAB7g");
	this.shape_66.setTransform(65.2,59);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgGgNABgQIAAhhQgBgQAGgNQAFgOAKgKQALgKANgFQANgGAPAAQAQAAANAGQANAFAKAKQAKAKAFAOQAHANgBAQIgxAAQAAgKgHgIQgHgGgKgBQgKABgHAGQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAxAAQABAQgHANQgFAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFg");
	this.shape_67.setTransform(49,59);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_68.setTransform(35.7,59);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#063928").s().p("AAYB7Igwh7IAwh6IAyAAIgyB6IAyB7gAhIB7IAAj1IAwAAIAAB6IAAB7gAgYAAg");
	this.shape_69.setTransform(196,24);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#063928").s().p("");
	this.shape_70.setTransform(177.8,24);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_71.setTransform(164.5,24);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQAOAGAJAJQAKAKAFAOQAHAOAAAPQgBAXgMASQgLARgTAIIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_72.setTransform(151.3,24);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_73.setTransform(126.5,24);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#063928").s().p("AgSAmIAAhLIAlAAIgPBLg");
	this.shape_74.setTransform(115.1,13.6);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgxAAIAAj1IAxAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_75.setTransform(102.7,24);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgGgNABgQIAAhhQgBgPAGgOQAFgOAKgKQALgJANgGQANgGAPAAQAQAAANAGQANAGAKAJQAKAKAFAOQAHAOgBAPIAABhQABAQgHANQgFAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_76.setTransform(84.6,24);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#063928").s().p("AhJB7IAAj1IBJAAQAPAAAOAGQANAGAKAJQAKAKAGAOQAFAOAAAPIAABhQAAAQgFANQgGAOgKAKQgKAKgNAGQgOAFgPAAgAgYBKIAYAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_77.setTransform(66.4,24);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(30,7.6,851.6,109.5), null);
...
// stage content:
(lib._300x250_st_icy = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(1).to({regX:171.3,regY:133.9,rotation:27.6,x:-14.9,y:480.5},0).wait(1).to({rotation:24.5,x:-8.1,y:462.7},0).wait(1).to({rotation:20.6,x:0.2,y:439.8},0).wait(1).to({rotation:15.6,x:10.4,y:410.2},0).wait(1).to({rotation:9.6,x:21.8,y:374.6},0).wait(1).to({rotation:3.4,x:32.6,y:338},0).wait(1).to({rotation:-1.8,x:41,y:306.8},0).wait(1).to({rotation:-5.9,x:47.1,y:282.1},0).wait(1).to({rotation:-9.2,x:51.6,y:263},0).wait(1).to({rotation:-11.7,x:55,y:248},0).wait(1).to({rotation:-13.7,x:57.5,y:236},0).wait(1).to({rotation:-15.3,x:59.6,y:226.2},0).wait(1).to({rotation:-16.7,x:61.2,y:218.3},0).wait(1).to({rotation:-17.8,x:62.5,y:211.8},0).wait(1).to({rotation:-18.7,x:63.5,y:206.5},0).wait(1).to({rotation:-19.4,x:64.3,y:202.1},0).wait(1).to({rotation:-20.1,x:65,y:198.5},0).wait(1).to({rotation:-20.5,x:65.6,y:195.7},0).wait(1).to({rotation:-20.9,x:66,y:193.3},0).wait(1).to({rotation:-21.2,x:66.3,y:191.6},0).wait(1).to({rotation:-21.4,x:66.5,y:190.4},0).wait(1).to({rotation:-21.6,x:66.6,y:189.5},0).wait(1).to({rotation:-21.7,x:66.8,y:189},0).wait(1).to({regX:89.4,regY:133.6,x:-9.3,y:218.7},0).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({regX:58.1,regY:124.9,rotation:-42.6,x:420.6,y:464.8},0).wait(1).to({rotation:-39.5,x:409.5,y:446.9},0).wait(1).to({rotation:-35.6,x:395.4,y:424},0).wait(1).to({rotation:-30.5,x:377.6,y:395},0).wait(1).to({rotation:-24.5,x:356.7,y:360.6},0).wait(1).to({rotation:-18.3,x:335.6,y:326},0).wait(1).to({rotation:-13,x:317.8,y:296.8},0).wait(1).to({rotation:-8.9,x:304,y:274.1},0).wait(1).to({rotation:-5.7,x:293.2,y:256.6},0).wait(1).to({rotation:-3.1,x:284.9,y:242.9},0).wait(1).to({rotation:-1.1,x:278.1,y:232.1},0).wait(1).to({rotation:0.6,x:272.7,y:223.3},0).wait(1).to({rotation:1.9,x:268.2,y:216.2},0).wait(1).to({rotation:3,x:264.6,y:210.2},0).wait(1).to({rotation:3.9,x:261.6,y:205.5},0).wait(1).to({rotation:4.7,x:259.2,y:201.6},0).wait(1).to({rotation:5.3,x:257.2,y:198.3},0).wait(1).to({rotation:5.8,x:255.6,y:195.8},0).wait(1).to({rotation:6.2,x:254.3,y:193.7},0).wait(1).to({rotation:6.5,x:253.3,y:192.2},0).wait(1).to({rotation:6.7,x:252.5,y:191.1},0).wait(1).to({rotation:6.9,x:252.1,y:190.3},0).wait(1).to({x:251.8,y:189.9},0).wait(1).to({regX:67.6,regY:174.6,rotation:7,x:255.1,y:240.1},0).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(79).to({regX:455.3,regY:56.3,x:473.1,y:76},0).wait(1).to({x:471.4},0).wait(1).to({x:468.2},0).wait(1).to({x:463.1},0).wait(1).to({x:455.5},0).wait(1).to({x:444.7},0).wait(1).to({x:429.1},0).wait(1).to({x:406.3,y:75.9},0).wait(1).to({x:371.7},0).wait(1).to({x:321.9},0).wait(1).to({x:269.5,y:75.8},0).wait(1).to({x:231.8},0).wait(1).to({x:207,y:75.7},0).wait(1).to({x:190.2},0).wait(1).to({x:178.7},0).wait(1).to({x:170.8},0).wait(1).to({x:165.5},0).wait(1).to({x:162.1},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(67));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_st_icy_atlas_.png", id:"300x250_st_icy_atlas_"}
	],
	preloads: []
};
