...
lib.ssMetadata = [
		{name:"300x250_st_gym_atlas_", frames: [[138,0,103,159],[0,0,136,171]]}
];
...
(lib.bb_bloobs = function() {
	this.spriteSheet = ss["300x250_st_gym_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.bb_mango = function() {
	this.spriteSheet = ss["300x250_st_gym_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.bb_mango();
	this.instance.parent = this;
	this.instance.setTransform(-16.8,35.9,1,1,-6.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-16.8,21,153.9,184.8), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.bb_bloobs();
	this.instance.parent = this;
	this.instance.setTransform(91.8,-1.5,0.999,0.999,22);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(32.2,-1.5,155,185.8), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_48.setTransform(176.3,139.4);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#063928").s().p("AgYB7IAAh7Igwh6IAwAAIAYA+IAYg+IAxAAIgxB6IAAB7g");
	this.shape_49.setTransform(163.8,129);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQANAFAKAKQAKALAGANQAFANABAQQAAAYgNARQgLAQgTAJIArBpgAgYgXIAYAAQAKgBAHgGQAHgIAAgKQAAgKgHgHQgHgIgKAAIgYAAg");
	this.shape_50.setTransform(146.6,129);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQAOAFAJAKQAKALAGANQAFANABAQQAAAYgNARQgLAQgTAJIArBpgAgYgXIAYAAQAKgBAHgGQAHgIAAgKQAAgKgHgHQgHgIgKAAIgYAAg");
	this.shape_51.setTransform(128.3,129);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#063928").s().p("AgdB1QgMgFgKgKQgLgKgFgNQgGgOAAgQIAAhhQAAgQAGgNQAFgNALgLQAKgKAMgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKALAFANQAHANAAAQIAABhQAAAQgHAOQgFANgKAKQgKAKgNAFQgOAGgPAAQgPAAgOgGgAgRhBQgHAHAAAKIAABhQAAAKAHAIQAHAGAKAAQAKAAAHgGQAHgIAAgKIAAhhQAAgKgHgHQgHgIgKAAQgKAAgHAIg");
	this.shape_52.setTransform(109.9,129);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#063928").s().p("");
	this.shape_53.setTransform(91.6,129);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#063928").s().p("AgSATIAAglIAlAAIAAAlg");
	this.shape_54.setTransform(216.8,104.4);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#063928").s().p("AAxB7IAAh7IgZB7IgwAAIgZh7IAAB7IgwAAIAAj1IBJAAIAYB6IAYh6IBKAAIAAD1g");
	this.shape_55.setTransform(201.8,94);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#063928").s().p("AgYB7IAAh7Igwh6IAwAAIAYA+IAYg+IAxAAIgxB6IAAB7g");
	this.shape_56.setTransform(182.2,94);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#063928").s().p("");
	this.shape_57.setTransform(165.1,94);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAyIBiAAIAAAxg");
	this.shape_58.setTransform(139.9,94);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgxAAIAAj1IAxAAIAABjIAwAAIAAhjIAyAAIAAD1g");
	this.shape_59.setTransform(121.5,94);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICTAAIAAAxIgyAAIAADEg");
	this.shape_60.setTransform(103.2,94);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICTAAIAAAxIgyAAIAADEg");
	this.shape_61.setTransform(78,94);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_62.setTransform(64.5,94);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgwAAIAAj1IAwAAIAABjIAwAAIAAhjIAyAAIAAD1g");
	this.shape_63.setTransform(51.1,94);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgGgNABgQIAAhhQgBgQAGgNQAFgOAKgKQALgKANgFQANgGAPAAQAPAAAOAGQANAFAKAKQAKAKAFAOQAHANAAAQIAABhQAAAQgHANQgFAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_64.setTransform(228.5,59);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICSAAIAAAxIgxAAIAADEg");
	this.shape_65.setTransform(211.3,59);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQANAFAKAKQAKAKAGAOQAFANAAAQQAAAXgMASQgLAQgTAJIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_66.setTransform(186.1,59);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#063928").s().p("AgdB2QgNgGgJgKQgKgKgGgOQgFgNgBgQIAAirIAxAAIAACrQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAirIAyAAIAACrQgBAQgFANQgGAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFg");
	this.shape_67.setTransform(167.8,59);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#063928").s().p("AgdB2QgNgGgJgKQgKgKgGgOQgGgNAAgQIAAhhQAAgQAGgNQAGgOAKgKQAJgKANgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKAKAFAOQAGANABAQIAABhQgBAQgGANQgFAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_68.setTransform(149.4,59);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgxAAIAAj1IAxAAIAABjIAwAAIAAhjIAyAAIAAD1g");
	this.shape_69.setTransform(131.1,59);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#063928").s().p("AAYB7IgKgxIgcAAIgKAxIgxAAIAxj1IAwAAIAyD1gAAEAYIgEgYIgEAYIAIAAg");
	this.shape_70.setTransform(105.9,59);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAPAAAOAGQANAFALAKQAJAKAFAOQAHANAAAQQgBAXgLASQgMAQgTAJIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_71.setTransform(87.5,59);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_72.setTransform(69.2,59);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#063928").s().p("AAYB7IgYg9IgYA9IgxAAIAxh7Igxh6IAxAAIAYA+IAYg+IAxAAIgxB6IAxB7g");
	this.shape_73.setTransform(52,59);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAyIBiAAIAAAxg");
	this.shape_74.setTransform(33.7,59);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgwAAIAAj1IAwAAIAwB6IAAh6IAyAAIAAD1g");
	this.shape_75.setTransform(228.5,24);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#063928").s().p("AAYB7IgJgxIgdAAIgKAxIgwAAIAwj1IAwAAIAxD1gAAEAYIgEgYIgEAYIAIAAg");
	this.shape_76.setTransform(210.1,24);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAQAAANAGQAOAGAKAJQAJAKAFAOQAHAOgBAPQABAXgMASQgMARgTAIIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_77.setTransform(184.9,24);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAAAyIBhAAIAAAxg");
	this.shape_78.setTransform(166.6,24);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#063928").s().p("AgYB7Igxj1IAxAAIAYB6IAYh6IAxAAIgxD1g");
	this.shape_79.setTransform(148.2,24);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_80.setTransform(134.7,24);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#063928").s().p("Ag8B7IAAj1IAwAAIAADEIBJAAIAAAxg");
	this.shape_81.setTransform(122.5,24);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBIAAIAAAvIhIAAIAAAyIBiAAIAAAxg");
	this.shape_82.setTransform(105.4,24);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAPAAAOAGQANAGALAJQAJAKAFAOQAHAOAAAPIAABhQAAAQgHANQgFAOgJAKQgLAKgNAGQgOAFgPAAgAgYBKIAYAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_83.setTransform(87.1,24);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#063928").s().p("AhIB7IAAj1ICSAAIAAAxIhiAAIAAAyIBIAAIAAAvIhIAAIAAAyIBiAAIAAAxg");
	this.shape_84.setTransform(61.9,24);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#063928").s().p("AAZB7IgZh7IgYB7IgxAAIgwj1IAwAAIAZB6IAYh6IAxAAIAYB6IAZh6IAwAAIgwD1g");
	this.shape_85.setTransform(38.6,24);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(23,7.6,858.6,144.5), null);
...
// stage content:
(lib._300x250_st_gym = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_2.setTransform(-91.1,383.2,1,1,30,0,0,89.5,133.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(1).to({regX:109.6,regY:91.4,rotation:27.6,x:-48,y:347.6},0).wait(1).to({rotation:24.5,x:-42.3,y:336.1},0).wait(1).to({rotation:20.6,x:-35.1,y:321.3},0).wait(1).to({rotation:15.6,x:-26.2,y:302.8},0).wait(1).to({rotation:9.6,x:-15.8,y:280.8},0).wait(1).to({rotation:3.4,x:-5.4,y:258.9},0).wait(1).to({rotation:-1.8,x:3.2,y:240.5},0).wait(1).to({rotation:-5.9,x:9.9,y:226.3},0).wait(1).to({rotation:-9.2,x:15,y:215.4},0).wait(1).to({rotation:-11.7,x:19,y:206.9},0).wait(1).to({rotation:-13.7,x:22.2,y:200.2},0).wait(1).to({rotation:-15.3,x:24.8,y:194.8},0).wait(1).to({rotation:-16.7,x:26.9,y:190.4},0).wait(1).to({rotation:-17.8,x:28.7,y:186.7},0).wait(1).to({rotation:-18.7,x:30,y:183.8},0).wait(1).to({rotation:-19.4,x:31.3,y:181.4},0).wait(1).to({rotation:-20.1,x:32.2,y:179.4},0).wait(1).to({rotation:-20.5,x:32.9,y:177.9},0).wait(1).to({rotation:-20.9,x:33.5,y:176.6},0).wait(1).to({rotation:-21.2,x:34,y:175.7},0).wait(1).to({rotation:-21.4,x:34.3,y:175},0).wait(1).to({rotation:-21.6,x:34.6,y:174.5},0).wait(1).to({rotation:-21.7,x:34.7,y:174.2},0).wait(1).to({regX:89.4,regY:133.6,x:31.7,y:220.7},0).wait(161));

	// Layer 3
	this.instance_3 = new lib.Symbol3();
	this.instance_3.parent = this;
	this.instance_3.setTransform(382.2,387.5,1,1,-45,0,0,67.5,174.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({regX:60.1,regY:113.4,rotation:-42.6,x:329.4,y:340.6},0).wait(1).to({rotation:-39.5,x:324.1,y:329.4},0).wait(1).to({rotation:-35.6,x:317.5,y:315.3},0).wait(1).to({rotation:-30.5,x:309.3,y:297.5},0).wait(1).to({rotation:-24.5,x:299.8,y:276.7},0).wait(1).to({rotation:-18.3,x:290.6,y:256.1},0).wait(1).to({rotation:-13,x:282.9,y:238.9},0).wait(1).to({rotation:-8.9,x:277.1,y:225.8},0).wait(1).to({rotation:-5.7,x:272.5,y:215.8},0).wait(1).to({rotation:-3.1,x:268.9,y:208.1},0).wait(1).to({rotation:-1.1,x:266.2,y:201.9},0).wait(1).to({rotation:0.6,x:263.9,y:197},0).wait(1).to({rotation:1.9,x:262,y:193.1},0).wait(1).to({rotation:3,x:260.5,y:189.9},0).wait(1).to({rotation:3.9,x:259.2,y:187.2},0).wait(1).to({rotation:4.7,x:258.2,y:185},0).wait(1).to({rotation:5.3,x:257.4,y:183.3},0).wait(1).to({rotation:5.8,x:256.7,y:181.8},0).wait(1).to({rotation:6.2,x:256.2,y:180.7},0).wait(1).to({rotation:6.5,x:255.7,y:179.9},0).wait(1).to({rotation:6.7,x:255.5,y:179.2},0).wait(1).to({rotation:6.9,x:255.2,y:178.9},0).wait(1).to({x:255.1,y:178.6},0).wait(1).to({regX:67.6,regY:174.6,rotation:7,y:240.1},0).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(79).to({regX:451.8,regY:73.8,x:469.6,y:93.5},0).wait(1).to({x:467.9},0).wait(1).to({x:464.7},0).wait(1).to({x:459.6},0).wait(1).to({x:452},0).wait(1).to({x:441.2},0).wait(1).to({x:425.6},0).wait(1).to({x:402.8,y:93.4},0).wait(1).to({x:368.2},0).wait(1).to({x:318.4},0).wait(1).to({x:266,y:93.3},0).wait(1).to({x:228.3},0).wait(1).to({x:203.5,y:93.2},0).wait(1).to({x:186.7},0).wait(1).to({x:175.2},0).wait(1).to({x:167.3},0).wait(1).to({x:162},0).wait(1).to({x:158.6},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(67));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_st_gym_atlas_.png", id:"300x250_st_gym_atlas_"}
	],
	preloads: []
};
