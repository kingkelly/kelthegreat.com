...
lib.ssMetadata = [
		{name:"300x250_st_frost_atlas_", frames: [[0,0,169,147],[0,149,127,138]]}
];
...
(lib.asp_bb = function() {
	this.spriteSheet = ss["300x250_st_frost_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.steak_bb = function() {
	this.spriteSheet = ss["300x250_st_frost_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.steak_bb();
	this.instance.parent = this;
	this.instance.setTransform(-14.9,109.4,1,1,-6.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-14.9,95.5,141.4,151.1), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.asp_bb();
	this.instance.parent = this;
	this.instance.setTransform(67,66.3,0.999,0.999,22);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(11.9,66.3,211.6,199.5), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_48.setTransform(254.8,139.4);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAPAAAOAGQAOAFAKAKQAJALAFANQAHANgBAQQABAYgMARQgMAQgTAJIAqBpgAgYgXIAYAAQAKgBAHgGQAHgIAAgKQAAgKgHgHQgHgIgKAAIgYAAg");
	this.shape_49.setTransform(242.4,129);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#063928").s().p("AAYB7IgJgyIgdAAIgKAyIgxAAIAxj1IAwAAIAxD1gAAFAYIgFgYIgEAYIAJAAg");
	this.shape_50.setTransform(224.3,129);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#063928").s().p("AgdB1QgNgFgJgKQgLgKgFgNQgGgOABgQIAAhhQgBgQAGgNQAFgNALgLQAJgKANgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKALAFANQAHANAAAQIgyAAQAAgKgHgHQgHgIgKAAQgKAAgHAIQgHAHAAAKIAABhQAAAKAHAIQAHAGAKAAQAKAAAHgGQAHgIAAgKIAyAAQAAAQgHAOQgFANgKAKQgKAKgNAFQgOAGgPAAQgPAAgOgGg");
	this.shape_51.setTransform(208.1,129);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#063928").s().p("AhJB7IAAj1ICSAAIAAAxIhhAAIAAAyIBJAAIAAAvIhJAAIAAAxIBhAAIAAAyg");
	this.shape_52.setTransform(183.3,129);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgxAAIAAj1IAxAAIAABjIAwAAIAAhjIAyAAIAAD1g");
	this.shape_53.setTransform(165.2,129);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_54.setTransform(147,129);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICSAAIAAAxIgxAAIAADEg");
	this.shape_55.setTransform(122.2,129);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#063928").s().p("");
	this.shape_56.setTransform(104.1,129);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#063928").s().p("AgcB1QgNgFgLgKQgKgKgFgNQgGgOABgQIAAhhQgBgQAGgNQAFgNAKgLQALgKANgFQANgGAPAAQAQAAANAGQANAFAKAKQAKALAFANQAHANgBAQIAABhQABAQgHAOQgFANgKAKQgKAKgNAFQgNAGgQAAQgPAAgNgGgAgRhBQgHAHAAAKIAABhQAAAKAHAIQAHAGAKAAQAKAAAHgGQAHgIAAgKIAAhhQAAgKgHgHQgHgIgKAAQgKAAgHAIg");
	this.shape_57.setTransform(85.9,129);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAQAAANAGQANAFAKAKQAKALAGANQAFANAAAQQAAAYgMARQgLAQgTAJIAqBpgAgYgXIAYAAQAKgBAHgGQAHgIAAgKQAAgKgHgHQgHgIgKAAIgYAAg");
	this.shape_58.setTransform(67.8,129);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAABjg");
	this.shape_59.setTransform(49.6,129);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAAAxIBhAAIAAAyg");
	this.shape_60.setTransform(31.5,129);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#063928").s().p("AhJB7IAAj1IBJAAQAQAAANAGQANAFAKAKQAKALAGANQAFANAAAQIAABhQAAAQgFAOQgGANgKAKQgKAKgNAFQgNAGgQAAgAgYBJIAYAAQAKAAAHgGQAHgIAAgKIAAhhQAAgKgHgHQgHgIgKAAIgYAAg");
	this.shape_61.setTransform(13.3,129);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#063928").s().p("AgcB1QgNgFgLgKQgKgKgFgOQgFgNAAgQIAAhhQAAgQAFgNQAFgNAKgLQALgKANgFQANgGAPAAQAQAAANAGQANAFAKAKQAKALAGANQAFANAAAQIAABhQAAAQgFANQgGAOgKAKQgKAKgNAFQgNAGgQAAQgPAAgNgGgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgHgKAAQgKAAgHAHg");
	this.shape_62.setTransform(241.7,94);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICTAAIAAAxIgyAAIAADEg");
	this.shape_63.setTransform(223.6,94);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#063928").s().p("");
	this.shape_64.setTransform(198.8,94);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBJAAIAAAvIhJAAIAAAyIBhAAIAAAxg");
	this.shape_65.setTransform(180.6,94);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#063928").s().p("AAYB7Igwh7IAwh6IAyAAIgyB6IAyB7gAhJB7IAAj1IAxAAIAAB6IAAB7g");
	this.shape_66.setTransform(162.5,94);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#063928").s().p("AAYB7IgKgxIgcAAIgKAxIgwAAIAwj1IAwAAIAxD1gAAEAYIgEgYIgEAYIAIAAg");
	this.shape_67.setTransform(144.3,94);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICTAAIAAAxIgyAAIAADEg");
	this.shape_68.setTransform(128.2,94);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_69.setTransform(103.4,94);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_70.setTransform(90.1,94);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAyIBiAAIAAAxg");
	this.shape_71.setTransform(70.2,94);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#063928").s().p("AAxB7IAAh7IgZB7IgvAAIgah7IAAB7IgwAAIAAj1IBKAAIAXB6IAYh6IBKAAIAAD1g");
	this.shape_72.setTransform(49.6,94);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_73.setTransform(33.9,94);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#063928").s().p("AgYB7IAAjEIgwAAIAAgxICRAAIAAAxIgxAAIAADEg");
	this.shape_74.setTransform(20.7,94);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#063928").s().p("AhIB7IAAj1ICSAAIAAAxIhiAAIAAAyIBIAAIAAAvIhIAAIAAAyIBiAAIAAAxg");
	this.shape_75.setTransform(246,59);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#063928").s().p("AAYB7IAAhjIgwAAIAABjIgwAAIAAj1IAwAAIAABjIAwAAIAAhjIAxAAIAAD1g");
	this.shape_76.setTransform(227.9,59);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f("#063928").s().p("AgYB7IAAjEIgxAAIAAgxICTAAIAAAxIgyAAIAADEg");
	this.shape_77.setTransform(209.7,59);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#063928").s().p("AAYB7Igwh7IAAB7IgwAAIAAj1IAwAAIAwB6IAAh6IAxAAIAAD1g");
	this.shape_78.setTransform(184.9,59);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_79.setTransform(171.6,59);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#063928").s().p("");
	this.shape_80.setTransform(151.8,59);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAAAyIBhAAIAAAxg");
	this.shape_81.setTransform(133.6,59);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_82.setTransform(120.3,59);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgxAAIAAj1IBJAAQAPAAAOAGQAOAFAJAKQAKAKAFAOQAGANABAQQAAAXgNASQgLAQgTAJIArBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_83.setTransform(107.1,59);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAAAyIBhAAIAAAxg");
	this.shape_84.setTransform(89,59);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgJgKgGgOQgFgNAAgQIAAhhQAAgQAFgNQAGgOAJgKQALgKANgFQANgGAPAAQAQAAANAGQANAFAKAKQAKAKAGAOQAFANAAAQIgxAAQAAgKgHgIQgHgGgKgBQgKABgHAGQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAxAAQAAAQgFANQgGAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFg");
	this.shape_85.setTransform(70.8,59);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f("#063928").s().p("AgdB2QgNgGgJgKQgKgKgGgOQgGgNAAgQIAAhhQAAgQAGgNQAGgOAKgKQAJgKANgFQAOgGAPAAQAPAAAOAGQANAFAKAKQAKAKAFAOQAGANABAQIAABhQgBAQgGANQgFAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_86.setTransform(52.7,59);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAPAAAOAGQAOAFAKAKQAJAKAFAOQAHANgBAQQABAXgMASQgMAQgTAJIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_87.setTransform(34.5,59);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f("#063928").s().p("");
	this.shape_88.setTransform(16.4,59);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAQAAANAGQANAGALAJQAJAKAGAOQAFAOAAAPQABAXgMASQgMARgTAIIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_89.setTransform(167.5,24);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.f("#063928").s().p("AhJB7IAAj1ICTAAIAAAxIhiAAIAAAyIBJAAIAAAvIhJAAIAAAyIBiAAIAAAxg");
	this.shape_90.setTransform(149.3,24);

	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAPAAAOAGQANAGALAJQAJAKAFAOQAHAOAAAPIAABhQAAAQgHANQgFAOgJAKQgLAKgNAGQgOAFgPAAgAgYBKIAYAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_91.setTransform(131.2,24);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f("#063928").s().p("AAYB7IgmhjIgKAAIAABjIgwAAIAAj1IBIAAQAQAAANAGQANAGALAJQAJAKAGAOQAFAOAAAPQABAXgMASQgMARgTAIIAqBpgAgYgXIAYAAQAKAAAHgIQAHgHAAgKQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_92.setTransform(113,24);

	this.shape_93 = new cjs.Shape();
	this.shape_93.graphics.f("#063928").s().p("AgdB2QgNgGgJgKQgKgKgGgOQgFgNgBgQIAAhhQABgPAFgOQAGgOAKgKQAJgJANgGQAOgGAPAAQAPAAAOAGQANAGAKAJQAKAKAGAOQAFAOABAPIAABhQgBAQgFANQgGAOgKAKQgKAKgNAGQgOAFgPAAQgPAAgOgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_93.setTransform(94.9,24);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(2.6,7.6,879,144.5), null);
...
// stage content:
(lib._300x250_st_frost = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).wait(1).to({regX:117.6,regY:166,rotation:27.6,x:-77.3,y:484.1},0).wait(1).to({rotation:24.5,x:-70.3,y:469.6},0).wait(1).to({rotation:20.6,x:-61.4,y:450.9},0).wait(1).to({rotation:15.6,x:-50,y:426.7},0).wait(1).to({rotation:9.6,x:-36.5,y:397.3},0).wait(1).to({rotation:3.4,x:-23,y:366.9},0).wait(1).to({rotation:-1.8,x:-11.7,y:340.5},0).wait(1).to({rotation:-5.9,x:-2.9,y:319.6},0).wait(1).to({rotation:-9.2,x:3.7,y:303.3},0).wait(1).to({rotation:-11.7,x:8.9,y:290.3},0).wait(1).to({rotation:-13.7,x:13,y:279.9},0).wait(1).to({rotation:-15.3,x:16.3,y:271.5},0).wait(1).to({rotation:-16.7,x:19,y:264.5},0).wait(1).to({rotation:-17.8,x:21.1,y:258.8},0).wait(1).to({rotation:-18.7,x:22.9,y:254.1},0).wait(1).to({rotation:-19.4,x:24.4,y:250.3},0).wait(1).to({rotation:-20.1,x:25.5,y:247.1},0).wait(1).to({rotation:-20.5,x:26.5,y:244.6},0).wait(1).to({rotation:-20.9,x:27.3,y:242.5},0).wait(1).to({rotation:-21.2,x:27.8,y:241},0).wait(1).to({rotation:-21.4,x:28.3,y:239.8},0).wait(1).to({rotation:-21.6,x:28.6,y:239.1},0).wait(1).to({rotation:-21.7,x:28.7,y:238.6},0).wait(1).to({regX:89.4,regY:133.6,x:-9.3,y:218.7},0).wait(77).to({regX:117.6,regY:166,x:28.9,y:238.3},0).wait(1).to({y:238},0).wait(1).to({y:237.4},0).wait(1).to({y:236.6},0).wait(1).to({x:28.8,y:235.2},0).wait(1).to({x:28.7,y:233.3},0).wait(1).to({x:28.6,y:230.6},0).wait(1).to({x:28.4,y:226.6},0).wait(1).to({x:28.2,y:220.7},0).wait(1).to({x:27.8,y:212.5},0).wait(1).to({x:27.5,y:205},0).wait(1).to({x:27.2,y:200},0).wait(1).to({x:27.1,y:197},0).wait(1).to({x:27,y:195.2},0).wait(1).to({y:194.1},0).wait(1).to({y:193.6},0).wait(1).to({regX:89.4,regY:133.6,x:-11.3,y:173.7},0).wait(68));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(1).to({regX:55.8,regY:171,rotation:-42.6,x:450.1,y:500.3},0).wait(1).to({rotation:-39.5,x:437,y:483.9},0).wait(1).to({rotation:-35.6,x:420.3,y:462.9},0).wait(1).to({rotation:-30.5,x:399,y:435.9},0).wait(1).to({rotation:-24.5,x:373.7,y:403.5},0).wait(1).to({rotation:-18.3,x:347.9,y:370.5},0).wait(1).to({rotation:-13,x:326,y:342.2},0).wait(1).to({rotation:-8.9,x:308.8,y:320},0).wait(1).to({rotation:-5.7,x:295.5,y:302.7},0).wait(1).to({rotation:-3.1,x:285.1,y:289},0).wait(1).to({rotation:-1.1,x:276.7,y:278.2},0).wait(1).to({rotation:0.6,x:270,y:269.3},0).wait(1).to({rotation:1.9,x:264.4,y:262.1},0).wait(1).to({rotation:3,x:259.9,y:256.2},0).wait(1).to({rotation:3.9,x:256.1,y:251.3},0).wait(1).to({rotation:4.7,x:253.1,y:247.3},0).wait(1).to({rotation:5.3,x:250.6,y:244},0).wait(1).to({rotation:5.8,x:248.6,y:241.5},0).wait(1).to({rotation:6.2,x:247,y:239.3},0).wait(1).to({rotation:6.5,x:245.8,y:237.8},0).wait(1).to({rotation:6.7,x:244.9,y:236.6},0).wait(1).to({rotation:6.9,x:244.3,y:235.8},0).wait(1).to({x:244,y:235.4},0).wait(1).to({regX:67.6,regY:174.6,rotation:7,x:255.1,y:240.1},0).wait(77).to({regX:55.8,regY:171,x:243.9,y:235},0).wait(1).to({x:244.1,y:234.8},0).wait(1).to({x:244.4,y:234.4},0).wait(1).to({x:245,y:233.7},0).wait(1).to({x:245.8,y:232.7},0).wait(1).to({x:247.1,y:231.3},0).wait(1).to({x:248.8,y:229.2},0).wait(1).to({x:251.4,y:226.2},0).wait(1).to({x:255.2,y:221.7},0).wait(1).to({x:260.5,y:215.6},0).wait(1).to({x:265.3,y:209.9},0).wait(1).to({x:268.5,y:206.1},0).wait(1).to({x:270.5,y:203.8},0).wait(1).to({x:271.7,y:202.4},0).wait(1).to({x:272.3,y:201.6},0).wait(1).to({x:272.7,y:201.2},0).wait(1).to({regX:67.6,regY:174.6,x:284.1,y:206.1},0).wait(68));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(79).to({regX:441.7,regY:73.8,x:459.5,y:93.5},0).wait(1).to({x:457.8},0).wait(1).to({x:454.6},0).wait(1).to({x:449.5},0).wait(1).to({x:441.9},0).wait(1).to({x:431.1},0).wait(1).to({x:415.5},0).wait(1).to({x:392.7,y:93.4},0).wait(1).to({x:358.1},0).wait(1).to({x:308.3},0).wait(1).to({x:255.9,y:93.3},0).wait(1).to({x:218.2},0).wait(1).to({x:193.4,y:93.2},0).wait(1).to({x:176.6},0).wait(1).to({x:165.1},0).wait(1).to({x:157.2},0).wait(1).to({x:151.9},0).wait(1).to({x:148.5},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(113).to({_off:false},0).to({alpha:1},10).wait(63));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_st_frost_atlas_.png", id:"300x250_st_frost_atlas_"}
	],
	preloads: []
};
