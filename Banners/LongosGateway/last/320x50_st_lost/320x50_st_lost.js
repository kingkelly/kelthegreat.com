...
(lib.bage_sm = function() {
	this.initialize(img.bage_sm);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,95,57);// helper functions:
...
(lib.Symbol3copy2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.bage_sm();
	this.instance.parent = this;
	this.instance.setTransform(-131,-1.9,1,1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3copy2, new cjs.Rectangle(-131,-2,95.1,57.1), null);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#063928").s().p("AgHAJIAAgRIAQAAIAAARg");
	this.shape.setTransform(178.2,-41.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#063928").s().p("AALA4IgVg4IAVg3IAXAAIgXA3IAXA4gAghA4IAAhvIAXAAIAAA3IAAA4gAgKAAg");
	this.shape_1.setTransform(172.5,-46.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#063928").s().p("AgMA2QgGgDgFgEQgFgFgCgGQgDgGAAgHIAAgsQAAgIADgGQACgGAFgEQAFgFAGgDQAGgCAGAAQAHAAAGACQAGADAFAFQAEAEADAGQADAGAAAIIgXAAQAAgFgDgDQgDgEgFAAQgEAAgDAEQgDADAAAFIAAAsQAAAEADADQADAEAEAAQAFAAADgEQADgDAAgEIAXAAQAAAHgDAGQgDAGgEAFQgFAEgGADQgGACgHAAQgGAAgGgCg");
	this.shape_2.setTransform(164.2,-46.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#063928").s().p("AALA4IgEgWIgNAAIgEAWIgXAAIAXhvIAVAAIAXBvgAACALIgCgLIgBALIADAAg");
	this.shape_3.setTransform(155.9,-46.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#063928").s().p("AghA4IAAhvIAhAAQAHAAAGACQAHADAEAFQAEAEADAGQADAGAAAIQAAAGgDAGQgCAGgEADQAEAFACAFQADAGAAAHQAAAHgDAGQgDAGgEAFQgEAEgHADQgGACgHAAgAgKAiIAKAAQAFAAADgEQADgDAAgEQAAgFgDgEQgDgDgFAAIgKAAgAgKgKIAKAAQAFAAADgDQADgEAAgEQAAgFgDgDQgDgEgFAAIgKAAg");
	this.shape_4.setTransform(147.6,-46.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#063928").s().p("AgKA4IAAhZIgXAAIAAgWIBDAAIAAAWIgXAAIAABZg");
	this.shape_5.setTransform(136.2,-46.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#063928").s().p("AgKA4IAAhvIAVAAIAABvg");
	this.shape_6.setTransform(130.6,-46.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#063928").s().p("AALA4IgVg4IAAA4IgXAAIAAhvIAXAAIAVA3IAAg3IAXAAIAABvg");
	this.shape_7.setTransform(121.5,-46.6);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#063928").s().p("AgKA4IAAhvIAVAAIAABvg");
	this.shape_8.setTransform(115.4,-46.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#063928").s().p("AALA4IgEgWIgNAAIgEAWIgXAAIAXhvIAVAAIAXBvgAACALIgCgLIgBALIADAAg");
	this.shape_9.setTransform(109.4,-46.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#063928").s().p("");
	this.shape_10.setTransform(101.1,-46.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#063928").s().p("AgIA4IAAgRIARAAIAAARgAgIAeIAAgyIAIAAQAEAAACgDQADgCAAgEQAAgEgDgCQgCgDgEAAQgDAAgCADQgDACAAAEIgRAAQAAgGACgEQACgFADgEQAEgDAFgCQAEgCAFAAQAGAAAEACQAFACAEADQADAEACAFQACAEAAAGQAAAJgFAGQgFAHgHACIAAAjg");
	this.shape_11.setTransform(90.6,-46.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#063928").s().p("AALA4IgRgtIgEAAIAAAtIgXAAIAAhvIAhAAQAHAAAGACQAHADAEAFQAEAEADAGQADAGAAAIQAAAKgGAIQgFAHgJAEIAUAwgAgKgKIAKAAQAFAAADgDQADgEAAgEQAAgFgDgDQgDgEgFAAIgKAAg");
	this.shape_12.setTransform(83.2,-46.6);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#063928").s().p("AgMA2QgGgDgFgEQgFgFgCgGQgDgGAAgHIAAhOIAXAAIAABOQAAAEADADQADAEAEAAQAFAAADgEQADgDAAgEIAAhOIAXAAIAABOQAAAHgDAGQgDAGgEAFQgFAEgGADQgGACgHAAQgGAAgGgCg");
	this.shape_13.setTransform(74.9,-46.6);
	...
	this.shape_14.setTransform(66.6,-46.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#063928").s().p("AALA4IAAgtIgVAAIAAAtIgXAAIAAhvIAXAAIAAAtIAVAAIAAgtIAXAAIAABvg");
	this.shape_15.setTransform(58.3,-46.6);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#063928").s().p("AALA4IgVg4IAAA4IgXAAIAAhvIAXAAIAVA3IAAg3IAXAAIAABvg");
	this.shape_16.setTransform(47,-46.6);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#063928").s().p("AALA4IgEgWIgNAAIgEAWIgXAAIAXhvIAVAAIAXBvgAACALIgCgLIgBALIADAAg");
	this.shape_17.setTransform(38.7,-46.6);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#063928").s().p("AgKA4IAAhZIgXAAIAAgWIBDAAIAAAWIgXAAIAABZg");
	this.shape_18.setTransform(27.3,-46.6);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#063928").s().p("");
	this.shape_19.setTransform(19.5,-46.6);
	...
	this.shape_20.setTransform(11.2,-46.6);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#063928").s().p("AgbA4IAAhvIAWAAIAABZIAhAAIAAAWg");
	this.shape_21.setTransform(3.5,-46.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-282,-55,744.1,20), null);
...
// stage content:
(lib._320x50_st_lost = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(22).to({_off:false},0).to({alpha:1},14).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:-83.5,regY:26.5,x:361.9,y:22.5},0).wait(1).to({x:357.7},0).wait(1).to({x:352.8},0).wait(1).to({x:347.2},0).wait(1).to({x:340.9},0).wait(1).to({x:334},0).wait(1).to({x:326.9},0).wait(1).to({x:319.8},0).wait(1).to({x:313.3},0).wait(1).to({x:307.3},0).wait(1).to({x:302.1},0).wait(1).to({x:297.6},0).wait(1).to({x:293.7},0).wait(1).to({x:290.4},0).wait(1).to({x:287.6},0).wait(1).to({x:285.2},0).wait(1).to({x:283.2},0).wait(1).to({x:281.4},0).wait(1).to({x:280},0).wait(1).to({x:278.8},0).wait(1).to({x:277.9},0).wait(1).to({x:277.1},0).wait(1).to({x:276.5},0).wait(1).to({x:276},0).wait(1).to({x:275.7},0).wait(1).to({x:275.6},0).wait(1).to({regX:133.5,regY:142,x:492.5,y:138},0).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(92).to({_off:false},0).wait(1).to({regX:2.5,regY:-20.6,x:119,y:-48.9},0).wait(1).to({y:-43},0).wait(1).to({y:-33.8},0).wait(1).to({y:-20.5},0).wait(1).to({y:-9.3},0).wait(1).to({y:-2.3},0).wait(1).to({y:2.4},0).wait(1).to({y:5.8},0).wait(1).to({y:8.4},0).wait(1).to({y:10.4},0).wait(1).to({y:12},0).wait(1).to({y:13.3},0).wait(1).to({y:14.3},0).wait(1).to({y:15.1},0).wait(1).to({y:15.7},0).wait(1).to({y:16.2},0).wait(1).to({y:16.5},0).wait(1).to({y:16.7},0).wait(1).to({y:16.9},0).wait(1).to({regX:372,regY:66,x:488.5,y:103.5},0).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({regX:89.8,regY:-46.6,x:113,y:-21.2},0).wait(1).to({x:113.4,y:-18.6},0).wait(1).to({x:113.8,y:-15},0).wait(1).to({x:114.5,y:-9.7},0).wait(1).to({x:115.3,y:-3.2},0).wait(1).to({x:115.9,y:1.9},0).wait(1).to({x:116.4,y:5.4},0).wait(1).to({x:116.7,y:7.8},0).wait(1).to({x:116.9,y:9.7},0).wait(1).to({x:117.1,y:11.1},0).wait(1).to({x:117.2,y:12.3},0).wait(1).to({x:117.3,y:13.2},0).wait(1).to({x:117.4,y:14},0).wait(1).to({x:117.5,y:14.6},0).wait(1).to({x:117.6,y:15.1},0).wait(1).to({y:15.6},0).wait(1).to({x:117.7,y:15.9},0).wait(1).to({y:16.2},0).wait(1).to({y:16.4},0).wait(1).to({x:117.8,y:16.6},0).wait(1).to({y:16.7},0).wait(1).to({y:16.8},0).wait(1).to({y:16.9},0).wait(1).to({regX:372,regY:67,x:400,y:130.5},0).wait(62).to({regX:89.8,regY:-46.6,x:117.8,y:17},0).wait(1).to({y:17.4},0).wait(1).to({y:18.2},0).wait(1).to({y:19.3},0).wait(1).to({y:21},0).wait(1).to({y:23.3},0).wait(1).to({y:26.6},0).wait(1).to({y:31.4},0).wait(1).to({y:38.5},0).wait(1).to({y:50.7},0).wait(1).to({y:74},0).wait(1).to({y:89.3},0).wait(1).to({y:94.6},0).wait(1).to({y:96.6},0).wait(1).to({regX:372,regY:67,x:400,y:210.5},0).wait(90));
...
p.nominalBounds = new cjs.Rectangle(-99,-6.5,744.1,82.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bage_sm.png", id:"bage_sm"}
	],
	preloads: []
};
