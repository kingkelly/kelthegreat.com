...
lib.ssMetadata = [
		{name:"300x250_st_miles_atlas_", frames: [[0,129,102,103],[0,0,111,127]]}
];
...
(lib.peach_bb = function() {
	this.spriteSheet = ss["300x250_st_miles_atlas_"];
	this.gotoAndStop(0);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_48.setTransform(201.7,69.4);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#063928").s().p("");
	this.shape_49.setTransform(189.2,59);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#063928").s().p("AhJB7IAAj1ICSAAIAAAxIhhAAIAAAyIBJAAIAAAvIhJAAIAAAyIBhAAIAAAxg");
	this.shape_50.setTransform(170.8,59);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#063928").s().p("Ag8B7IAAj1IAwAAIAADEIBJAAIAAAxg");
	this.shape_51.setTransform(153.7,59);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#063928").s().p("");
	this.shape_52.setTransform(136.6,59);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_53.setTransform(123.1,59);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#063928").s().p("AAYB7IgKgxIgcAAIgKAxIgwAAIAwj1IAwAAIAxD1gAAEAYIgEgYIgEAYIAIAAg");
	this.shape_54.setTransform(109.7,59);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#063928").s().p("AhIB7IAAj1ICRAAIAAAxIhhAAIAAAyIBIAAIAAAvIhIAAIAABjg");
	this.shape_55.setTransform(84.5,59);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgGgNABgQIAAhhQgBgQAGgNQAFgOAKgKQALgKANgFQANgGAPAAQAQAAANAGQANAFAKAKQAKAKAFAOQAHANgBAQIAABhQABAQgHANQgFAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAGAKABQAKgBAHgGQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_56.setTransform(66.1,59);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#063928").s().p("");
	this.shape_57.setTransform(206.3,24);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#063928").s().p("AhIB7IAAj1ICSAAIAAAxIhiAAIAAAyIBIAAIAAAvIhIAAIAAAyIBiAAIAAAxg");
	this.shape_58.setTransform(188,24);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#063928").s().p("Ag8B7IAAj1IAxAAIAADEIBIAAIAAAxg");
	this.shape_59.setTransform(170.8,24);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_60.setTransform(158.6,24);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#063928").s().p("AAxB7IAAh7IgZB7IgwAAIgYh7IAAB7IgxAAIAAj1IBJAAIAYB6IAYh6IBKAAIAAD1g");
	this.shape_61.setTransform(142.7,24);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#063928").s().p("AhIB7IAAj1IBIAAQAPAAAOAGQAOAGAKAJQAJAKAFAOQAHAOAAAPIAABhQAAAQgHANQgFAOgJAKQgKAKgOAGQgOAFgPAAgAgYBKIAYAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBIgYAAg");
	this.shape_62.setTransform(115.1,24);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#063928").s().p("AgXB7IAAj1IAvAAIAAD1g");
	this.shape_63.setTransform(101.6,24);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#063928").s().p("AgcB2QgNgGgLgKQgKgKgFgOQgGgNABgQIAAhhQgBgPAGgOQAFgOAKgKQALgJANgGQANgGAPAAQAQAAANAGQANAGAKAJQAKAKAFAOQAHAOgBAPIAABhQABAQgHANQgFAOgKAKQgKAKgNAGQgNAFgQAAQgPAAgNgFgAgRhCQgHAIAAAKIAABhQAAAKAHAIQAHAHAKAAQAKAAAHgHQAHgIAAgKIAAhhQAAgKgHgIQgHgGgKgBQgKABgHAGg");
	this.shape_64.setTransform(88.2,24);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#063928").s().p("AgYB7Igxj1IAxAAIAYB6IAYh6IAyAAIgyD1g");
	this.shape_65.setTransform(72,24);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#063928").s().p("AAYB7IgJgxIgdAAIgKAxIgwAAIAwj1IAwAAIAxD1gAAFAYIgFgYIgEAYIAJAAg");
	this.shape_66.setTransform(55.9,24);
...
}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(45.2,7.6,836.5,74.5), null);
...
// stage content:
(lib._300x250_st_miles = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(-1)).wait(67).to({regX:462.9,regY:38.8,x:480.7,y:58.5},0).wait(1).to({x:479},0).wait(1).to({x:475.8},0).wait(1).to({x:470.7},0).wait(1).to({x:463.1},0).wait(1).to({x:452.3},0).wait(1).to({x:436.7},0).wait(1).to({x:413.9,y:58.4},0).wait(1).to({x:379.3},0).wait(1).to({x:329.5},0).wait(1).to({x:277.1,y:58.3},0).wait(1).to({x:239.4},0).wait(1).to({x:214.6,y:58.2},0).wait(1).to({x:197.8},0).wait(1).to({x:186.3},0).wait(1).to({x:178.4},0).wait(1).to({x:173.1},0).wait(1).to({x:169.7},0).wait(1).to({regX:131.7,regY:89,x:-163.3,y:108.4},0).wait(56));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_st_miles_atlas_.png", id:"300x250_st_miles_atlas_"}
	],
	preloads: []
};
