...
lib.ssMetadata = [
		{name:"300x250_soar_atlas_NP_", frames: [[0,0,300,250],[0,252,300,250],[0,504,300,250]]}
];
...
(lib.Lights300x250 = function() {
	this.spriteSheet = ss["300x250_soar_atlas_NP_"];
	this.gotoAndStop(0);
...
(lib.Symbol2copy2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AA4HPIhanKIgVh7IAAJFIhaAAIAAudIBvAAIBKHDIARB/IAApCIBZAAIAAOdg");
	this.shape.setTransform(134.4,27.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAtHPQgLAAgIg2IgHhZIAAjaQAAglgXAAIgaAAIAAGOIhtAAIAAudICMAAQAyAAAfAdQATASAKAbQAMAeAAAqIAADtQAAAegOAYQgMAUgYAVQAZAUAMAUQAQAZAAAeIAADGQAAA9AOBZIAAAEgAgegnIAcAAQASAAAAgmIAAjsQAAglgSAAIgcAAg");
	this.shape_1.setTransform(101.9,27.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgyHJQgYgLgTgVQgTgWgKgcQgKgeAAgjIAAsJIBrAAIAAMRQAAAiAbAAQAdAAAAgiIAAsRIBmAAIAAMJQABAjgLAeQgJAdgTAVQgRAVgYALQgZAMgbAAQgbAAgZgMg");
	this.shape_2.setTransform(68.5,28.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ag1HPIAAsmIhRAAIAAh3IENAAIAAB3IhQAAIAAMmg");
	this.shape_3.setTransform(38.5,27.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2copy2, new cjs.Rectangle(0,-39,176.6,142.9), null);
...
(lib.Symbol2copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AiCHPIAAudICLAAQAyAAAgAdQATARAKAcQALAeAAAqIAAEGQAAApgLAeQgKAbgTASQggAdgygBIgfAAIAAF1gAgWgLIAcAAQAUAAAAgkIAAkKQAAgmgUAAIgcAAg");
	this.shape.setTransform(114,29.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ag1HPIAAudIBrAAIAAOdg");
	this.shape_1.setTransform(89.1,29.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiGHPIAAudICSAAQAzAAAgAdQATARAKAcQALAeAAAqIAAJ5QAAAqgLAeQgKAcgTARQggAdgzAAgAgaFhIAbAAQAbAAAAgmIAAp0QAAgmgbAAIgbAAg");
	this.shape_2.setTransform(64.4,29.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2copy, new cjs.Rectangle(0,-37,176.6,142.9), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAtHPQgLAAgIg1IgHhaIAAjaQAAglgXAAIgaAAIAAGOIhtAAIAAudICMAAQAyAAAfAdQATARAKAcQAMAeAAAqIAADsQAAAfgOAYQgMAUgYAVQAZAUAMAUQAQAZAAAfIAADFQAAA9AOBZIAAAEgAgegnIAcAAQASAAAAgmIAAjsQAAgmgSAAIgcAAg");
	this.shape.setTransform(135.5,21.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAhHPIgHioIg+AAIgMCoIhgAAIBUudIB4AAIBVOdgAAUCxIgUmYIgbGYIAvAAg");
	this.shape_1.setTransform(103.6,21.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ag0HOQgZgLgSgVQgVgWgKgcQgKgegBgjIAAp2QABgiAKgeQAKgcAVgWQASgVAZgLQAZgMAcAAQAbAAAaAMQAZALASAVQAUAWALAcQAJAeABAiIAAJ2QgBAjgJAeQgLAcgUAWQgSAVgZALQgZAMgcAAQgcAAgZgMgAgblDIAAKHQAAAhAcAAQAbAAAAghIAAqHQAAghgbAAQgcAAAAAhg");
	this.shape_2.setTransform(72.9,21.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(41.2,21.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,-45,176.6,142.9), null);
...
// stage content:
(lib._300x250_soar = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(118).to({_off:false},0).wait(1).to({regX:87,regY:28.3,scaleX:0.24,scaleY:0.24,x:149.6,y:129.7},0).wait(1).to({scaleX:0.31,scaleY:0.31,x:149.5,y:129.6},0).wait(1).to({scaleX:0.36,scaleY:0.36},0).wait(1).to({scaleX:0.41,scaleY:0.41,x:149.4,y:129.5},0).wait(1).to({scaleX:0.45,scaleY:0.45,x:149.3,y:129.4},0).wait(1).to({scaleX:0.48,scaleY:0.48},0).wait(1).to({scaleX:0.52,scaleY:0.52,x:149.2},0).wait(1).to({scaleX:0.55,scaleY:0.55},0).wait(1).to({scaleX:0.57,scaleY:0.57,x:149.1,y:129.3},0).wait(1).to({scaleX:0.6,scaleY:0.6},0).wait(1).to({scaleX:0.62,scaleY:0.62},0).wait(1).to({scaleX:0.65,scaleY:0.65,x:149,y:129.2},0).wait(1).to({scaleX:0.67,scaleY:0.67},0).wait(1).to({scaleX:0.69,scaleY:0.69},0).wait(1).to({scaleX:0.71,scaleY:0.71,x:148.9},0).wait(1).to({scaleX:0.72,scaleY:0.72,y:129.1},0).wait(1).to({scaleX:0.74,scaleY:0.74},0).wait(1).to({scaleX:0.76,scaleY:0.76,x:148.8},0).wait(1).to({scaleX:0.77,scaleY:0.77},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:129},0).wait(1).to({scaleX:0.8,scaleY:0.8},0).wait(1).to({scaleX:0.81,scaleY:0.81},0).wait(1).to({scaleX:0.83,scaleY:0.83},0).wait(1).to({scaleX:0.84,scaleY:0.84,x:148.7},0).wait(1).to({scaleX:0.85,scaleY:0.85},0).wait(1).to({scaleX:0.86,scaleY:0.86},0).wait(1).to({scaleX:0.87,scaleY:0.87},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:128.9},0).wait(1).to({scaleX:0.89,scaleY:0.89},0).wait(1).to({scaleX:0.9,scaleY:0.9},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:148.6},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:148.7},0).wait(1).to({scaleX:0.92,scaleY:0.92,x:148.6},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94,y:128.8},0).wait(1).to({scaleX:0.95,scaleY:0.95,y:128.9},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:148.5,y:128.8},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:148.6},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:128.9},0).wait(1).to({scaleX:0.97,scaleY:0.97,y:128.8},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:148.5},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:148.6},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:148.5},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(2).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(2).to({regX:88.3,regY:29,x:150,y:130},0).to({regX:88.4,regY:29.1,scaleX:1.73,scaleY:1.73,x:150.1,y:130.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(104));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(59).to({_off:false},0).wait(1).to({regX:89,regY:29.8,scaleX:0.24,scaleY:0.24,x:150.1,y:130.1},0).wait(1).to({scaleX:0.31,scaleY:0.31},0).wait(1).to({scaleX:0.36,scaleY:0.36,x:150.2},0).wait(1).to({scaleX:0.41,scaleY:0.41},0).wait(1).to({scaleX:0.45,scaleY:0.45},0).wait(1).to({scaleX:0.48,scaleY:0.48},0).wait(1).to({scaleX:0.52,scaleY:0.52,x:150.3,y:130.2},0).wait(1).to({scaleX:0.55,scaleY:0.55},0).wait(1).to({scaleX:0.57,scaleY:0.57},0).wait(1).to({scaleX:0.6,scaleY:0.6},0).wait(1).to({scaleX:0.62,scaleY:0.62},0).wait(1).to({scaleX:0.65,scaleY:0.65},0).wait(1).to({scaleX:0.67,scaleY:0.67},0).wait(1).to({scaleX:0.69,scaleY:0.69,x:150.4},0).wait(1).to({scaleX:0.71,scaleY:0.71,x:150.3},0).wait(1).to({scaleX:0.72,scaleY:0.72,x:150.4},0).wait(1).to({scaleX:0.74,scaleY:0.74},0).wait(1).to({scaleX:0.76,scaleY:0.76},0).wait(1).to({scaleX:0.77,scaleY:0.77},0).wait(1).to({scaleX:0.79,scaleY:0.79},0).wait(1).to({scaleX:0.8,scaleY:0.8},0).wait(1).to({scaleX:0.81,scaleY:0.81,y:130.3},0).wait(1).to({scaleX:0.83,scaleY:0.83,y:130.2},0).wait(1).to({scaleX:0.84,scaleY:0.84},0).wait(1).to({scaleX:0.85,scaleY:0.85,y:130.3},0).wait(1).to({scaleX:0.86,scaleY:0.86},0).wait(1).to({scaleX:0.87,scaleY:0.87},0).wait(1).to({scaleX:0.88,scaleY:0.88,x:150.5},0).wait(1).to({scaleX:0.89,scaleY:0.89},0).wait(1).to({scaleX:0.9,scaleY:0.9},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:150.4},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:150.5},0).wait(1).to({scaleX:0.92,scaleY:0.92},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.95,scaleY:0.95},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(2).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(2).to({regX:88.3,regY:29,x:150,y:130},0).to({regX:88.4,regY:29.1,scaleX:1.99,scaleY:1.99,x:150.1,y:130.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regY:21.8,scaleX:0.24,scaleY:0.24,y:128.2},0).wait(1).to({scaleX:0.31,scaleY:0.31,y:127.6},0).wait(1).to({scaleX:0.36,scaleY:0.36,y:127.2},0).wait(1).to({scaleX:0.41,scaleY:0.41,y:126.9},0).wait(1).to({scaleX:0.45,scaleY:0.45,y:126.5},0).wait(1).to({scaleX:0.48,scaleY:0.48,y:126.3},0).wait(1).to({scaleX:0.52,scaleY:0.52,y:126.1},0).wait(1).to({scaleX:0.55,scaleY:0.55,y:125.8},0).wait(1).to({scaleX:0.57,scaleY:0.57,y:125.6},0).wait(1).to({scaleX:0.6,scaleY:0.6,y:125.4},0).wait(1).to({scaleX:0.62,scaleY:0.62,y:125.2},0).wait(1).to({scaleX:0.65,scaleY:0.65,y:125},0).wait(1).to({scaleX:0.67,scaleY:0.67,y:124.9},0).wait(1).to({scaleX:0.69,scaleY:0.69,y:124.7},0).wait(1).to({scaleX:0.71,scaleY:0.71,y:124.6},0).wait(1).to({scaleX:0.72,scaleY:0.72,y:124.4},0).wait(1).to({scaleX:0.74,scaleY:0.74,y:124.3},0).wait(1).to({scaleX:0.76,scaleY:0.76,y:124.2},0).wait(1).to({scaleX:0.77,scaleY:0.77,y:124.1},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:123.9},0).wait(1).to({scaleX:0.8,scaleY:0.8,y:123.8},0).wait(1).to({scaleX:0.81,scaleY:0.81},0).wait(1).to({scaleX:0.83,scaleY:0.83,y:123.6},0).wait(1).to({scaleX:0.84,scaleY:0.84,y:123.5},0).wait(1).to({scaleX:0.85,scaleY:0.85},0).wait(1).to({scaleX:0.86,scaleY:0.86,y:123.4},0).wait(1).to({scaleX:0.87,scaleY:0.87,y:123.3},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:123.2},0).wait(1).to({scaleX:0.89,scaleY:0.89},0).wait(1).to({scaleX:0.9,scaleY:0.9,y:123.1},0).wait(1).to({scaleX:0.9,scaleY:0.9,y:123},0).wait(1).to({scaleX:0.91,scaleY:0.91},0).wait(1).to({scaleX:0.92,scaleY:0.92,y:122.9},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:122.8},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94,y:122.7},0).wait(1).to({scaleX:0.95,scaleY:0.95},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:122.6},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.97,scaleY:0.97,y:122.5},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:122.4},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:122.3},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(2).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(2).to({regX:88.3,regY:29,y:130},0).to({regX:88.4,regY:29.1,scaleX:1.73,scaleY:1.73,x:150.1,y:130.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(222));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x250_soar_atlas_NP_.jpg", id:"300x250_soar_atlas_NP_"}
	],
	preloads: []
};
