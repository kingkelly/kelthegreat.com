...
lib.ssMetadata = [
		{name:"300x600_soar_atlas_NP_", frames: [[0,602,300,305],[604,0,300,600],[0,0,300,600],[302,0,300,600]]}
];
...
(lib.Couple300x600 = function() {
	this.spriteSheet = ss["300x600_soar_atlas_NP_"];
	this.gotoAndStop(0);
...
(lib.Symbol2copy2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AA2G+IhWm5IgVh3IAAIwIhXAAIAAt7IBsAAIBHGyIAQB6IAAosIBWAAIAAN7g");
	this.shape.setTransform(132.7,45.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AArG+QgKAAgIgzIgHhXIAAjSQAAgjgWAAIgZAAIAAF/IhpAAIAAt7ICGAAQAxAAAeAbQASARAKAaQALAeAAAoIAADkQAAAegOAXQgLAUgXATQAYAUAMATQAPAYAAAdIAAC/QAAA7AOBVIAAAEgAgdgmIAbAAQARAAAAgkIAAjkQAAgkgRAAIgbAAg");
	this.shape_1.setTransform(101.4,45.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgwG5QgYgLgSgUQgSgVgKgcQgKgdAAghIAArtIBoAAIAAL1QAAAgAaAAQAcAAAAggIAAr1IBjAAIAALtQAAAhgKAdQgJAcgSAVQgRAUgXALQgYALgagBQgaABgYgLg");
	this.shape_2.setTransform(69.2,46);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgzG+IAAsJIhOAAIAAhyIEDAAIAAByIhNAAIAAMJg");
	this.shape_3.setTransform(40.3,45.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2copy2, new cjs.Rectangle(0,-19,176.6,137.9), null);
...
(lib.Symbol2copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ah9G+IAAt7ICGAAQAwAAAeAbQATARAJAaQAMAeAAAoIAAD8QAAApgMAcQgJAbgTARQgeAbgwAAIgeAAIAAFngAgVgLIAbAAQATAAAAgjIAAkAQAAgkgTAAIgbAAg");
	this.shape.setTransform(113.1,40.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgzG+IAAt7IBnAAIAAN7g");
	this.shape_1.setTransform(89,40.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AiBG+IAAt7ICMAAQAyAAAeAbQATARAJAaQALAeAAAoIAAJjQAAAogLAeQgJAagTARQgeAbgyAAgAgZFUIAaAAQAZAAAAgkIAApeQAAgkgZAAIgaAAg");
	this.shape_2.setTransform(65.3,40.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2copy, new cjs.Rectangle(0,-24,176.6,137.9), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AArG+QgKAAgIgzIgHhXIAAjSQAAgjgWAAIgZAAIAAF/IhpAAIAAt7ICGAAQAxAAAeAbQASARAKAaQALAeAAAoIAADkQAAAegOAXQgLAUgXATQAYAUAMATQAPAYAAAdIAAC/QAAA7AOBVIAAAEgAgdgmIAbAAQARAAAAgkIAAjkQAAgkgRAAIgbAAg");
	this.shape.setTransform(134.1,39.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAgG+IgHiiIg8AAIgLCiIhcAAIBQt7IB0AAIBSN7gAATCqIgTmJIgaGJIAtAAg");
	this.shape_1.setTransform(103.3,39.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgyG+QgYgLgSgUQgTgVgKgcQgKgcAAgiIAApfQAAghAKgdQAKgbATgVQASgUAYgMQAYgLAaAAQAbAAAZALQAYAMASAUQATAVAKAbQAJAdAAAhIAAJfQAAAigJAcQgKAcgTAVQgSAUgYALQgYALgcAAQgaAAgYgLgAgak3IAAJvQAAAgAaAAQAbAAAAggIAApvQAAgggbAAQgaAAAAAgg");
	this.shape_2.setTransform(73.7,39.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(43.2,39.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(-60.4,-25,298,137.9), null);
...
// stage content:
(lib._300x600_soar = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(118).to({_off:false},0).wait(1).to({regX:87,regY:45.9,scaleX:0.24,scaleY:0.24,x:149.6,y:276.9},0).wait(1).to({scaleX:0.3,scaleY:0.3,y:277.9},0).wait(1).to({scaleX:0.35,scaleY:0.35,x:149.5,y:278.8},0).wait(1).to({scaleX:0.4,scaleY:0.4,x:149.4,y:279.5},0).wait(1).to({scaleX:0.44,scaleY:0.44,x:149.3,y:280.2},0).wait(1).to({scaleX:0.47,scaleY:0.47,y:280.7},0).wait(1).to({scaleX:0.5,scaleY:0.5,y:281.2},0).wait(1).to({scaleX:0.53,scaleY:0.53,x:149.2,y:281.7},0).wait(1).to({scaleX:0.56,scaleY:0.56,y:282.2},0).wait(1).to({scaleX:0.58,scaleY:0.58,x:149.1,y:282.5},0).wait(1).to({scaleX:0.61,scaleY:0.61,y:283},0).wait(1).to({scaleX:0.63,scaleY:0.63,x:149,y:283.3},0).wait(1).to({scaleX:0.65,scaleY:0.65,y:283.7},0).wait(1).to({scaleX:0.67,scaleY:0.67,y:283.9},0).wait(1).to({scaleX:0.69,scaleY:0.69,y:284.2},0).wait(1).to({scaleX:0.7,scaleY:0.7,y:284.5},0).wait(1).to({scaleX:0.72,scaleY:0.72,x:148.9,y:284.8},0).wait(1).to({scaleX:0.74,scaleY:0.74,y:285.1},0).wait(1).to({scaleX:0.75,scaleY:0.75,x:148.8,y:285.3},0).wait(1).to({scaleX:0.77,scaleY:0.77,y:285.5},0).wait(1).to({scaleX:0.78,scaleY:0.78,y:285.8},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:286},0).wait(1).to({scaleX:0.8,scaleY:0.8,y:286.2},0).wait(1).to({scaleX:0.82,scaleY:0.82,y:286.4},0).wait(1).to({scaleX:0.83,scaleY:0.83,y:286.5},0).wait(1).to({scaleX:0.84,scaleY:0.84,x:148.7,y:286.7},0).wait(1).to({scaleX:0.85,scaleY:0.85,y:286.9},0).wait(1).to({scaleX:0.86,scaleY:0.86,y:287},0).wait(1).to({scaleX:0.87,scaleY:0.87,y:287.2},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:287.3},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:287.5},0).wait(1).to({scaleX:0.89,scaleY:0.89,x:148.6,y:287.6},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:148.7,y:287.7},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:148.6,y:287.9},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:148.7,y:288},0).wait(1).to({scaleX:0.92,scaleY:0.92,x:148.6,y:288.1},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:288.2},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:288.3},0).wait(1).to({scaleX:0.94,scaleY:0.94,y:288.4},0).wait(1).to({scaleX:0.94,scaleY:0.94,y:288.5},0).wait(1).to({scaleX:0.95,scaleY:0.95},0).wait(1).to({scaleX:0.95,scaleY:0.95,y:288.6},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:288.7},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:148.5,y:288.8},0).wait(1).to({scaleX:0.97,scaleY:0.97,y:288.9},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:289},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:289.1},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:289.2},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:289.3},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1,y:289.4},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({regX:88.3,regY:29,scaleX:1,scaleY:1,x:150,y:273},0).to({regX:88.4,regY:29.1,scaleX:1.73,scaleY:1.73,x:150.1,y:273.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(104));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(59).to({_off:false},0).wait(1).to({regX:89,regY:40.4,scaleX:0.24,scaleY:0.24,x:150.1,y:275.6},0).wait(1).to({scaleX:0.3,scaleY:0.3,x:150.2,y:276.3},0).wait(1).to({scaleX:0.35,scaleY:0.35,y:276.9},0).wait(1).to({scaleX:0.4,scaleY:0.4,y:277.3},0).wait(1).to({scaleX:0.44,scaleY:0.44,y:277.8},0).wait(1).to({scaleX:0.47,scaleY:0.47,x:150.3,y:278.2},0).wait(1).to({scaleX:0.5,scaleY:0.5,y:278.5},0).wait(1).to({scaleX:0.53,scaleY:0.53,y:278.8},0).wait(1).to({scaleX:0.56,scaleY:0.56,y:279.1},0).wait(1).to({scaleX:0.58,scaleY:0.58,y:279.3},0).wait(1).to({scaleX:0.61,scaleY:0.61,y:279.6},0).wait(1).to({scaleX:0.63,scaleY:0.63,y:279.9},0).wait(1).to({scaleX:0.65,scaleY:0.65,y:280.1},0).wait(1).to({scaleX:0.67,scaleY:0.67,x:150.4,y:280.3},0).wait(1).to({scaleX:0.69,scaleY:0.69,x:150.3,y:280.5},0).wait(1).to({scaleX:0.7,scaleY:0.7,x:150.4,y:280.7},0).wait(1).to({scaleX:0.72,scaleY:0.72,x:150.3,y:280.8},0).wait(1).to({scaleX:0.74,scaleY:0.74,x:150.4,y:281},0).wait(1).to({scaleX:0.75,scaleY:0.75,x:150.3,y:281.2},0).wait(1).to({scaleX:0.77,scaleY:0.77,x:150.4,y:281.3},0).wait(1).to({scaleX:0.78,scaleY:0.78,y:281.5},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:281.6},0).wait(1).to({scaleX:0.8,scaleY:0.8,y:281.7},0).wait(1).to({scaleX:0.82,scaleY:0.82,y:281.9},0).wait(1).to({scaleX:0.83,scaleY:0.83,y:282},0).wait(1).to({scaleX:0.84,scaleY:0.84,y:282.1},0).wait(1).to({scaleX:0.85,scaleY:0.85,y:282.2},0).wait(1).to({scaleX:0.86,scaleY:0.86,y:282.3},0).wait(1).to({scaleX:0.87,scaleY:0.87,y:282.5},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:282.6},0).wait(1).to({scaleX:0.89,scaleY:0.89,y:282.7},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:150.5,y:282.8},0).wait(1).to({scaleX:0.91,scaleY:0.91,y:282.9},0).wait(1).to({scaleX:0.91,scaleY:0.91,y:283},0).wait(1).to({scaleX:0.92,scaleY:0.92},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:283.1},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:283.2},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94,y:283.3},0).wait(1).to({scaleX:0.95,scaleY:0.95},0).wait(1).to({scaleX:0.95,scaleY:0.95,y:283.4},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:283.5},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97,y:283.6},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:283.7},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:283.8},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:1,scaleY:1,y:283.9},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({regX:88.3,regY:29,scaleX:1,scaleY:1,x:150,y:273},0).to({regX:88.4,regY:29.1,scaleX:1.99,scaleY:1.99,x:150.1,y:273.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:88.7,regY:39.4,scaleX:0.24,scaleY:0.24,y:275.3},0).wait(1).to({scaleX:0.3,scaleY:0.3,x:150.1,y:276},0).wait(1).to({scaleX:0.35,scaleY:0.35,y:276.5},0).wait(1).to({scaleX:0.4,scaleY:0.4,y:277},0).wait(1).to({scaleX:0.44,scaleY:0.44,y:277.3},0).wait(1).to({scaleX:0.47,scaleY:0.47,y:277.7},0).wait(1).to({scaleX:0.5,scaleY:0.5,y:278},0).wait(1).to({scaleX:0.53,scaleY:0.53,y:278.3},0).wait(1).to({scaleX:0.56,scaleY:0.56,y:278.5},0).wait(1).to({scaleX:0.58,scaleY:0.58,y:278.8},0).wait(1).to({scaleX:0.61,scaleY:0.61,y:279},0).wait(1).to({scaleX:0.63,scaleY:0.63,y:279.2},0).wait(1).to({scaleX:0.65,scaleY:0.65,y:279.4},0).wait(1).to({scaleX:0.67,scaleY:0.67,y:279.6},0).wait(1).to({scaleX:0.69,scaleY:0.69,y:279.8},0).wait(1).to({scaleX:0.7,scaleY:0.7,x:150.2,y:280},0).wait(1).to({scaleX:0.72,scaleY:0.72,x:150.1,y:280.1},0).wait(1).to({scaleX:0.74,scaleY:0.74,x:150.2,y:280.3},0).wait(1).to({scaleX:0.75,scaleY:0.75,x:150.1,y:280.4},0).wait(1).to({scaleX:0.77,scaleY:0.77,y:280.6},0).wait(1).to({scaleX:0.78,scaleY:0.78,x:150.2,y:280.7},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:280.9},0).wait(1).to({scaleX:0.8,scaleY:0.8,x:150.1},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:150.2,y:281.1},0).wait(1).to({scaleX:0.83,scaleY:0.83,y:281.2},0).wait(1).to({scaleX:0.84,scaleY:0.84,y:281.3},0).wait(1).to({scaleX:0.85,scaleY:0.85,y:281.4},0).wait(1).to({scaleX:0.86,scaleY:0.86,y:281.5},0).wait(1).to({scaleX:0.87,scaleY:0.87,y:281.6},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:281.7},0).wait(1).to({scaleX:0.89,scaleY:0.89,y:281.8},0).wait(1).to({scaleX:0.9,scaleY:0.9,y:281.9},0).wait(1).to({scaleX:0.91,scaleY:0.91,y:282},0).wait(1).to({scaleX:0.91,scaleY:0.91},0).wait(1).to({scaleX:0.92,scaleY:0.92,y:282.1},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:282.2},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.94,scaleY:0.94,y:282.3},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.95,scaleY:0.95,y:282.4},0).wait(1).to({scaleX:0.95,scaleY:0.95},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:282.5},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.97,scaleY:0.97,y:282.6},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:282.7},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:282.8},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:1,scaleY:1,y:282.9},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({regX:88.3,regY:29,scaleX:1,scaleY:1,x:150,y:273},0).to({regX:88.4,regY:29.1,scaleX:1.73,scaleY:1.73,x:150.1,y:273.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(222));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x600_soar_atlas_NP_.jpg", id:"300x600_soar_atlas_NP_"}
	],
	preloads: []
};
