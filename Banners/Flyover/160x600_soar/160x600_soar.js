...
lib.ssMetadata = [
		{name:"160x600_soar_atlas_NP_", frames: [[0,602,160,218],[302,0,300,600],[604,0,300,600],[0,0,300,600]]}
];
...
(lib.Couple160x600 = function() {
	this.spriteSheet = ss["160x600_soar_atlas_NP_"];
	this.gotoAndStop(0);
...
(lib.Symbol2copy2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAvGGIhLmCIgShnIAAHpIhMAAIAAsLIBeAAIA+F8IAOBqIAAnmIBLAAIAAMLg");
	this.shape.setTransform(127,37.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAmGGQgKgBgHgsIgFhMIAAi4QAAgegTAAIgWAAIAAFPIhbAAIAAsLIB1AAQAqAAAaAYQAQAPAIAXQAKAaAAAjIAADHQAAAZgLAVQgKARgVARQAWARAJARQAOAVAAAZIAACnQAAAzAMBLIAAAEgAgZghIAXAAQAPAAAAggIAAjHQAAgfgPAAIgXAAg");
	this.shape_1.setTransform(99.8,37.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgqGAQgVgIgPgTQgQgRgJgYQgIgaAAgdIAAqOIBaAAIAAKVQAAAcAXAAQAYAAAAgcIAAqVIBWAAIAAKOQAAAdgIAaQgIAYgQARQgPATgUAIQgUAKgXAAQgXAAgVgKg");
	this.shape_2.setTransform(71.6,38);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgsGGIAAqoIhEAAIAAhjIDhAAIAABjIhDAAIAAKog");
	this.shape_3.setTransform(46.4,37.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2copy2, new cjs.Rectangle(0,-19,176.6,120.9), null);
...
(lib.Symbol2copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhtGFIAAsJIB0AAQArAAAaAYQAQAOAIAXQAKAZAAAkIAADcQAAAjgKAZQgIAXgQAPQgaAYgrAAIgZAAIAAE5gAgSgJIAYAAQAQAAAAgfIAAjfQAAgggQAAIgYAAg");
	this.shape.setTransform(110,32.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgtGFIAAsJIBbAAIAAMJg");
	this.shape_1.setTransform(89,32.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhxGFIAAsJIB7AAQAqAAAbAYQARAOAIAXQAKAZAAAkIAAIVQAAAjgKAaQgIAXgRAPQgbAYgqgBgAgVEpIAVAAQAXAAAAgfIAAoRQAAgggXAAIgVAAg");
	this.shape_2.setTransform(68.2,32.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2copy, new cjs.Rectangle(0,-24,176.6,120.9), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAlGFQgIABgIguIgFhLIAAi3QAAgggTAAIgWAAIAAFPIhcAAIAAsJIB1AAQArAAAaAXQAQAPAIAXQALAZAAAkIAADHQAAAagNAUQgKARgUARQAWARAJAQQANAWABAZIAACnQgBAzAMBLIAAADgAgZghIAXAAQAPAAAAggIAAjGQAAgggPAAIgXAAg");
	this.shape.setTransform(128.3,31.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAcGFIgGiNIg1AAIgJCNIhRAAIBGsJIBlAAIBHMJgAARCVIgRlYIgXFYIAoAAg");
	this.shape_1.setTransform(101.5,31.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgsGFQgUgJgQgSQgRgSgIgYQgKgZAAgdIAAoTQAAgcAKgZQAIgYARgSQAQgSAUgKQAVgKAXAAQAYAAAVAKQAVAKAQASQAQASAJAYQAJAZAAAcIAAITQAAAdgJAZQgJAYgQASQgPASgWAJQgVAKgYAAQgXAAgVgKgAgWkPIAAIgQAAAcAWAAQAYAAAAgcIAAogQAAgcgYAAQgWAAAAAcg");
	this.shape_2.setTransform(75.6,31.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(49,31.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(-60.4,-25,298,120.9), null);
...
// stage content:
(lib._160x600_soar = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_7.setTransform(80,213,0.1,0.1,0,0,0,88.5,29.5);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(118).to({_off:false},0).wait(1).to({regX:87.2,regY:38,scaleX:0.24,scaleY:0.24,x:79.7,y:215},0).wait(1).to({scaleX:0.3,scaleY:0.3,x:79.6,y:215.6},0).wait(1).to({scaleX:0.35,scaleY:0.35,x:79.5,y:216},0).wait(1).to({scaleX:0.4,scaleY:0.4,y:216.4},0).wait(1).to({scaleX:0.44,scaleY:0.44,x:79.4,y:216.7},0).wait(1).to({scaleX:0.47,scaleY:0.47,y:217},0).wait(1).to({scaleX:0.5,scaleY:0.5,y:217.3},0).wait(1).to({scaleX:0.53,scaleY:0.53,x:79.3,y:217.5},0).wait(1).to({scaleX:0.56,scaleY:0.56,y:217.7},0).wait(1).to({scaleX:0.58,scaleY:0.58,x:79.2,y:217.9},0).wait(1).to({scaleX:0.61,scaleY:0.61,y:218.2},0).wait(1).to({scaleX:0.63,scaleY:0.63,y:218.4},0).wait(1).to({scaleX:0.65,scaleY:0.65,y:218.5},0).wait(1).to({scaleX:0.67,scaleY:0.67,x:79.1,y:218.7},0).wait(1).to({scaleX:0.69,scaleY:0.69,y:218.8},0).wait(1).to({scaleX:0.7,scaleY:0.7,y:219},0).wait(1).to({scaleX:0.72,scaleY:0.72,x:79,y:219.1},0).wait(1).to({scaleX:0.74,scaleY:0.74,x:79.1,y:219.2},0).wait(1).to({scaleX:0.75,scaleY:0.75,x:79,y:219.4},0).wait(1).to({scaleX:0.77,scaleY:0.77,y:219.5},0).wait(1).to({scaleX:0.78,scaleY:0.78,y:219.6},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:219.7},0).wait(1).to({scaleX:0.8,scaleY:0.8,x:78.9,y:219.8},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:79,y:219.9},0).wait(1).to({scaleX:0.83,scaleY:0.83,x:78.9,y:220},0).wait(1).to({scaleX:0.84,scaleY:0.84,y:220.1},0).wait(1).to({scaleX:0.85,scaleY:0.85,y:220.2},0).wait(1).to({scaleX:0.86,scaleY:0.86,y:220.3},0).wait(1).to({scaleX:0.87,scaleY:0.87,y:220.4},0).wait(1).to({scaleX:0.88,scaleY:0.88,x:78.8},0).wait(1).to({scaleX:0.88,scaleY:0.88,y:220.5},0).wait(1).to({scaleX:0.89,scaleY:0.89,y:220.6},0).wait(1).to({scaleX:0.9,scaleY:0.9},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:78.9,y:220.7},0).wait(1).to({scaleX:0.91,scaleY:0.91,y:220.8},0).wait(1).to({scaleX:0.92,scaleY:0.92},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:220.9},0).wait(1).to({scaleX:0.93,scaleY:0.93,x:78.8},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94,y:221},0).wait(1).to({scaleX:0.95,scaleY:0.95},0).wait(1).to({scaleX:0.95,scaleY:0.95,y:221.1},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:221.2},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97,y:221.3},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:221.4},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:78.7},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:78.8},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:78.7},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:78.8,y:221.5},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({regX:88.3,regY:29,scaleX:1,scaleY:1,x:80,y:213},0).to({regX:88.4,regY:29.1,scaleX:1.73,scaleY:1.73,x:80.1,y:213.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(122));

	// txt2
	this.instance_8 = new lib.Symbol2copy();
	this.instance_8.parent = this;
	this.instance_8.setTransform(80,213,0.1,0.1,0,0,0,88.5,29.5);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(59).to({_off:false},0).wait(1).to({regX:88.9,regY:32.5,scaleX:0.24,scaleY:0.24,x:80.1,y:213.7},0).wait(1).to({scaleX:0.3,scaleY:0.3,y:213.9},0).wait(1).to({scaleX:0.35,scaleY:0.35,y:214.1},0).wait(1).to({scaleX:0.4,scaleY:0.4,y:214.2},0).wait(1).to({scaleX:0.44,scaleY:0.44,x:80.2,y:214.3},0).wait(1).to({scaleX:0.47,scaleY:0.47,y:214.4},0).wait(1).to({scaleX:0.5,scaleY:0.5,y:214.5},0).wait(1).to({scaleX:0.53,scaleY:0.53,y:214.6},0).wait(1).to({scaleX:0.56,scaleY:0.56,y:214.7},0).wait(1).to({scaleX:0.58,scaleY:0.58},0).wait(1).to({scaleX:0.61,scaleY:0.61,y:214.8},0).wait(1).to({scaleX:0.63,scaleY:0.63,y:214.9},0).wait(1).to({scaleX:0.65,scaleY:0.65,x:80.3,y:215},0).wait(1).to({scaleX:0.67,scaleY:0.67},0).wait(1).to({scaleX:0.69,scaleY:0.69},0).wait(1).to({scaleX:0.7,scaleY:0.7,y:215.1},0).wait(1).to({scaleX:0.72,scaleY:0.72},0).wait(1).to({scaleX:0.74,scaleY:0.74,y:215.2},0).wait(1).to({scaleX:0.75,scaleY:0.75},0).wait(1).to({scaleX:0.77,scaleY:0.77,y:215.3},0).wait(1).to({scaleX:0.78,scaleY:0.78},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:215.4},0).wait(1).to({scaleX:0.8,scaleY:0.8},0).wait(1).to({scaleX:0.82,scaleY:0.82,y:215.5},0).wait(1).to({scaleX:0.83,scaleY:0.83},0).wait(1).to({scaleX:0.84,scaleY:0.84},0).wait(1).to({scaleX:0.85,scaleY:0.85,y:215.6},0).wait(1).to({scaleX:0.86,scaleY:0.86},0).wait(1).to({scaleX:0.87,scaleY:0.87},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1).to({scaleX:0.89,scaleY:0.89,y:215.7},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:80.4},0).wait(1).to({scaleX:0.91,scaleY:0.91},0).wait(1).to({scaleX:0.91,scaleY:0.91},0).wait(1).to({scaleX:0.92,scaleY:0.92,y:215.8},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:80.5},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:80.4},0).wait(1).to({scaleX:0.96,scaleY:0.96,y:215.9},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:216},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:215.9},0).wait(1).to({scaleX:0.99,scaleY:0.99,y:216},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:80.5},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1,x:80.4},0).wait(1).to({scaleX:1,scaleY:1,x:80.5},0).wait(1).to({regX:88.3,regY:29,scaleX:1,scaleY:1,x:80,y:213},0).to({regX:88.4,regY:29.1,scaleX:1.99,scaleY:1.99,x:80.1,y:213.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(181));

	// txt1
	this.instance_9 = new lib.Symbol2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(80,213,0.1,0.1,0,0,0,88.5,29.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regX:88.7,regY:31.5,scaleX:0.24,scaleY:0.24,y:213.5},0).wait(1).to({scaleX:0.3,scaleY:0.3,x:80.1,y:213.6},0).wait(1).to({scaleX:0.35,scaleY:0.35,y:213.7},0).wait(1).to({scaleX:0.4,scaleY:0.4,y:213.8},0).wait(1).to({scaleX:0.44,scaleY:0.44,y:213.9},0).wait(1).to({scaleX:0.47,scaleY:0.47,y:214},0).wait(1).to({scaleX:0.5,scaleY:0.5},0).wait(1).to({scaleX:0.53,scaleY:0.53,y:214.1},0).wait(1).to({scaleX:0.56,scaleY:0.56},0).wait(1).to({scaleX:0.58,scaleY:0.58},0).wait(1).to({scaleX:0.61,scaleY:0.61,y:214.2},0).wait(1).to({scaleX:0.63,scaleY:0.63,y:214.3},0).wait(1).to({scaleX:0.65,scaleY:0.65},0).wait(1).to({scaleX:0.67,scaleY:0.67},0).wait(1).to({scaleX:0.69,scaleY:0.69,y:214.4},0).wait(1).to({scaleX:0.7,scaleY:0.7,x:80.2},0).wait(1).to({scaleX:0.72,scaleY:0.72,x:80.1},0).wait(1).to({scaleX:0.74,scaleY:0.74,x:80.2,y:214.5},0).wait(1).to({scaleX:0.75,scaleY:0.75,x:80.1},0).wait(1).to({scaleX:0.77,scaleY:0.77},0).wait(1).to({scaleX:0.78,scaleY:0.78,x:80.2},0).wait(1).to({scaleX:0.79,scaleY:0.79,y:214.6},0).wait(1).to({scaleX:0.8,scaleY:0.8,x:80.1},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:80.2,y:214.7},0).wait(1).to({scaleX:0.83,scaleY:0.83},0).wait(1).to({scaleX:0.84,scaleY:0.84},0).wait(1).to({scaleX:0.85,scaleY:0.85},0).wait(1).to({scaleX:0.86,scaleY:0.86},0).wait(1).to({scaleX:0.87,scaleY:0.87},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1).to({scaleX:0.88,scaleY:0.88},0).wait(1).to({scaleX:0.89,scaleY:0.89,y:214.8},0).wait(1).to({scaleX:0.9,scaleY:0.9},0).wait(1).to({scaleX:0.91,scaleY:0.91},0).wait(1).to({scaleX:0.91,scaleY:0.91,x:80.3},0).wait(1).to({scaleX:0.92,scaleY:0.92,x:80.2},0).wait(1).to({scaleX:0.93,scaleY:0.93},0).wait(1).to({scaleX:0.93,scaleY:0.93,y:214.9},0).wait(1).to({scaleX:0.94,scaleY:0.94},0).wait(1).to({scaleX:0.94,scaleY:0.94,x:80.3},0).wait(1).to({scaleX:0.95,scaleY:0.95},0).wait(1).to({scaleX:0.95,scaleY:0.95,x:80.2},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.96,scaleY:0.96},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.97,scaleY:0.97},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98},0).wait(1).to({scaleX:0.98,scaleY:0.98,y:215},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99},0).wait(1).to({scaleX:0.99,scaleY:0.99,x:80.3},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({scaleX:1,scaleY:1,x:80.2},0).wait(1).to({scaleX:1,scaleY:1,x:80.3},0).wait(1).to({regX:88.3,regY:29,scaleX:1,scaleY:1,x:80,y:213},0).to({regX:88.4,regY:29.1,scaleX:1.73,scaleY:1.73,x:80.1,y:273.1,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(240));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/160x600_soar_atlas_NP_.jpg", id:"160x600_soar_atlas_NP_"}
	],
	preloads: []
};
