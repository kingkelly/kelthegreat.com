...
lib.ssMetadata = [
		{name:"300x250_pursuit_a_atlas_", frames: [[302,252,300,250],[302,0,300,250],[0,252,300,250],[0,0,300,250],[604,0,300,250]]}
];
...
(lib.photo1 = function() {
	this.spriteSheet = ss["300x250_pursuit_a_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgWAcIAAg3IAsAAIAAANIgcAAIAAAIIAZAAIAAAMIgZAAIAAAJIAdAAIAAANg");
	this.shape.setTransform(42.7,66.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgDAcIgFgBIgFgCIgEgEIgEgEIgCgFIgCgGIgBgGIABgFIACgFIACgGIAEgDIAEgEIAFgDIAGgBIAFgBIAIABIAGACIAFAEIAFAEIgMAKIgFgFQgEgCgDAAIgFABIgEAEIgDAEIgBAFIABAGIADAEIAEAEIAFABIAEAAIADgCIAFgFIAMAJIgEAEIgGAFQgDACgDAAIgJABIgFgBg");
	this.shape_1.setTransform(37.1,66.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AANAcIgXgdIAAAdIgPAAIAAg3IAOAAIAWAcIAAgcIAQAAIAAA3g");
	this.shape_2.setTransform(31,66.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAPAcIgEgKIgVAAIgEAKIgQAAIAYg3IAOAAIAXA3gAAGAGIgGgPIgFAPIALAAg");
	this.shape_3.setTransform(24.7,66.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgHAcIgWg3IASAAIALAiIANgiIARAAIgXA3g");
	this.shape_4.setTransform(18.5,66.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgaAcIAAg3IAWAAIAGABIAGABIAGACIAEAEIAEAEIACAFIACAFIAAAFIAAAAIAAAGIgCAFIgCAFIgEAEIgEAEIgGACIgGABIgGABgAgKAPIAHAAIAFgCIAEgDIADgEIACgGIgCgFIgDgEIgEgEIgFAAIgHAAg");
	this.shape_5.setTransform(12.5,66.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAPAcIgEgKIgVAAIgEAKIgQAAIAYg3IAOAAIAXA3gAAGAGIgGgPIgFAPIALAAg");
	this.shape_6.setTransform(6.2,66.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AANAcIgXgdIAAAdIgPAAIAAg3IAOAAIAWAcIAAgcIAQAAIAAA3g");
	this.shape_7.setTransform(35.7,55.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgHAcIAAg3IAPAAIAAA3g");
	this.shape_8.setTransform(31.2,55.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AAIAcIgNgVIgGAHIAAAOIgPAAIAAg3IAPAAIAAAXIATgXIASAAIgVAYIAWAfg");
	this.shape_9.setTransform(25.1,55.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(18.6,55.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(12,55.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(6,55.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgKAbIgFgCIgDgDIgEgDIgCgEIgBgGIAAgGIAAgeIAQAAIAAAdIAAAGIACADIADADIAEABIAEgBIAEgDIACgDIAAgFIAAgeIAQAAIAAAdIAAAHIgCAFIgCAEIgDAEIgEADIgFACIgKABIgKgBg");
	this.shape_13.setTransform(47.1,45);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("");
	this.shape_14.setTransform(40.8,44.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgHAcIAAgVIgVgiIASAAIAKAVIALgVIASAAIgVAiIAAAVg");
	this.shape_15.setTransform(34.6,44.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AANAcIgXgeIAAAeIgPAAIAAg3IAOAAIAWAdIAAgdIAQAAIAAA3g");
	this.shape_16.setTransform(26.4,44.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgWAcIAAg3IAsAAIAAANIgcAAIAAAJIAZAAIAAALIgZAAIAAAJIAdAAIAAANg");
	this.shape_17.setTransform(20.7,44.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAKAcIAAgWIgTAAIAAAWIgPAAIAAg3IAPAAIAAAVIATAAIAAgVIAPAAIAAA3g");
	this.shape_18.setTransform(15,44.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AAMAcIgMgfIgKAfIgNAAIgUg3IARAAIAKAfIALgfIAMAAIALAfIAJgfIAQAAIgSA3g");
	this.shape_19.setTransform(7.5,44.9);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("");
	this.shape_20.setTransform(6.6,25.8);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgQBMQgKgCgIgDQgIgDgHgFIgMgMIAbgbQAIAJAIAFQAKAEAJAAQAJAAAFgEQAGgFAAgGIAAgBQAAgHgHgFQgHgEgKAAIgSAAIgHgVIAjggIg6AAIAAgjIBuAAIAAAfIglAgQAKABAGADQAHAEAGAFQAFAEADAIQADAIAAAJIAAABQABALgFAJQgFAKgHAHQgJAGgLAEQgKADgNAAQgKAAgJgCg");
	this.shape_21.setTransform(41.4,28.6);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("Ag3BNIBDh1IhGAAIAAgkIB1AAIAAAgIhDB5g");
	this.shape_22.setTransform(28.2,28.4);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgDBNIAAhyIgaAGIgIghIAsgMIAfAAIAACZg");
	this.shape_23.setTransform(16,28.4);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AAbA0IAAg7IgbApIAAAAIgagpIAAA7IgdAAIAAhoIAfAAIAYApIAZgpIAfAAIAABog");
	this.shape_24.setTransform(41.4,10.2);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("");
	this.shape_25.setTransform(28.7,10.2);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AAPA0IgVgfIgMAAIAAAfIgdAAIAAhoIAwAAQAIABANADIAHADIAGAFQAFAFACAGQADAFAAAIQAAAGgCAGQgBAEgDAEQgDAEgEADQgEADgFACIAZAkgAgSgBIASAAQAHAAAEgDQAEgEAAgFIAAgBQAAgGgEgDQgEgDgHgBIgSAAg");
	this.shape_26.setTransform(17.5,10.2);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AgpA0IAAhoIBTAAIAAAaIg2AAIAAASIAxAAIAAAXIgxAAIAAAlg");
	this.shape_27.setTransform(7.2,10.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol11, new cjs.Rectangle(0,-1,52.3,73.8), null);
...
// stage content:
(lib._300x250_pursuit_a = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(242).to({_off:false},0).wait(1).to({regX:26,regY:36.9,x:154.2,y:127.6,alpha:0.002},0).wait(1).to({x:154.9,alpha:0.009},0).wait(1).to({x:156.2,alpha:0.022},0).wait(1).to({x:158.4,alpha:0.044},0).wait(1).to({x:161.8,alpha:0.078},0).wait(1).to({x:167,alpha:0.13},0).wait(1).to({x:175.1,alpha:0.211},0).wait(1).to({x:187.6,alpha:0.336},0).wait(1).to({x:203.3,alpha:0.493},0).wait(1).to({x:216.8,alpha:0.628},0).wait(1).to({x:226.5,alpha:0.725},0).wait(1).to({x:233.4,alpha:0.794},0).wait(1).to({x:238.6,alpha:0.846},0).wait(1).to({x:242.6,alpha:0.886},0).wait(1).to({x:245.6,alpha:0.916},0).wait(1).to({x:248,alpha:0.94},0).wait(1).to({x:249.9,alpha:0.959},0).wait(1).to({x:251.3,alpha:0.973},0).wait(1).to({x:252.4,alpha:0.984},0).wait(1).to({x:253.1,alpha:0.991},0).wait(1).to({x:253.6,alpha:0.996},0).wait(1).to({x:253.9,alpha:0.999},0).wait(1).to({regX:25.4,regY:20,x:253.4,y:110.7,alpha:1},0).wait(11));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x250_pursuit_a_atlas_.jpg", id:"300x250_pursuit_a_atlas_"}
	],
	preloads: []
};
