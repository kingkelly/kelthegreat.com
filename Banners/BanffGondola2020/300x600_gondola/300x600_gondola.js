...
(lib.spectacular = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAjCDQgHg3gHgQQgHgSgQAAIgjAAIAABZIg+AAIAAkFIBrAAQAnAAAWAOQAdATAAAqQAAA6gxAOQAYADALAbQAJAYAHA8gAglgIIAcAAQAWgBAKgHQALgIAAgYQAAgSgHgGQgGgGgRAAIgpAAg");
	this.shape.setTransform(233,18);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AA3CDIgOgxIhTAAIgOAxIg+AAIBSkFIBJAAIBSEFgAAcAhIgchlIgcBlIA4AAg");
	this.shape_1.setTransform(208.7,18);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhLCDIAAkFIA+AAIAADOIBZAAIAAA3g");
	this.shape_2.setTransform(188.4,18);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhTBoQgTgWAAguIAAioIA+AAIAACnQAAAZAGAIQAIAMAaAAQAaAAAJgLQAGgJAAgZIAAinIA+AAIAACmQAAAsgSAWQgaAhg8AAQg5AAgZgdg");
	this.shape_3.setTransform(165.3,18.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhBBuQgegfAAhMQAAhMAfghQAbgdAzAAQA0AAAbAdIgiAqQgSgRgdAAQgYAAgKAPQgJAQAAA0QAAA1ALAPQAJANATAAQAdAAAXgaIAkAmQgjApg4AAQgtAAgZgag");
	this.shape_4.setTransform(142.2,17.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AA3CDIgOgxIhTAAIgOAxIg+AAIBSkFIBJAAIBSEFgAAcAhIgchlIgcBlIA4AAg");
	this.shape_5.setTransform(119.2,18);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgeCDIAAjPIhDAAIAAg2IDDAAIAAA2IhDAAIAADPg");
	this.shape_6.setTransform(97.3,18);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhBBuQgegfAAhMQAAhMAfghQAbgdAzAAQA0AAAbAdIgiAqQgSgRgdAAQgYAAgKAPQgJAQAAA0QAAA1ALAPQAJANATAAQAdAAAXgaIAkAmQgjApg4AAQgtAAgZgag");
	this.shape_7.setTransform(77,17.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhPCDIAAkFICdAAIAAAzIhgAAIAAA1IBXAAIAAAyIhXAAIAAA4IBiAAIAAAzg");
	this.shape_8.setTransform(56,18);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhfCDIAAkFIBjAAQAqAAAWARQAcAWAAAzQAAAzgcAXQgWARgrAAIgkAAIAABQgAghgBIAiAAQARAAAHgHQAHgGAAgZQAAgagIgGQgHgHgRAAIghAAg");
	this.shape_9.setTransform(34.7,18);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AhdBuIAeguQAZAUAmAAQAfAAAAgcQAAgOgSgJIgpgPQgcgKgNgNQgTgTAAggQAAgkAegWQAbgVAoAAQA0AAAbAXIgdAtQgWgPghAAQgeAAAAAZQAAANATAIQAKAFAeAJQAcAKAOAOQATATAAAgQAAAqghAXQgbASgoAAQg6AAgdgag");
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape.setTransform(116.7,8.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AghA1IAAgNQAAgPAHgIQAGgHASgLQAIgFAEgEQAFgFAAgIQAAgNgPAAQgNAAgJAJIgLgLQALgOAWAAQAiAAAAAdQAAALgGAIQgFAFgNAIQgNAJgEAFQgGAGAAAHIAvAAIAAARg");
	this.shape_1.setTransform(108.2,8.3);
	...
	this.shape_4.setTransform(83.2,9.7);
	...
	this.shape_5.setTransform(75.5,9.8);
	...
	this.shape_6.setTransform(67.1,9.6);
	...
	this.shape_9.setTransform(44.4,9.7);
	...
	this.shape_12.setTransform(24.8,9.7);
	...
	this.shape_13.setTransform(17.9,8.7);
	...
	this.shape_14.setTransform(10.8,8.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.date, new cjs.Rectangle(4.8,0,118.2,19.2), null);
...
(lib.cta = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(159,27);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#3D3D3F").s().p("AgcAwIAAhfIA5AAIAAAUIgiAAIAAAUIAfAAIAAATIgfAAIAAAkg");
	this.shape.setTransform(147.3,32.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#3D3D3F").s().p("AgbAwIAAhfIAXAAIAABLIAgAAIAAAUg");
	this.shape_1.setTransform(140.3,32.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#3D3D3F").s().p("AgcAwIAAhfIA5AAIAAATIgjAAIAAATIAgAAIAAASIggAAIAAAVIAjAAIAAASg");
	this.shape_2.setTransform(132.9,32.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#3D3D3F").s().p("AghAoIALgQQAJAHANAAQAMAAAAgKQAAgFgHgDIgPgGQgJgEgFgEQgIgHAAgMQAAgNALgIQALgIAOAAQASAAAKAJIgKAQQgIgFgMgBQgKAAAAAKQAAAFAGACIAOAGQALADAFAFQAHAHgBAMQAAAPgMAIQgKAHgOAAQgVAAgKgKg");
	this.shape_3.setTransform(125.2,32.9);
	...
	this.shape_4.setTransform(117.3,32.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#3D3D3F").s().p("AgeAnQgHgJAAgRIAAg9IAXAAIAAA9QAAAJACADQADAEAJABQAKAAADgFQACgDAAgJIAAg9IAXAAIAAA9QAAAQgGAIQgKAMgWAAQgVAAgJgKg");
	this.shape_5.setTransform(108,33);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#3D3D3F").s().p("AgeAoQgLgMAAgbQAAgcAMgMQALgKASAAQAVAAALAKQALALgBAcQABAcgMAMQgLAKgUAAQgUAAgKgKgAgMgZQgFAGAAATQAAAVAFAGQAEAEAIAAQAJAAAFgFQAEgGAAgUQAAgUgFgGQgEgEgJAAQgIAAgEAFg");
	this.shape_6.setTransform(98.5,32.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#3D3D3F").s().p("AgLAwIAAgkIgdg7IAaAAIAOAlIAPglIAaAAIgeA7IAAAkg");
	this.shape_7.setTransform(89.7,32.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#3D3D3F").s().p("AANAwQgDgUgCgGQgDgGgFAAIgNAAIAAAgIgXAAIAAhfIAnAAQAPAAAIAFQAKAHAAAPQAAAVgSAFQAJACAEAJQADAJADAWgAgNgDIAKAAQAIAAAEgCQAEgDAAgJQAAgHgDgCQgCgCgGAAIgPAAg");
	this.shape_8.setTransform(78.8,32.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#3D3D3F").s().p("AgeAoQgMgMAAgbQAAgcANgMQAKgKATAAQAVAAALAKQAKALABAcQgBAcgMAMQgKAKgUAAQgUAAgKgKgAgMgZQgFAGAAATQAAAVAFAGQAEAEAIAAQAJAAAFgFQAEgGAAgUQAAgUgFgGQgEgEgJAAQgIAAgEAFg");
	this.shape_9.setTransform(69.4,32.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#3D3D3F").s().p("AgcAwIAAhfIA5AAIAAAUIgiAAIAAAUIAfAAIAAATIgfAAIAAAkg");
	this.shape_10.setTransform(61.2,32.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#3D3D3F").s().p("AgcAwIAAhfIA5AAIAAATIgjAAIAAATIAgAAIAAASIggAAIAAAVIAjAAIAAASg");
	this.shape_11.setTransform(51,32.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#3D3D3F").s().p("AgcAwIAAhfIA5AAIAAATIgjAAIAAATIAgAAIAAASIggAAIAAAVIAjAAIAAASg");
	this.shape_12.setTransform(43.5,32.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#3D3D3F").s().p("AgiAoIAMgQQAJAHANAAQAMAAAAgKQAAgFgHgDIgPgGQgJgEgGgEQgGgHAAgMQAAgNALgIQAKgIAOAAQASAAALAJIgLAQQgIgFgNgBQgJAAgBAKQAAAFAHACIAPAGQAJADAGAFQAGAHAAAMQABAPgMAIQgLAHgOAAQgVAAgLgKg");
	this.shape_13.setTransform(35.8,32.9);
	...
	// Layer_2
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AsUDaQgyABAAgyIAAlRQAAgxAyAAIYpAAQAyAAAAAxIAAFRQAAAygygBg");
	this.shape_14.setTransform(100.2,33);
