...
lib.ssMetadata = [
		{name:"300x600_pursuit_a_atlas_", frames: [[0,0,300,600],[302,0,300,600],[302,602,300,600],[0,1204,300,600],[0,602,300,600]]}
];
...
(lib.photo1 = function() {
	this.spriteSheet = ss["300x600_pursuit_a_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	this.shape_20.graphics.f("#FFFFFF").s().p("");
	this.shape_20.setTransform(-184.1,239.3);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgeCIQgRgDgPgHQgOgGgMgJQgMgIgKgMIAwgwQAPAQAPAIQARAIARAAQAQAAAKgIQAJgIAAgMIAAgBQAAgNgLgIQgMgHgUAAIggAAIgMgnIA/g4IhoAAIAAg+IDFAAIAAA3IhCA4QAQADAMAGQANAGAKAJQAKAJAFAMQAFAOAAARIAAAAQAAAVgIARQgHARgPAMQgOAMgTAGQgUAHgXAAQgSAAgRgEg");
	this.shape_21.setTransform(-122.2,244.3);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AhiCJIB3jSIh+AAIAAg/IDTAAIAAA5Ih5DYg");
	this.shape_22.setTransform(-145.7,244);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AgGCKIAAjMIguAKIgPg6IBQgXIA3AAIAAETg");
	this.shape_23.setTransform(-167.5,243.9);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AAwBdIAAhqIgwBJIAAAAIgvhJIAABqIg0AAIAAi5IA3AAIAsBIIAshIIA3AAIAAC5g");
	this.shape_24.setTransform(-122.1,211.5);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("");
	this.shape_25.setTransform(-144.8,211.5);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("AAaBdIglg4IgWAAIAAA4Ig0AAIAAi5IBYAAQAOgBAWAGQAIADAFAEQAHADAEAFQAIAIAFALQAEALAAAOIAAAAQAAAKgDAKQgDAIgFAHQgEAGgIAGQgGAGgKADIAtBBgAghgCIAhAAQANgBAIgFQAGgHAAgKIAAAAQAAgMgGgFQgIgGgNABIghAAg");
	this.shape_26.setTransform(-164.8,211.5);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#FFFFFF").s().p("AhKBdIAAi5ICVAAIAAAtIhhAAIAAAfIBXAAIAAArIhXAAIAABCg");
	this.shape_27.setTransform(-183.2,211.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol11, new cjs.Rectangle(-195.8,191.7,192.1,79), null);
...
// stage content:
(lib._300x600_pursuit_a = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(245).to({_off:false},0).wait(1).to({regX:-99.9,regY:229.9,x:28.3,y:320.6,alpha:0.002},0).wait(1).to({x:29,alpha:0.009},0).wait(1).to({x:30.2,alpha:0.022},0).wait(1).to({x:32.3,alpha:0.044},0).wait(1).to({x:35.5,alpha:0.078},0).wait(1).to({x:40.5,alpha:0.13},0).wait(1).to({x:48.2,alpha:0.211},0).wait(1).to({x:60,alpha:0.336},0).wait(1).to({x:74.9,alpha:0.493},0).wait(1).to({x:87.8,alpha:0.628},0).wait(1).to({x:97,alpha:0.725},0).wait(1).to({x:103.6,alpha:0.794},0).wait(1).to({x:108.5,alpha:0.846},0).wait(1).to({x:112.3,alpha:0.886},0).wait(1).to({x:115.2,alpha:0.916},0).wait(1).to({x:117.4,alpha:0.94},0).wait(1).to({x:119.2,alpha:0.959},0).wait(1).to({x:120.5,alpha:0.973},0).wait(1).to({x:121.5,alpha:0.984},0).wait(1).to({x:122.3,alpha:0.991},0).wait(1).to({x:122.7,alpha:0.996},0).wait(1).to({x:123,alpha:0.999},0).wait(1).to({regX:25.4,regY:20,x:248.4,y:110.7,alpha:1},0).wait(8));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x600_pursuit_a_atlas_.jpg", id:"300x600_pursuit_a_atlas_"}
	],
	preloads: []
};
