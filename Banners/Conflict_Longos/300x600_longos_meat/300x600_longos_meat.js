...
lib.ssMetadata = [
		{name:"300x600_longos_meat_atlas_", frames: [[0,402,144,52],[0,0,291,400]]}
];
...
(lib.bb_logo = function() {
	this.spriteSheet = ss["300x600_longos_meat_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._300x600_longos_meat = function(mode,startPosition,loop) {
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x600_longos_meat_atlas_.png", id:"300x600_longos_meat_atlas_"}
	],
	preloads: []
};
