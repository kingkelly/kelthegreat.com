...
lib.ssMetadata = [
		{name:"300x600_longos_broc_atlas_", frames: [[187,272,144,52],[0,0,267,270],[0,272,185,76]]}
];
...
(lib.bb_logo = function() {
	this.spriteSheet = ss["300x600_longos_broc_atlas_"];
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-1,0,185,76), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E2231A").s().p("AgVAXQgFgFgDgFQgCgGAAgHQAAgGACgGQADgFAFgFQAJgIAMAAQANAAAKAIQAEAFADAFQACAGAAAGQAAAHgCAGQgDAFgEAFQgKAIgNAAQgMAAgJgIg");
	this.shape.setTransform(123.7,131.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E2231A").s().p("");
	this.shape_1.setTransform(109.9,123.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E2231A").s().p("AhOBtIAAjZICYAAIAAAxIhdAAIAAAkIBOAAIAAAtIhOAAIAAAmIBiAAIAAAxg");
	this.shape_2.setTransform(92.4,123.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#E2231A").s().p("");
	this.shape_3.setTransform(71.9,123.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#E2231A").s().p("AgcBtIAAjZIA5AAIAADZg");
	this.shape_4.setTransform(55.7,123.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#E2231A").s().p("AAbBtIgmhEIgUAAIAABEIg6AAIAAjZIBYAAQANAAAXAGQAQAGALAKQALAKAGAPQAFAOAAAQQAAALgCAKQgDAJgFAHQgFAIgHAHQgIAGgJAFIAtBNgAgfgDIAbAAQAOAAAIgHQAIgHAAgOQAAgNgIgHQgIgIgOAAIgbAAg");
	this.shape_5.setTransform(40.9,123.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#E2231A").s().p("AhWBtIAAjZIBXAAQAOAAAXAGQAPAGAMAKQAKALAGAOQAGAPAAAQQAAARgGANQgGAOgKALQgMAKgPAGQgXAFgOAAIgdAAIAAA/gAgcgBIAbAAQAOAAAIgIQAHgHABgOQgBgNgHgIQgIgIgOAAIgbAAg");
	this.shape_6.setTransform(20.6,123.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#E2231A").s().p("AgbBtIAAhUIhOiFIBAAAIAqBQIAshQIA9AAIhNCDIAABWg");
	this.shape_7.setTransform(224,92.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#E2231A").s().p("AhKBtIAAjZIA6AAIAACoIBbAAIAAAxg");
	this.shape_8.setTransform(205.3,92.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#E2231A").s().p("AAbBtIgmhEIgUAAIAABEIg6AAIAAjZIBYAAQANAAAXAGQAQAGALAKQALAKAGAPQAFAOAAAQQAAALgCAKQgDAJgFAHQgFAIgHAHQgIAGgJAFIAtBNgAgfgDIAbAAQAOAAAIgHQAIgHAAgOQAAgNgIgHQgIgIgOAAIgbAAg");
	this.shape_9.setTransform(186,92.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#E2231A").s().p("AglBpQgVgJgIgHQgHgGgFgHQgFgGgDgJQgDgIgCgJQgCgKAAgLIAAiEIA6AAIAACDQAAAKACAHQACAHAFAFQAFAFAGADQAHACAIAAQAJAAAHgCQAHgDAEgFQAFgFACgHQACgHAAgKIAAiDIA7AAIAACEQAAALgCAKQgCAJgDAIQgEAJgFAGQgFAHgGAGIgOAJIgQAHQgSAFgUAAQgUAAgRgFg");
	this.shape_10.setTransform(164.1,92.2);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#E2231A").s().p("");
	this.shape_11.setTransform(140.5,92.1);
	...
	this.shape_12.setTransform(118.3,92.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#E2231A").s().p("AAmBtIAAhVIhLAAIAABVIg6AAIAAjZIA6AAIAABUIBLAAIAAhUIA6AAIAADZg");
	this.shape_13.setTransform(96.2,92.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#E2231A").s().p("");
	this.shape_14.setTransform(73.1,92.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#E2231A").s().p("AgcBtIAAjZIA5AAIAADZg");
	this.shape_15.setTransform(56.8,92.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#E2231A").s().p("AhNBtIAAjZICXAAIAAAxIheAAIAAAkIBPAAIAAAtIhPAAIAAAmIBiAAIAAAxg");
	this.shape_16.setTransform(43.1,92.1);
	...
	this.shape_17.setTransform(21.7,92.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#E2231A").s().p("AgVAXQgFgFgCgFQgDgGAAgHQAAgGADgGQACgFAFgFQAJgIAMAAQANAAAKAIQAEAFACAFQADAGAAAGQAAAHgDAGQgCAFgEAFQgKAIgNAAQgMAAgJgIg");
	this.shape_18.setTransform(163,69.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#E2231A").s().p("AhgBtIAAjZIBUAAQALAAALACQALACAKAEQAJADAKAGQAIAFAHAHQAIAHAGAJQAGAJAEAKQAEAKACALQACAMAAALQAAANgCALQgCALgEAKQgEAKgGAJQgGAJgIAHQgHAHgIAFQgKAGgJADQgKAEgLACQgLACgLAAgAgmA8IAUAAQANAAAKgFQAKgEAIgIQAHgIAEgKQADgMAAgNQAAgMgDgMQgEgKgHgIQgIgIgKgEQgKgFgNAAIgUAAg");
	this.shape_19.setTransform(148.2,61.1);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#E2231A").s().p("AhOBtIAAjZICYAAIAAAxIhdAAIAAAkIBOAAIAAAtIhOAAIAAAmIBiAAIAAAxg");
	this.shape_20.setTransform(127.9,61.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#E2231A").s().p("");
	this.shape_21.setTransform(107.4,61.1);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#E2231A").s().p("AAbBtIgmhEIgUAAIAABEIg6AAIAAjZIBYAAQANAAAXAGQAQAGALAKQALAKAGAPQAFAOAAAQQAAALgCAKQgDAJgFAHQgFAIgHAHQgIAGgJAFIAtBNgAgfgDIAbAAQAOAAAIgHQAIgHAAgOQAAgNgIgHQgIgIgOAAIgbAAg");
	this.shape_22.setTransform(86.2,61.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#E2231A").s().p("AglBpQgVgJgIgHQgHgGgFgHQgFgGgDgJQgEgIgCgJQgBgKAAgLIAAiEIA6AAIAACDQAAAKACAHQACAHAFAFQAFAFAGADQAHACAIAAQAJAAAHgCQAHgDAEgFQAFgFACgHQACgHAAgKIAAiDIA7AAIAACEQAAALgCAKQgCAJgEAIQgDAJgFAGQgFAHgGAGIgOAJIgQAHQgSAFgUAAQgUAAgRgFg");
	this.shape_23.setTransform(64.3,61.2);
	...
	this.shape_24.setTransform(40.7,61.1);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#E2231A").s().p("");
	this.shape_25.setTransform(18.8,61.1);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#E2231A").s().p("AgbBtIAAhUIhOiFIBAAAIArBQIArhQIA8AAIhMCDIAABWg");
	this.shape_26.setTransform(142.4,30.1);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#E2231A").s().p("AhKBtIAAjZIA6AAIAACoIBbAAIAAAxg");
	this.shape_27.setTransform(123.7,30.1);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#E2231A").s().p("AhKBtIAAjZIA6AAIAACoIBbAAIAAAxg");
	this.shape_28.setTransform(106,30.1);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#E2231A").s().p("AAvBwIgLgaIhLAAIgLAaIg4AAIBpjdQABgEACAEIBqDdgAASArIgUgtIgTAtIAnAAg");
	this.shape_29.setTransform(85.7,29.8);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#E2231A").s().p("");
	this.shape_30.setTransform(64.1,30.1);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#E2231A").s().p("");
	this.shape_31.setTransform(40.3,30.1);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#E2231A").s().p("AhKBtIAAjZIA6AAIAACoIBbAAIAAAxg");
	this.shape_32.setTransform(19.4,30.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(8,14,228.5,129), null);
...
}).prototype = getMCSymbolPrototype(lib.saltcopy2, new cjs.Rectangle(0,52,267,270), null);


// stage content:
(lib._300x600_longos_broc = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(14).to({_off:false},0).wait(1).to({regX:122.3,regY:76.4,x:88.3,y:147.2,alpha:0.059},0).wait(1).to({x:92.5,alpha:0.143},0).wait(1).to({x:99.1,alpha:0.276},0).wait(1).to({x:108.6,alpha:0.466},0).wait(1).to({x:116.6,alpha:0.625},0).wait(1).to({x:121.6,alpha:0.725},0).wait(1).to({x:125,alpha:0.793},0).wait(1).to({x:127.4,alpha:0.842},0).wait(1).to({x:129.3,alpha:0.879},0).wait(1).to({x:130.7,alpha:0.908},0).wait(1).to({x:131.8,alpha:0.93},0).wait(1).to({x:132.7,alpha:0.948},0).wait(1).to({x:133.4,alpha:0.963},0).wait(1).to({x:134,alpha:0.974},0).wait(1).to({x:134.4,alpha:0.983},0).wait(1).to({x:134.8,alpha:0.99},0).wait(1).to({x:135,alpha:0.994},0).wait(1).to({x:135.2,alpha:0.998},0).wait(1).to({x:135.3,alpha:0.999},0).wait(1).to({regX:61.9,regY:44.5,x:74.9,y:115.3,alpha:1},0).wait(42).to({regX:122.3,regY:76.4,x:135.4,y:147.2,alpha:0.997},0).wait(1).to({x:135.8,alpha:0.988},0).wait(1).to({x:136.5,alpha:0.97},0).wait(1).to({x:137.7,alpha:0.939},0).wait(1).to({x:139.8,alpha:0.887},0).wait(1).to({x:143.4,alpha:0.798},0).wait(1).to({x:149.8,alpha:0.637},0).wait(1).to({x:158,alpha:0.432},0).wait(1).to({x:163.7,alpha:0.289},0).wait(1).to({x:167.3,alpha:0.199},0).wait(1).to({x:169.8,alpha:0.138},0).wait(1).to({x:171.5,alpha:0.095},0).wait(1).to({x:172.7,alpha:0.064},0).wait(1).to({x:173.7,alpha:0.041},0).wait(1).to({x:174.3,alpha:0.024},0).wait(1).to({x:174.8,alpha:0.013},0).wait(1).to({x:175.1,alpha:0.005},0).wait(1).to({x:175.2,alpha:0.001},0).wait(1).to({regX:61.9,regY:44.5,x:114.9,y:115.3,alpha:0},0).wait(15));

	// meaty
	this.instance_4 = new lib.saltcopy2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(390.5,672.1,1,1,0,0,0,135.5,147.6);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(5).to({_off:false},0).wait(1).to({regX:133.5,regY:187,x:374.5,y:695},0).wait(1).to({x:354.5,y:671.3},0).wait(1).to({x:323.2,y:634.2},0).wait(1).to({x:278,y:580.8},0).wait(1).to({x:240.3,y:536.2},0).wait(1).to({x:216.5,y:508},0).wait(1).to({x:200.5,y:489},0).wait(1).to({x:188.9,y:475.3},0).wait(1).to({x:180.1,y:464.9},0).wait(1).to({x:173.3,y:456.9},0).wait(1).to({x:167.9,y:450.5},0).wait(1).to({x:163.7,y:445.5},0).wait(1).to({x:160.3,y:441.4},0).wait(1).to({x:157.6,y:438.3},0).wait(1).to({x:155.5,y:435.8},0).wait(1).to({x:153.9,y:433.9},0).wait(1).to({x:152.8,y:432.6},0).wait(1).to({x:152,y:431.7},0).wait(1).to({x:151.6,y:431.2},0).wait(1).to({regX:135.5,regY:147.6,x:153.5,y:391.6},0).wait(84));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x600_longos_broc_atlas_.png", id:"300x600_longos_broc_atlas_"}
	],
	preloads: []
};
