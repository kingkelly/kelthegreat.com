...
lib.ssMetadata = [
		{name:"300x600_longos_prod_atlas_", frames: [[0,602,144,52],[0,0,300,600]]}
];
...
(lib.bb_logo = function() {
	this.spriteSheet = ss["300x600_longos_prod_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._300x600_longos_prod = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x600_longos_prod_atlas_.png", id:"300x600_longos_prod_atlas_"}
	],
	preloads: []
};
