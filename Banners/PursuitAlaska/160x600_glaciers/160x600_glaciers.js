...
lib.ssMetadata = [
		{name:"160x600_glaciers_atlas_P_", frames: [[0,602,25,86],[0,0,160,600],[162,0,160,600],[324,0,160,600]]},
		{name:"160x600_glaciers_atlas_NP_", frames: [[0,0,160,600],[162,0,160,600]]}
];
...
(lib.endpath = function() {
	this.spriteSheet = ss["160x600_glaciers_atlas_P_"];
	this.gotoAndStop(0);
...
(lib.sky_glacier = function() {
	this.spriteSheet = ss["160x600_glaciers_atlas_NP_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(164.1,38.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AATAxIgegqIgLAMIAAAeIgVAAIAAhhIAVAAIAAArIAmgrIAaAAIgnAqIAqA3g");
	this.shape_1.setTransform(154,38.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(143.8,38.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAdAxIgJgWIgoAAIgJAWIgWAAIAqhhIASAAIArBhgAgMAIIAZAAIgNgfg");
	this.shape_3.setTransform(133.9,38.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgiAxIAAhhIAVAAIAABOIAwAAIAAATg");
	this.shape_4.setTransform(124.4,38.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAdAxIgJgWIgoAAIgJAWIgWAAIAqhhIASAAIArBhgAgMAIIAZAAIgNgfg");
	this.shape_5.setTransform(114.2,38.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgkAxIAAhhIBIAAIAAATIgzAAIAAAUIAtAAIAAASIgtAAIAAAVIA0AAIAAATg");
	this.shape_6.setTransform(100,38.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AARAxIgUgfIgRAAIAAAfIgVAAIAAhhIArAAQASAAAKAIQAJAJAAAQQAAAMgGAGQgFAHgKAEIAYAjgAgUgBIAVAAQAIAAAEgDQAEgEAAgGQAAgIgEgDQgFgEgHAAIgVAAg");
	this.shape_7.setTransform(90.4,38.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(79.1,38.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgiAxIAAhhIAVAAIAABOIAwAAIAAATg");
	this.shape_9.setTransform(69.2,38.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgmAxIAAhhIAnAAQAJAAAHACQAHADAFAEQAEAFADAGQADAGAAAIQAAAJgDAFQgEAHgFAEQgFAEgIADQgHACgHAAIgQAAIAAAdgAgQABIAQAAQAIAAAEgEQAFgEAAgHQAAgHgFgEQgFgEgHAAIgQAAg");
	this.shape_10.setTransform(60.2,38.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAWAxIgWgiIgVAiIgZAAIAigxIghgwIAaAAIATAgIAVggIAYAAIggAwIAiAxg");
	this.shape_11.setTransform(50,38.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgkAxIAAhhIBIAAIAAATIgzAAIAAAUIAtAAIAAASIgtAAIAAAVIA0AAIAAATg");
	this.shape_12.setTransform(40.5,38.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#D41B44").s().p("AssC2IAAlrIZZAAIAAFrg");
	this.shape_13.setTransform(102.4,39);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol11, new cjs.Rectangle(21.1,20.8,162.6,36.4), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0D233F").s().p("AgHAJIAAgRIAPAAIAAARg");
	this.shape.setTransform(103,16.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#0D233F").s().p("");
	this.shape_1.setTransform(96.6,13.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#0D233F").s().p("AgYAtIAAhXIAOAAIAAAXIAFgKIAIgIIAKgFQAFgCAHAAIAAAOIgBAAQgIAAgGADQgGADgEAFQgFAFgCAHQgDAHAAAKIAAAjg");
	this.shape_2.setTransform(89.5,13.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#0D233F").s().p("");
	this.shape_3.setTransform(80.6,13.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#0D233F").s().p("AgFA9IAAhXIALAAIAABXgAgGgtIAAgPIANAAIAAAPg");
	this.shape_4.setTransform(73.4,11.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#0D233F").s().p("AgMAqQgJgDgFgHQgHgGgDgIQgDgJgBgJQABgIADgJQADgIAHgGQAFgHAJgDQAIgEAIAAIAMABQAFABAFADIAHAEIAHAHIgJAJIgLgKQgGgDgKAAQgFAAgGACQgFADgFAEQgEAFgCAGQgDAHAAAGQAAAHADAGQACAGAFAFQADAFAHACQAFADAGAAQAJAAAHgEQAGgEAFgFIAIAIQgGAHgIAFQgJAFgNAAQgIAAgIgEg");
	this.shape_5.setTransform(66.4,13.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#0D233F").s().p("");
	this.shape_6.setTransform(56.3,13.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#0D233F").s().p("AgFA+IAAh7IALAAIAAB7g");
	this.shape_7.setTransform(49.4,11.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#0D233F").s().p("");
	this.shape_8.setTransform(41.3,14.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#0D233F").s().p("AgGA+IAAh7IANAAIAAB7g");
	this.shape_9.setTransform(113,-9.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#0D233F").s().p("");
	this.shape_10.setTransform(105.6,-7.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#0D233F").s().p("");
	this.shape_11.setTransform(96.6,-7.7);
	...
	this.shape_12.setTransform(88.2,-7.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#0D233F").s().p("");
	this.shape_13.setTransform(78.6,-7.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#0D233F").s().p("AgFA+IAAh7IALAAIAAB7g");
	this.shape_14.setTransform(70.9,-9.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#0D233F").s().p("");
	this.shape_15.setTransform(63.2,-7.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#0D233F").s().p("AgMAqQgJgDgFgHQgHgGgDgIQgEgJAAgJQAAgIAEgJQADgIAHgGQAFgHAJgDQAIgEAIAAIAMABQAFABAFADIAIAEIAGAHIgJAJIgLgKQgHgDgJAAQgFAAgGACQgFADgFAEQgEAFgDAGQgCAHAAAGQAAAHACAGQADAGAFAFQAEAFAGACQAFADAGAAQAJAAAGgEQAHgEAFgFIAIAIQgGAHgIAFQgJAFgNAAQgIAAgIgEg");
	this.shape_16.setTransform(53,-7.7);
	...
	this.shape_17.setTransform(40.1,-9.5);
	...
	this.shape_18.setTransform(31.3,-7.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(21.2,-18.9,98.7,42), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0D233F").s().p("");
	this.shape.setTransform(144.7,34.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#0D233F").s().p("Ag0BGIAAiLIBoAAIAAAcIhKAAIAAAcIBBAAIAAAaIhBAAIAAAdIBLAAIAAAcg");
	this.shape_1.setTransform(132.1,34.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#0D233F").s().p("AgxBGIAAiLIAeAAIAABvIBFAAIAAAcg");
	this.shape_2.setTransform(119.4,34.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#0D233F").s().p("AgOBGIAAiLIAdAAIAACLg");
	this.shape_3.setTransform(109.4,34.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#0D233F").s().p("AAoBGIAAhbIgoA8IAAAAIgng7IAABaIgeAAIAAiLIAhAAIAkA7IAkg7IAiAAIAACLg");
	this.shape_4.setTransform(97.4,34.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#0D233F").s().p("Ag0BGIAAiLIBoAAIAAAcIhKAAIAAAcIBBAAIAAAaIhBAAIAAAdIBLAAIAAAcg");
	this.shape_5.setTransform(157.8,12.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#0D233F").s().p("AAYBGIgcgtIgZAAIAAAtIgeAAIAAiLIA+AAQAaAAANAMQAOANAAAVIAAABQAAAQgIALQgIAKgOAFIAiAygAgdgBIAfAAQALAAAGgFQAGgGAAgJQAAgKgGgFQgHgFgLAAIgeAAg");
	this.shape_6.setTransform(144.1,12.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#0D233F").s().p("AAqBHIgNggIg6AAIgNAgIgfAAIA8iMIAbAAIA8CMgAgSAMIAkAAIgSgtg");
	this.shape_7.setTransform(128.5,12.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#0D233F").s().p("AgsA4QgQgQAAgfIAAhPIAfAAIAABOQAAARAIAJQAIAJANAAQAPAAAIgJQAHgIAAgRIAAhPIAfAAIAABOQAAAQgEAMQgEALgJAJQgIAHgLAFQgMADgNAAQgcAAgQgPg");
	this.shape_8.setTransform(113,12.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#0D233F").s().p("");
	this.shape_9.setTransform(97.1,12.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#0D233F").s().p("");
	this.shape_10.setTransform(81.9,12.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#0D233F").s().p("");
	this.shape_11.setTransform(150.2,-9.3);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#0D233F").s().p("");
	this.shape_12.setTransform(135.6,-9.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#0D233F").s().p("");
	this.shape_13.setTransform(121,-9.3);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#0D233F").s().p("AgTAUQAUgDgBgRIgLAAIAAgfIAfAAIAAAbQAAATgKAIQgJAJgRAAg");
	this.shape_14.setTransform(110.5,-2.3);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#0D233F").s().p("");
	this.shape_15.setTransform(101.4,-9.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#0D233F").s().p("AgzBHIAAgZIAvgmIAKgIIAHgJIAFgHIABgIQAAgJgFgEQgGgFgIAAQgHAAgGAFQgHAEgIAJIgVgRIAKgNQAGgFAGgEQAGgDAHgCQAIgCAIAAQALAAAJADQAJADAGAGQAHAFADAIQADAJAAAJQAAAJgCAHQgCAHgFAFQgEAGgHAHIgRANIgVARIA8AAIAAAbg");
	this.shape_16.setTransform(88.5,-9.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(73.6,-18.9,92.7,65.4), null);
...
// stage content:
(lib._160x600_glaciers = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.setTransform(80.7,233.5,0.8,0.8,0,0,0,101.9,29.7);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(149).to({_off:false},0).wait(1).to({regX:102.4,regY:39,x:81.1,y:241,alpha:0.002},0).wait(1).to({alpha:0.009},0).wait(1).to({alpha:0.023},0).wait(1).to({alpha:0.044},0).wait(1).to({alpha:0.075},0).wait(1).to({alpha:0.118},0).wait(1).to({alpha:0.179},0).wait(1).to({alpha:0.259},0).wait(1).to({alpha:0.36},0).wait(1).to({alpha:0.473},0).wait(1).to({alpha:0.581},0).wait(1).to({alpha:0.674},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:0.809},0).wait(1).to({alpha:0.857},0).wait(1).to({alpha:0.895},0).wait(1).to({alpha:0.924},0).wait(1).to({alpha:0.948},0).wait(1).to({alpha:0.965},0).wait(1).to({alpha:0.979},0).wait(1).to({alpha:0.989},0).wait(1).to({alpha:0.995},0).wait(1).to({alpha:0.999},0).wait(1).to({regX:101.9,regY:29.7,x:80.7,y:233.5,alpha:1},0).wait(13));
	...
	this.instance_5.setTransform(80,302,1,1,0,0,0,80,300);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(124).to({_off:false},0).to({alpha:0},10).wait(52));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(7).to({_off:false},0).wait(1).to({regX:70.2,regY:2.3,x:79.7,y:112.4,alpha:0.006},0).wait(1).to({y:112.9,alpha:0.027},0).wait(1).to({y:114.2,alpha:0.075},0).wait(1).to({y:116.7,alpha:0.174},0).wait(1).to({y:120.9,alpha:0.338},0).wait(1).to({y:125,alpha:0.497},0).wait(1).to({y:127.9,alpha:0.612},0).wait(1).to({y:130.1,alpha:0.695},0).wait(1).to({y:131.7,alpha:0.758},0).wait(1).to({y:132.9,alpha:0.807},0).wait(1).to({y:134,alpha:0.847},0).wait(1).to({y:134.8,alpha:0.879},0).wait(1).to({y:135.5,alpha:0.906},0).wait(1).to({y:136,alpha:0.927},0).wait(1).to({y:136.5,alpha:0.945},0).wait(1).to({y:136.9,alpha:0.96},0).wait(1).to({y:137.2,alpha:0.972},0).wait(1).to({y:137.4,alpha:0.981},0).wait(1).to({y:137.6,alpha:0.988},0).wait(1).to({y:137.7,alpha:0.994},0).wait(1).to({y:137.8,alpha:0.997},0).wait(1).to({y:137.9,alpha:0.999},0).wait(1).to({regX:70.5,regY:32,x:80,y:167.6,alpha:1},0).to({_off:true},43).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(4).to({_off:false},0).wait(1).to({regX:119.8,regY:12.5,x:79.9,y:47,alpha:0.006},0).wait(1).to({y:47.6,alpha:0.027},0).wait(1).to({y:49.1,alpha:0.075},0).wait(1).to({y:52,alpha:0.174},0).wait(1).to({y:56.9,alpha:0.338},0).wait(1).to({y:61.6,alpha:0.497},0).wait(1).to({y:65,alpha:0.612},0).wait(1).to({y:67.5,alpha:0.695},0).wait(1).to({y:69.3,alpha:0.758},0).wait(1).to({y:70.8,alpha:0.807},0).wait(1).to({y:72,alpha:0.847},0).wait(1).to({y:73,alpha:0.879},0).wait(1).to({y:73.7,alpha:0.906},0).wait(1).to({y:74.4,alpha:0.927},0).wait(1).to({y:74.9,alpha:0.945},0).wait(1).to({y:75.4,alpha:0.96},0).wait(1).to({y:75.7,alpha:0.972},0).wait(1).to({y:76,alpha:0.981},0).wait(1).to({y:76.2,alpha:0.988},0).wait(1).to({y:76.4,alpha:0.994},0).wait(1).to({y:76.5,alpha:0.997},0).wait(1).to({alpha:0.999},0).wait(1).to({regX:120,regY:35,x:80.1,y:99.1,alpha:1},0).to({_off:true},46).wait(113));

	// Layer_8 (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_10 = new cjs.Graphics().p("A1NBfIAAi9MAqbAAAIAAC9g");
	var mask_3_graphics_11 = new cjs.Graphics().p("A1NC7IAAl1MAqbAAAIAAF1g");
	var mask_3_graphics_12 = new cjs.Graphics().p("A1NEWIAAorMAqbAAAIAAIrg");
	var mask_3_graphics_13 = new cjs.Graphics().p("A1NFuIAArbMAqbAAAIAALbg");
	var mask_3_graphics_14 = new cjs.Graphics().p("A1NHFIAAuJMAqbAAAIAAOJg");
	var mask_3_graphics_15 = new cjs.Graphics().p("A1NIZIAAwxMAqbAAAIAAQxg");
	var mask_3_graphics_16 = new cjs.Graphics().p("A1NJqIAAzTMAqbAAAIAATTg");
	var mask_3_graphics_17 = new cjs.Graphics().p("A1NK6IAA1zMAqbAAAIAAVzg");
	var mask_3_graphics_18 = new cjs.Graphics().p("A1NMIIAA4PMAqbAAAIAAYPg");
	var mask_3_graphics_19 = new cjs.Graphics().p("A1NNTIAA6lMAqbAAAIAAalg");
	var mask_3_graphics_20 = new cjs.Graphics().p("A1NOcIAA83MAqbAAAIAAc3g");
	var mask_3_graphics_21 = new cjs.Graphics().p("A1NPjIAA/FMAqbAAAIAAfFg");
	var mask_3_graphics_22 = new cjs.Graphics().p("A1NQoMAAAghPMAqbAAAMAAAAhPg");
	var mask_3_graphics_23 = new cjs.Graphics().p("A1NRqMAAAgjTMAqbAAAMAAAAjTg");
	var mask_3_graphics_24 = new cjs.Graphics().p("A1NSrMAAAglVMAqbAAAMAAAAlVg");
	var mask_3_graphics_25 = new cjs.Graphics().p("A1NTpMAAAgnRMAqbAAAMAAAAnRg");
	var mask_3_graphics_26 = new cjs.Graphics().p("A1NUlMAAAgpJMAqbAAAMAAAApJg");
	var mask_3_graphics_27 = new cjs.Graphics().p("A1NVfMAAAgq9MAqbAAAMAAAAq9g");
	var mask_3_graphics_28 = new cjs.Graphics().p("A1NWWMAAAgsrMAqbAAAMAAAAsrg");
	var mask_3_graphics_29 = new cjs.Graphics().p("A1NXMMAAAguXMAqbAAAMAAAAuXg");
	var mask_3_graphics_30 = new cjs.Graphics().p("A1NX/MAAAgv9MAqbAAAMAAAAv9g");
	var mask_3_graphics_31 = new cjs.Graphics().p("A1NYwMAAAgxfMAqbAAAMAAAAxfg");
	var mask_3_graphics_32 = new cjs.Graphics().p("A1NZfMAAAgy9MAqbAAAMAAAAy9g");
	var mask_3_graphics_33 = new cjs.Graphics().p("A1NaMMAAAg0XMAqbAAAMAAAA0Xg");
	var mask_3_graphics_34 = new cjs.Graphics().p("A1Na2MAAAg1rMAqbAAAMAAAA1rg");
	var mask_3_graphics_35 = new cjs.Graphics().p("A1NbfMAAAg29MAqbAAAMAAAA29g");
	var mask_3_graphics_36 = new cjs.Graphics().p("A1NcFMAAAg4JMAqbAAAMAAAA4Jg");
	var mask_3_graphics_37 = new cjs.Graphics().p("A1NcpMAAAg5RMAqbAAAMAAAA5Rg");
	var mask_3_graphics_38 = new cjs.Graphics().p("A1NdLMAAAg6VMAqbAAAMAAAA6Vg");
	var mask_3_graphics_39 = new cjs.Graphics().p("A1NdqMAAAg7TMAqbAAAMAAAA7Tg");
	var mask_3_graphics_40 = new cjs.Graphics().p("A1NeIMAAAg8PMAqbAAAMAAAA8Pg");
	var mask_3_graphics_41 = new cjs.Graphics().p("A1NejMAAAg9FMAqbAAAMAAAA9Fg");
	var mask_3_graphics_42 = new cjs.Graphics().p("A1Ne8MAAAg93MAqbAAAMAAAA93g");
	var mask_3_graphics_43 = new cjs.Graphics().p("A1NfTMAAAg+lMAqbAAAMAAAA+lg");
	var mask_3_graphics_44 = new cjs.Graphics().p("A1NfoMAAAg/PMAqbAAAMAAAA/Pg");
	var mask_3_graphics_45 = new cjs.Graphics().p("A1Nf6MAAAg/zMAqbAAAMAAAA/zg");
	var mask_3_graphics_46 = new cjs.Graphics().p("EgVNAgLMAAAhAVMAqbAAAMAAABAVg");
	var mask_3_graphics_47 = new cjs.Graphics().p("EgVNAgZMAAAhAxMAqbAAAMAAABAxg");
	var mask_3_graphics_48 = new cjs.Graphics().p("EgVNAglMAAAhBJMAqbAAAMAAABBJg");
	var mask_3_graphics_49 = new cjs.Graphics().p("EgVNAgvMAAAhBdMAqbAAAMAAABBdg");
	var mask_3_graphics_50 = new cjs.Graphics().p("EgVNAg2MAAAhBrMAqbAAAMAAABBrg");
	var mask_3_graphics_51 = new cjs.Graphics().p("EgVNAg8MAAAhB3MAqbAAAMAAABB3g");
	var mask_3_graphics_52 = new cjs.Graphics().p("EgVNAg/MAAAhB9MAqbAAAMAAABB9g");
	var mask_3_graphics_53 = new cjs.Graphics().p("EgVNAhAMAAAhB/MAqbAAAMAAABB/g");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(10).to({graphics:mask_3_graphics_10,x:83.4,y:9.5}).wait(1).to({graphics:mask_3_graphics_11,x:83.4,y:18.7}).wait(1).to({graphics:mask_3_graphics_12,x:83.4,y:27.8}).wait(1).to({graphics:mask_3_graphics_13,x:83.4,y:36.6}).wait(1).to({graphics:mask_3_graphics_14,x:83.4,y:45.3}).wait(1).to({graphics:mask_3_graphics_15,x:83.4,y:53.7}).wait(1).to({graphics:mask_3_graphics_16,x:83.4,y:61.8}).wait(1).to({graphics:mask_3_graphics_17,x:83.4,y:69.8}).wait(1).to({graphics:mask_3_graphics_18,x:83.4,y:77.6}).wait(1).to({graphics:mask_3_graphics_19,x:83.4,y:85.1}).wait(1).to({graphics:mask_3_graphics_20,x:83.4,y:92.4}).wait(1).to({graphics:mask_3_graphics_21,x:83.4,y:99.5}).wait(1).to({graphics:mask_3_graphics_22,x:83.4,y:106.4}).wait(1).to({graphics:mask_3_graphics_23,x:83.4,y:113}).wait(1).to({graphics:mask_3_graphics_24,x:83.4,y:119.5}).wait(1).to({graphics:mask_3_graphics_25,x:83.4,y:125.7}).wait(1).to({graphics:mask_3_graphics_26,x:83.4,y:131.7}).wait(1).to({graphics:mask_3_graphics_27,x:83.4,y:137.5}).wait(1).to({graphics:mask_3_graphics_28,x:83.4,y:143}).wait(1).to({graphics:mask_3_graphics_29,x:83.4,y:148.4}).wait(1).to({graphics:mask_3_graphics_30,x:83.4,y:153.5}).wait(1).to({graphics:mask_3_graphics_31,x:83.4,y:158.4}).wait(1).to({graphics:mask_3_graphics_32,x:83.4,y:163.1}).wait(1).to({graphics:mask_3_graphics_33,x:83.4,y:167.6}).wait(1).to({graphics:mask_3_graphics_34,x:83.4,y:171.8}).wait(1).to({graphics:mask_3_graphics_35,x:83.4,y:175.9}).wait(1).to({graphics:mask_3_graphics_36,x:83.4,y:179.7}).wait(1).to({graphics:mask_3_graphics_37,x:83.4,y:183.3}).wait(1).to({graphics:mask_3_graphics_38,x:83.4,y:186.7}).wait(1).to({graphics:mask_3_graphics_39,x:83.4,y:189.8}).wait(1).to({graphics:mask_3_graphics_40,x:83.4,y:192.8}).wait(1).to({graphics:mask_3_graphics_41,x:83.4,y:195.5}).wait(1).to({graphics:mask_3_graphics_42,x:83.4,y:198}).wait(1).to({graphics:mask_3_graphics_43,x:83.4,y:200.3}).wait(1).to({graphics:mask_3_graphics_44,x:83.4,y:202.4}).wait(1).to({graphics:mask_3_graphics_45,x:83.4,y:204.2}).wait(1).to({graphics:mask_3_graphics_46,x:83.4,y:205.9}).wait(1).to({graphics:mask_3_graphics_47,x:83.4,y:207.3}).wait(1).to({graphics:mask_3_graphics_48,x:83.4,y:208.5}).wait(1).to({graphics:mask_3_graphics_49,x:83.4,y:209.5}).wait(1).to({graphics:mask_3_graphics_50,x:83.4,y:210.2}).wait(1).to({graphics:mask_3_graphics_51,x:83.4,y:210.8}).wait(1).to({graphics:mask_3_graphics_52,x:83.4,y:211.1}).wait(1).to({graphics:mask_3_graphics_53,x:83.4,y:211.2}).wait(20).to({graphics:null,x:0,y:0}).wait(113));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/160x600_glaciers_atlas_P_.png", id:"160x600_glaciers_atlas_P_"},
		{src:"images/160x600_glaciers_atlas_NP_.jpg", id:"160x600_glaciers_atlas_NP_"}
	],
	preloads: []
};
