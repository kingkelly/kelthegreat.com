...
lib.ssMetadata = [
		{name:"300x250_4talk_dog_atlas_NP_", frames: [[0,0,300,250],[0,252,300,250],[0,504,300,250],[0,756,300,250]]}
];
...
(lib.dbl_aurora = function() {
	this.spriteSheet = ss["300x250_4talk_dog_atlas_NP_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._300x250_4talk_dog = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/300x250_4talk_dog_atlas_NP_.jpg", id:"300x250_4talk_dog_atlas_NP_"}
	],
	preloads: []
};
