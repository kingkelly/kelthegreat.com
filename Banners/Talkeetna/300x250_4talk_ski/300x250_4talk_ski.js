...
lib.ssMetadata = [
		{name:"300x250_4talk_ski_atlas_NP_", frames: [[0,252,300,250],[0,756,300,250],[0,0,300,250],[0,504,300,250]]}
];
...
(lib.dbl_aurora = function() {
	this.spriteSheet = ss["300x250_4talk_ski_atlas_NP_"];
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.aurora, new cjs.Rectangle(0,0,300,250), null);
...
// stage content:
(lib._300x250_3talk_ski = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(165).to({_off:false},0).to({alpha:0.5},14).to({alpha:0},27).to({scaleX:1.35,scaleY:12.89,rotation:44.9,x:31.9,y:213,alpha:1},29).to({scaleX:1.35,scaleY:12.92,rotation:45,x:31.5,y:213.4,alpha:0.309},6).to({alpha:0.77},11).to({scaleX:1.35,scaleY:12.89,rotation:44.9,x:31.9,y:213,alpha:0.641},12).to({scaleX:1.35,scaleY:12.92,rotation:45,x:31.5,y:213.4,alpha:0},46).to({alpha:0.531},16).to({alpha:0.012},58).to({alpha:0.75},75).to({alpha:0},39).to({alpha:0.82},53).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(148).to({_off:false},0).wait(1).to({regX:92.6,regY:-129.1,x:228.4,y:62,alpha:0.238},0).wait(1).to({y:58.6,alpha:0.388},0).wait(1).to({y:54.8,alpha:0.56},0).wait(1).to({y:51.3,alpha:0.713},0).wait(1).to({y:49.1,alpha:0.815},0).wait(1).to({y:47.6,alpha:0.878},0).wait(1).to({y:46.7,alpha:0.918},0).wait(1).to({y:46.1,alpha:0.945},0).wait(1).to({y:45.7,alpha:0.964},0).wait(1).to({y:45.4,alpha:0.978},0).wait(1).to({y:45.2,alpha:0.987},0).wait(1).to({y:45.1,alpha:0.993},0).wait(1).to({y:45,alpha:0.997},0).wait(1).to({y:44.9,alpha:0.999},0).wait(1).to({regX:0,regY:0,x:135.8,y:174,alpha:1},0).wait(389));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(50).to({_off:false},0).wait(1).to({regX:66.9,regY:-30.3,x:104.7,y:118.7,alpha:0.005},0).wait(1).to({y:118.3,alpha:0.022},0).wait(1).to({y:117.8,alpha:0.052},0).wait(1).to({y:116.8,alpha:0.101},0).wait(1).to({y:115.5,alpha:0.171},0).wait(1).to({y:113.7,alpha:0.265},0).wait(1).to({y:111.5,alpha:0.381},0).wait(1).to({y:109.1,alpha:0.508},0).wait(1).to({y:106.8,alpha:0.631},0).wait(1).to({y:104.8,alpha:0.736},0).wait(1).to({y:103.2,alpha:0.82},0).wait(1).to({y:102,alpha:0.884},0).wait(1).to({y:101.1,alpha:0.931},0).wait(1).to({y:100.4,alpha:0.964},0).wait(1).to({y:100,alpha:0.985},0).wait(1).to({y:99.8,alpha:0.996},0).wait(1).to({regX:128.6,regY:92.2,x:166.4,y:222.3,alpha:1},0).wait(45).to({regX:66.9,regY:-30.3,x:104.7,y:99.8,alpha:0.995},0).wait(1).to({y:100.2,alpha:0.978},0).wait(1).to({y:100.7,alpha:0.948},0).wait(1).to({y:101.7,alpha:0.899},0).wait(1).to({y:103,alpha:0.829},0).wait(1).to({y:104.8,alpha:0.735},0).wait(1).to({y:107,alpha:0.619},0).wait(1).to({y:109.4,alpha:0.492},0).wait(1).to({y:111.7,alpha:0.369},0).wait(1).to({y:113.7,alpha:0.264},0).wait(1).to({y:115.3,alpha:0.18},0).wait(1).to({y:116.5,alpha:0.116},0).wait(1).to({y:117.4,alpha:0.069},0).wait(1).to({y:118.1,alpha:0.036},0).wait(1).to({y:118.5,alpha:0.015},0).wait(1).to({y:118.7,alpha:0.004},0).wait(1).to({regX:128.6,regY:92.2,x:166.4,y:241.3,alpha:0},0).to({_off:true},9).wait(415));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(137).to({_off:false},0).wait(1).to({regX:-14.8,regY:26.4,x:147.2,y:75.4,alpha:0.004},0).wait(1).to({y:75.2,alpha:0.015},0).wait(1).to({y:74.8,alpha:0.037},0).wait(1).to({y:74.2,alpha:0.07},0).wait(1).to({y:73.3,alpha:0.116},0).wait(1).to({y:72.1,alpha:0.179},0).wait(1).to({y:70.6,alpha:0.26},0).wait(1).to({y:68.7,alpha:0.356},0).wait(1).to({y:66.7,alpha:0.463},0).wait(1).to({y:64.6,alpha:0.571},0).wait(1).to({y:62.8,alpha:0.67},0).wait(1).to({y:61.2,alpha:0.755},0).wait(1).to({y:59.8,alpha:0.824},0).wait(1).to({y:58.8,alpha:0.879},0).wait(1).to({y:58,alpha:0.921},0).wait(1).to({y:57.4,alpha:0.952},0).wait(1).to({y:57,alpha:0.975},0).wait(1).to({y:56.7,alpha:0.989},0).wait(1).to({y:56.5,alpha:0.997},0).wait(1).to({regX:61.5,regY:63.6,x:223.5,y:93.7,alpha:1},0).wait(395));
	...
	this.instance_13 = new lib.aurora();
	this.instance_13.parent = this;
	this.instance_13.setTransform(149.9,305,1.028,1.028,0,0,0,149.8,299.8);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({alpha:0},17,cjs.Ease.get(1)).to({_off:true},1).wait(534));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(82).to({_off:false},0).to({scaleX:1.07,scaleY:1.07,x:143,y:307.1,alpha:1},13).to({regX:150,regY:299.9,scaleX:1.22,scaleY:1.22,x:120.1,y:311.9},43).wait(414));

	// Layer_2
	this.instance_14 = new lib.bike();
	this.instance_14.parent = this;
	this.instance_14.setTransform(150,290,1,1,0,0,0,150,300);
	this.instance_14.alpha = 0.109;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(40).to({_off:false},0).to({scaleX:1.03,scaleY:1.03,y:293,alpha:1},7).to({regY:299.9,scaleX:1.21,scaleY:1.21,x:150.1,y:299.9},45).to({_off:true},9).wait(451));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({scaleX:1,scaleY:1,y:295},51).wait(501));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/300x250_4talk_ski_atlas_NP_.jpg", id:"300x250_4talk_ski_atlas_NP_"}
	],
	preloads: []
};
