...
lib.ssMetadata = [
		{name:"300x600_3talk_ski_atlas_P_", frames: [[302,0,39,42],[0,0,300,122]]},
		{name:"300x600_3talk_ski_atlas_NP_", frames: [[0,0,300,600],[302,0,300,600],[604,0,300,600]]}
];
...
(lib.arrow = function() {
	this.spriteSheet = ss["300x600_3talk_ski_atlas_P_"];
	this.gotoAndStop(0);
...
(lib.dbl_aurora = function() {
	this.spriteSheet = ss["300x600_3talk_ski_atlas_NP_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib._300x600_3talk_ski = function(mode,startPosition,loop) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_3talk_ski_atlas_P_.png", id:"300x600_3talk_ski_atlas_P_"},
		{src:"images/300x600_3talk_ski_atlas_NP_.jpg", id:"300x600_3talk_ski_atlas_NP_"}
	],
	preloads: []
};
