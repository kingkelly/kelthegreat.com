...
lib.ssMetadata = [
		{name:"300x250_3talk_ski_atlas_NP_", frames: [[0,504,300,250],[0,0,300,250],[0,252,300,250]]}
];
...
(lib.dbl_bike = function() {
	this.spriteSheet = ss["300x250_3talk_ski_atlas_NP_"];
	this.gotoAndStop(0);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/300x250_3talk_ski_atlas_NP_.jpg", id:"300x250_3talk_ski_atlas_NP_"}
	],
	preloads: []
};
