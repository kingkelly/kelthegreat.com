...
lib.ssMetadata = [
		{name:"300x250_longos_meat_atlas_", frames: [[0,234,144,52],[0,0,211,232]]}
];
...
(lib.bb_logo = function() {
	this.spriteSheet = ss["300x250_longos_meat_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.shape_20.graphics.f("#E2231A").s().p("ABABNIhdhNIAABLIglAAIAAiXQAAgBAAAAQAAAAABAAQAAAAAAAAQABAAABABIBdBMIAAhKIAlAAIAACXQAAAAAAAAQAAABAAAAQAAAAAAAAQAAAAgBAAIgCgBg");
	this.shape_20.setTransform(112.8,11.7);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#E2231A").s().p("Ag1BLIAAiVIBoAAIAAAiIhAAAIAAAYIA1AAIAAAfIg1AAIAAAaIBDAAIAAAig");
	this.shape_21.setTransform(98.8,11.7);
	...
	this.shape_22.setTransform(85.6,11.7);
	...
	this.shape_23.setTransform(69.7,11.7);
	...
	this.shape_24.setTransform(45.6,11.6);
	...
	this.shape_25.setTransform(26.7,11.7);
	...
	this.shape_26.setTransform(10,11.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,158.3,68), null);
...
(lib.saltcopy2 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AhKSJImGlVIAA1FIX5AAIAAaag");
	mask.setTransform(106.5,116.1);
...
// stage content:
(lib._300x250_longos_meat = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(5).to({_off:false},0).wait(1).to({regX:105.5,regY:116,x:301.8,y:237.5},0).wait(1).to({x:290.8,y:228.2},0).wait(1).to({x:273.7,y:213.6},0).wait(1).to({x:248.9,y:192.7},0).wait(1).to({x:228.2,y:175.2},0).wait(1).to({x:215.2,y:164.1},0).wait(1).to({x:206.4,y:156.7},0).wait(1).to({x:200,y:151.3},0).wait(1).to({x:195.2,y:147.3},0).wait(1).to({x:191.5,y:144.1},0).wait(1).to({x:188.5,y:141.6},0).wait(1).to({x:186.2,y:139.6},0).wait(1).to({x:184.3,y:138},0).wait(1).to({x:182.9,y:136.8},0).wait(1).to({x:181.7,y:135.8},0).wait(1).to({x:180.9,y:135.1},0).wait(1).to({x:180.2,y:134.6},0).wait(1).to({x:179.8,y:134.2},0).wait(1).to({x:179.6,y:134},0).wait(1).to({regX:135.5,regY:147.6,x:209.5,y:165.6},0).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(3).to({_off:false},0).wait(1).to({x:225.4,y:274.8},0).wait(1).to({x:215.3,y:270.6},0).wait(1).to({x:199.4,y:264},0).wait(1).to({x:176.6,y:254.5},0).wait(1).to({x:157.5,y:246.5},0).wait(1).to({x:145.4,y:241.5},0).wait(1).to({x:137.3,y:238.1},0).wait(1).to({x:131.5,y:235.6},0).wait(1).to({x:127,y:233.8},0).wait(1).to({x:123.6,y:232.4},0).wait(1).to({x:120.8,y:231.2},0).wait(1).to({x:118.7,y:230.3},0).wait(1).to({x:117,y:229.6},0).wait(1).to({x:115.6,y:229},0).wait(1).to({x:114.6,y:228.6},0).wait(1).to({x:113.8,y:228.3},0).wait(1).to({x:113.2,y:228},0).wait(1).to({x:112.8,y:227.9},0).wait(1).to({x:112.6,y:227.8},0).wait(1).to({x:112.5},0).wait(75));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/300x250_longos_meat_atlas_.png", id:"300x250_longos_meat_atlas_"}
	],
	preloads: []
};
