...
lib.ssMetadata = [
		{name:"728x90_longos_surf_alt_atlas_", frames: [[0,0,552,309],[0,311,209,204],[211,311,188,186]]}
];
...
(lib.ribeye = function() {
	this.spriteSheet = ss["728x90_longos_surf_alt_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._728x90_longos_surf_alt = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_4.setTransform(89.5,282.6,0.751,0.751,0,0,0,51.1,16.2);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(65).to({_off:false},0).to({y:272.6,alpha:1},26,cjs.Ease.quartInOut).wait(32));

	// Layer_4 copy
	this.instance_5 = new lib.Symbol1copy2();
	this.instance_5.parent = this;
	this.instance_5.setTransform(117.5,236.9,0.751,0.751,0,0,0,128.5,115);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:118.4,y:160},41,cjs.Ease.quartInOut).wait(82));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(27).to({_off:false},0).to({x:118.4,y:160},41,cjs.Ease.quartInOut).wait(55));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/728x90_longos_surf_alt_atlas_.png", id:"728x90_longos_surf_alt_atlas_"}
	],
	preloads: []
};
