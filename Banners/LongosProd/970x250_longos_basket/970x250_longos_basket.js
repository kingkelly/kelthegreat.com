...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(400,-852,1.264,1.264);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(400,-852,670,833.1), null);
...
(lib.Symbol1copy = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(221.1,60.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E52527").s().p("AhbBaQgngkAAg2QAAg1AngkQAmgjA1AAQA2AAAmAjQAnAkAAA1QAAA2gnAkQgmAjg2AAQg1AAgmgjgAgvgwQgQATAAAdQAAAeAQATQASAUAdAAQAeAAASgUQAQgTAAgeQAAgdgQgTQgSgTgeAAQgdAAgSATg");
	this.shape_1.setTransform(202.1,51.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E52527").s().p("AhsB6IAAj0IBeAAQA1AAAjAiQAjAhAAA3QAAA4gjAiQgjAhg1gBgAgrBDIAWAAQAdAAARgSQARgTAAgeQAAgdgRgTQgRgSgdAAIgWAAg");
	this.shape_2.setTransform(176.3,51.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#E52527").s().p("AhXB6IAAj0ICqAAIAAA4IhpAAIAAAoIBYAAIAAAzIhYAAIAAAqIBuAAIAAA3g");
	this.shape_3.setTransform(144.7,51.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#E52527").s().p("AAeB6IgqhMIgWAAIAABMIhCAAIAAj0IBjAAQAtAAAaAZQAZAYAAAnQAAAxgtAVIAzBWgAgigDIAeAAQAhAAAAgfQAAggghAAIgeAAg");
	this.shape_4.setTransform(122.7,51.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#E52527").s().p("AhLBkQgegaAAgwIAAiVIBBAAIAACUQAAAsAoAAQApAAAAgsIAAiUIBBAAIAACVQAAAwgeAaQgcAYgwAAQgvAAgcgYg");
	this.shape_5.setTransform(98,52);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#E52527").s().p("AhgBQIAvgkQAWAbAcAAQAfAAAAgTQAAgNgYgIIgcgJQg9gVAAg1QAAgiAagUQAXgTAiAAQA4AAAcAhIgmAnQgRgSgZAAQgXAAAAARQAAAMARAGIAgALQAjAMAQARQAOARAAAbQAAAkgWAUQgYAVgvAAQhCAAgigtg");
	this.shape_6.setTransform(75,51.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#E52527").s().p("AhXB6IAAj0ICqAAIAAA4IhpAAIAAAoIBYAAIAAAzIhYAAIAAAqIBuAAIAAA3g");
	this.shape_7.setTransform(46.6,51.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#E52527").s().p("Ag/B+Ihnj3IBFAAIAtBzIA0h4QAAAAABgBQAAAAABAAQAAAAAAAAQABABAAAAIA3B4IArhzIBCAAIhlD3QgCAEgCgEIg+iDIg7CDQAAABgBAAQAAAAAAABQgBAAAAAAQAAAAAAAAQgBAAAAAAQAAAAAAAAQgBgBAAAAQAAAAAAgBg");
	this.shape_8.setTransform(18.9,51.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#E52527").s().p("AgYAaQgLgLAAgPQAAgOALgKQALgKANAAQAOAAALAKQALAKAAAOQAAAPgLALQgLAJgOAAQgNAAgLgJg");
	this.shape_9.setTransform(452.6,22.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#E52527").s().p("AhQBaQgmgkAAg2QAAg1AmgkQAmgjA1AAQBAAAAjArIguAoQgVgagiAAQgcAAgQATQgQATAAAdQAAAeAQAUQASAUAfAAQAbAAAUgJIAAgZIgwAAIAAgxIBqAAIAABpQgpAhhBAAQg2AAgngjg");
	this.shape_10.setTransform(434.6,13.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#E52527").s().p("ABpB/IiYh/IAAB6Ig+AAIAAj3QAAgFAFAFICYB9IAAh6IA+AAIAAD4QAAAAAAABQAAAAAAABQgBAAAAAAQAAAAgBAAIgDgBg");
	this.shape_11.setTransform(408.7,13.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#E52527").s().p("AggB7IAAj0IBBAAIAAD0g");
	this.shape_12.setTransform(390,13.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#E52527").s().p("AAhB7Ig5haIgUAaIAABAIhCAAIAAj0IBCAAIAABlIBKhlIBHAAIhRBqIBbCKg");
	this.shape_13.setTransform(373.1,13.9);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#E52527").s().p("AhPBaQgmgkABg2QAAg1AlgkQAkgjAxAAQBGAAAkA0IgxAiQgUgdgjAAQgaAAgQATQgQATAAAdQAAAdAQAUQARAUAaAAQAoAAASgiIAyAgQgiA6hJAAQg0AAglgjg");
	this.shape_14.setTransform(347.8,13.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#E52527").s().p("AggB7IAAj0IBBAAIAAD0g");
	this.shape_15.setTransform(329.6,13.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#E52527").s().p("AhhB7IAAj0IBiAAQAugBAaAaQAZAYAAAnQAAAlgZAYQgaAZgugBIggAAIAABHgAgfgCIAeAAQAhAAAAgfQAAghghAAIgeAAg");
	this.shape_16.setTransform(313.4,13.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#E52527").s().p("AhXB7IAAj0ICqAAIAAA3IhpAAIAAAoIBYAAIAAAzIhYAAIAAArIBuAAIAAA3g");
	this.shape_17.setTransform(282.9,13.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#E52527").s().p("ABGB9IgHhpIg9BHQAAABAAAAQgBAAAAAAQAAAAgBAAQAAAAAAgBIhAhHIgFBpIhAAAIAOj3QAAgBAAAAQABgBAAAAQABAAAAABQABAAAAABIB1CDIBziDQABgBABAAQAAgBAAAAQABAAAAABQAAAAAAABIAPD3g");
	this.shape_18.setTransform(257.1,13.6);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#E52527").s().p("AggB7IAAj0IBBAAIAAD0g");
	this.shape_19.setTransform(236.7,13.9);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#E52527").s().p("AggB7IAAi9IhAAAIAAg3IDBAAIAAA3IhBAAIAAC9g");
	this.shape_20.setTransform(220.6,13.9);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#E52527").s().p("AAeB7IgqhNIgWAAIAABNIhCAAIAAj0IBjAAQAtgBAaAZQAZAYAAAmQAAAzgtATIAzBYgAgigDIAeAAQAhAAAAggQAAgfghAAIgeAAg");
	this.shape_21.setTransform(190.3,13.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#E52527").s().p("AhLBkQgegaAAgwIAAiVIBBAAIAACUQAAAsAoAAQApAAAAgsIAAiUIBBAAIAACVQAAAwgeAaQgcAYgwAAQgvAAgcgYg");
	this.shape_22.setTransform(165.6,14);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#E52527").s().p("AhbBaQgngkAAg2QAAg1AngkQAmgjA1AAQA2AAAmAjQAnAkAAA1QAAA2gnAkQgmAjg2AAQg1AAgmgjgAgvgwQgQATAAAdQAAAeAQATQASAUAdAAQAeAAASgUQAQgTAAgeQAAgdgQgTQgSgTgeAAQgdAAgSATg");
	this.shape_23.setTransform(139,13.9);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#E52527").s().p("AggB7IAAhfIhViVIBIAAIAuBaIAxhaIBEAAIhUCTIAABhg");
	this.shape_24.setTransform(113.4,13.9);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#E52527").s().p("AhXB7IAAj0ICqAAIAAA3IhpAAIAAAoIBYAAIAAAzIhYAAIAAArIBuAAIAAA3g");
	this.shape_25.setTransform(83.2,13.9);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#E52527").s().p("AAhB7Ig5haIgUAaIAABAIhCAAIAAj0IBCAAIAABlIBKhlIBHAAIhRBqIBbCKg");
	this.shape_26.setTransform(60.9,13.9);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#E52527").s().p("AA2B+IgOgeIhUAAIgMAeIhAAAIB3j4QABgFACAFIB3D4gAATAxIgUgzIgXAzIArAAg");
	this.shape_27.setTransform(35.4,13.5);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#E52527").s().p("AggB7IAAi9IhAAAIAAg3IDBAAIAAA3IhBAAIAAC9g");
	this.shape_28.setTransform(12.6,13.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_28},{t:this.shape_27},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1copy, new cjs.Rectangle(0,-4,658,78), null);
...
(lib.Scene_1_Layer_10 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(92.6,363.3,1,1,0,0,0,51.1,16.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(53).to({_off:false},0).to({alpha:1},26,cjs.Ease.quartInOut).wait(3));
...
(lib.Scene_1_Layer_4 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-362.3,213.3,1,1,0,0,0,128.5,115);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:157.7},41,cjs.Ease.quartInOut).wait(41));
...
(lib.Scene_1_beef = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(865.5,351.2,1,1,-55,0,0,126,92.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:92.6,rotation:0,x:151,y:487.6},41,cjs.Ease.quartOut).wait(41));
...
(lib.Scene_1_GG_stack_svg = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-27.7,298.9,1,1,0,0,0,45.3,29.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({x:92.3,alpha:1},33,cjs.Ease.quartInOut).wait(10));

}).prototype = p = new cjs.MovieClip();


// stage content:
(lib._970x250_longos_basket = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.longos_svg.setTransform(102,47.7,1,1,0,0,0,102,47.7);
	...
	this.beef.setTransform(782.1,-306.4,1,1,0,0,0,782.1,-306.4);
	this.beef.depth = 0;
	...
	this.Layer_4.setTransform(-261.6,156.2,1,1,0,0,0,-261.6,156.2);
...
p.nominalBounds = new cjs.Rectangle(-5.8,-838.9,1806.3,1214);
// library properties:
lib.properties = {
