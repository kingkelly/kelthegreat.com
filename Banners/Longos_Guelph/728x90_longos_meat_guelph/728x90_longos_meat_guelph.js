...
lib.ssMetadata = [
		{name:"728x90_longos_meat_guelph_atlas_", frames: [[0,234,144,52],[0,0,211,232]]}
];
...
(lib.bb_logo = function() {
	this.spriteSheet = ss["728x90_longos_meat_guelph_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._728x90_longos_meat_guelph = function(mode,startPosition,loop) {
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/728x90_longos_meat_guelph_atlas_.png", id:"728x90_longos_meat_guelph_atlas_"}
	],
	preloads: []
};
