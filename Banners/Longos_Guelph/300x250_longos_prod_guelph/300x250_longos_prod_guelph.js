...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.shape_8.setTransform(125.3,59.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#E2231A").s().p("AgmBNIg/iWIAqAAIAcBGIAfhJQAAgBAAAAQABAAAAAAQAAAAAAAAQAAAAAAABIAiBJIAbhGIAoAAIg+CWQAAAAgBABQAAAAAAAAQAAAAgBAAQAAgBgBAAIglhPIgkBPIgBABIgBgBg");
	this.shape_9.setTransform(114,53.6);
	...
	this.shape_10.setTransform(91.7,53.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#E2231A").s().p("AgTBLIAAiVIAnAAIAACVg");
	this.shape_11.setTransform(80.9,53.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#E2231A").s().p("AAhBNIgJgSIgzAAIgHASIgnAAIBIiXQABgBAAAAQAAgBAAAAQAAAAABABQAAAAAAABIBJCXgAAMAeIgNgfIgNAfIAaAAg");
	this.shape_12.setTransform(70,53.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#E2231A").s().p("AgzBLIAAiVIAoAAIAABzIA/AAIAAAig");
	this.shape_13.setTransform(56.8,53.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#E2231A").s().p("");
	this.shape_14.setTransform(42.9,53.7);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#E2231A").s().p("AgTBLIAAhzIgoAAIAAgiIB3AAIAAAiIgoAAIAABzg");
	this.shape_15.setTransform(23.4,53.7);
...
}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,130.4,89), null);
...
// stage content:
(lib._300x250_longos_prod_guelph = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(101).to({_off:false},0).wait(1).to({regX:64.8,regY:43.3,x:40.5,y:114.3,alpha:0.066},0).wait(1).to({x:43.9,alpha:0.15},0).wait(1).to({x:48,alpha:0.254},0).wait(1).to({x:52.6,alpha:0.369},0).wait(1).to({x:57.3,alpha:0.485},0).wait(1).to({x:61.5,alpha:0.591},0).wait(1).to({x:65,alpha:0.68},0).wait(1).to({x:68,alpha:0.754},0).wait(1).to({x:70.4,alpha:0.814},0).wait(1).to({x:72.3,alpha:0.862},0).wait(1).to({x:73.8,alpha:0.901},0).wait(1).to({x:75,alpha:0.931},0).wait(1).to({x:76,alpha:0.955},0).wait(1).to({x:76.7,alpha:0.972},0).wait(1).to({x:77.2,alpha:0.985},0).wait(1).to({x:77.5,alpha:0.994},0).wait(1).to({x:77.7,alpha:0.998},0).wait(1).to({regX:79.1,regY:34,x:92.1,y:105,alpha:1},0).wait(4));
